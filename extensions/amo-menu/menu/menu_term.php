...
class AmoKit_Menu_Term_Meta{
    ...
    public function custom_nav_fields_data( $menu_item ){
        ...
        $item_settings = get_post_meta( $menu_item->ID, 'amokit_menu_settings', true );
    ...
    function _change_nav_menu_args( $args ){
        ...
        $settings = get_option( "amo_menu_options_" . $menu_id );
        if ( isset ( $settings['enable_menu'] ) && $settings['enable_menu'] == 'on' ) {
            ...
            $args = [
                ...
                'container_class' => 'amokit-menu-container',
                'fallback_cb'     => false,
                'before'          => $args['before'],
                'after'           => $args['after'],
            ...
            return apply_filters( 'amokitmenu_nav_menu_args', $args );
...
AmoKit_Menu_Term_Meta::instance();