...
$GLOBALS['amokit_Menu'] = new AmoKit_Menu();
require AMONAKIT_ADDONS_PL_PATH . 'extensions/amo-menu/menu/free-menu/amomenu_walker.php';
require AMONAKIT_ADDONS_PL_PATH . 'extensions/amo-menu/menu/free-menu/menu_term.php';