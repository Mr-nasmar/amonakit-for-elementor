...
class Bl_Post_Author_Info_ELement extends Widget_Base {
    ...
    public function get_title() {
        return __( 'Author Info', 'amokit-addons' );
    }
    ...
    public function get_keywords() {
        return ['author', 'author info', 'profile', 'user info', 'amokit', 'Amona Kit', 'addons'];
    }
    ...
    protected function register_controls() {
        ...
        $this->start_controls_section(
            ...
            [
                'label' => __( 'Author Info', 'amokit-addons' ),
            ]
        );
            $this->add_control(
                'show_name',
            ...
            $this->add_control(
                'name_html_tag',
                [
                    'label'   => __( 'Name HTML Tag', 'amokit-addons' ),
            ...
            $this->add_control(
                'show_avater_image',
                [
                    'label'         => __( 'Show Avatar Image', 'amokit-addons' ),
                    'type'          => Controls_Manager::SWITCHER,
                    'label_on'      => __( 'Show', 'amokit-addons' ),
                    'label_off'     => __( 'Hide', 'amokit-addons' ),
                    'return_value'  => 'yes',
            ...
            $this->add_control(
                'show_biography',
                [
                    'label'        => __( 'Show Biography', 'amokit-addons' ),
                    'type'         => Controls_Manager::SWITCHER,
                    'label_on'     => __( 'Show', 'amokit-addons' ),
                    'label_off'    => __( 'Hide', 'amokit-addons' ),
                    'return_value' => 'yes',
            ...
            $this->add_control(
                ...
                [
                    ...
                    'type'  => Controls_Manager::SELECT,
                    'options' => [
                        ''              => __( 'None', 'amokit-addons' ),
                        'website'       => __( 'Website', 'amokit-addons' ),
                        'admin_archive' => __( 'Admin Posts', 'amokit-addons' ),
                    ],
                    'description'       => __( 'Link for the Author Name and Image', 'amokit-addons' ),
                ]
            );
            ...
            $this->add_control(
                ...
                [
                    'label'   => __( 'Avater Image Position', 'amokit-addons' ),
        ...
        $this->start_controls_section(
            ...
            $this->add_control(
                'heading_bio_style',
                [
                    'label' => __( 'Biography', 'amokit-addons' ),
                    'type' => Controls_Manager::HEADING,
                    'separator' => 'before',
                ]
            );
            ...
            $this->add_control(
                ...
                [
                    ...
                    'type' => Controls_Manager::COLOR,
                    'selectors' => [
                        '{{WRAPPER}} .htauthor-info .amobuilder-bio' => 'color: {{VALUE}}',
                    ],
                ]
            );
            ...
            $this->add_group_control(
                ...
                [
                    ...
                    'selector' => '{{WRAPPER}} .htauthor-info .amobuilder-bio',
                ]
            );
            ...
            $this->add_control(
                ...
                [
                    ...
                    'size_units' => [ 'px', '%', 'em' ],
                    'selectors' => [
                        '{{WRAPPER}} .htauthor-info .amobuilder-bio' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    ],
                ]
            );
    ...
    protected function render( $instance = [] ) {
        ...
        $name_tag = amokit_validate_html_tag( $settings['name_html_tag'] );

        ?>
            <div class="amobuilder-author-box amoavaterpos-<?php echo esc_attr($settings['avater_image_position']); ?>">
                ...
                <div class="htauthor-info">
                    <?php
                        ...
                        if( $settings['show_biography'] == 'yes' ){
                            echo '<div class="amobuilder-bio">'.esc_html($author_info['bio']).'</div>';
                        }
                    ?>
                </div>
            </div>
