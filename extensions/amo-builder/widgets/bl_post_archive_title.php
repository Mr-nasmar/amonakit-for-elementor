...
class Bl_Post_Archive_Title_ELement extends Widget_Base {
    ...
    public function get_title() {
        return __( 'Archive Title', 'amokit-addons' );
    }

    public function get_icon() {
        return 'amokit-icon eicon-archive-title';
    }
    ...
    public function get_keywords() {
        return ['archive title', 'post title', 'amokit', 'Amona Kit', 'addons'];
    }
    ...
    protected function register_controls() {
        ...
        $this->start_controls_section(
            'title_content',
            [
                'label' => __( 'Archive Title', 'amokit-addons' ),
            ]
        );
    ...
    protected function render( $instance = [] ) {
        ...
        if( Elementor::instance()->editor->is_edit_mode() ){
            echo sprintf( '<%1$s class="htarchive-title">' . esc_html__('Archive Title', 'amokit-addons' ). '</%1$s>', esc_attr( $title_tag ) );
        }else{
