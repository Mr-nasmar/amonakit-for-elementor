...
*/
class AmoKitWC_Sales_Notification{
    ...
    public function purchased_products(){
        ...
        if ( ! $products ) {
            $args = array(
                ...
                'orderby' => 'ID',
                'order' => 'DESC',
                'posts_per_page' => amokit_get_option( 'notification_limit','amokitwcsales_setting_tabs','5' ),
                'date_query' => array(
    ...
    function ajax_request() {
        ...
        $duration       = (int)amokit_get_option( 'notification_loadduration','amokitwcsales_setting_tabs', '3' )*1000;
...
AmoKitWC_Sales_Notification::instance();