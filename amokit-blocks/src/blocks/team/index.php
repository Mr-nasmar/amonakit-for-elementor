<?php
	...
	$card_classes = [
		...
		"amokit-team",
		"amokit-team-{$settings['teamStyle']}",
	];
	...
	?>
		<div class="<?php echo esc_attr(implode(' ', $card_classes)); ?>">
			...
			<div class='amo-team-content'>
				<div class='amo-team-content-inner'>
					<<?php echo tag_escape($settings['nameTag']); ?> class='amo-team-name'><?php echo esc_html($settings['name']); ?></<?php echo tag_escape($settings['nameTag']); ?>>
					<span class='amo-team-designation'><?php echo esc_html($settings['designation']) ?></span>
					<?php echo $settings['showBio'] ? "<p class='amo-team-bio'>" . esc_html($settings['bio']) ."</p>" : ''; ?>
				</div>
				<ul class='amo-team-social'>
				<?php 
