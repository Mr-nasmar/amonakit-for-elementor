...
class AmoKit_Elementor_Widget_WC_Add_to_Cart extends Widget_Button {

    public function get_name() {
        return 'amokit-wcaddtocart-addons';
    }
    
    public function get_title() {
        return __( 'WC : Add To cart', 'amokit-addons' );
    }

    public function get_icon() {
        return 'amokit-icon eicon-product-add-to-cart';
    }
    ...
    public function get_script_depends() {
        return ['amokit-single-product-ajax-cart'];
    }
    ...
    public function get_keywords() {
        return ['amokit', 'Amona Kit', 'woocommerce', 'add to cart', 'wc cart', 'button', 'addons','widget'];
    }
    ...
    protected function register_controls() {
        ...
        $this->start_controls_section(
            'wcaddtocart_content',
            [
                'label' => __( 'Product', 'amokit-addons' ),
            ]
        );

            $post_list = get_posts(['numberposts' => 50, 'post_type' => 'product',]);
            $post_list_options = ['0' => esc_html__( 'Select Post', 'amokit-addons' ) ];
            ...
            $this->add_control(
                'show_quantity',
                [
                    'label'     => __( 'Show Quantity', 'amokit-addons' ),
            ...
            $this->add_control(
                'quantity',
                [
                    'label'     => __( 'Quantity', 'amokit-addons' ),
        ...
        $this->update_control(
            'text',
            [
                'default'     => __( 'Add to Cart', 'amokit-addons' ),
                'placeholder' => __( 'Add to Cart', 'amokit-addons' ),
            ]
        );
    ...
    private function render_ajax_button( $product ) {
        ...
        if ( $product ) {
            ...
            /*$settings['text'] = __( 'Please set a valid product', 'amokit-addons' );
            $this->set_settings( $settings );*/
            echo esc_html__( 'Please set a valid product', 'amokit-addons' );
        }
    }
