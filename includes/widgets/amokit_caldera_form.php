...
class AmoKit_Elementor_Widget_Caldera_Form extends Widget_Base {

    public function get_name() {
        return 'amokit-calderaform-addons';
    }
    
    public function get_title() {
        return __( 'Caldera Form', 'amokit-addons' );
    }

    public function get_keywords() {
        return [ 'form', 'contact', 'caldera', 'contact form','caldera form','amokit' ];
    }
    ...
    public function get_help_url() {
		return 'https://nasdesigns.rf.gd/docs/forms-widgets/caldera-forms-widget/';
	}
    ...
    protected function register_controls() {
        ...
        $this->start_controls_section(
            'calderaform_content',
            [
                'label' => __( 'Caldera Form', 'amokit-addons' ),
            ]
        );
            ...
            $this->add_control(
                'caldera_form_list',
                [
                    'label'   => __( 'Select Form', 'amokit-addons' ),
                    'type'    => Controls_Manager::SELECT,
                    'default' => '0',
                    'options' => amokit_caldera_forms_options(),
                ]
            );
        ...
        $this->add_responsive_control(
            ...
            $this->add_control(
                ...
                [
                    'label'     => __( 'Required Symbol Color', 'amokit-addons' ),
                    'type'      => Controls_Manager::COLOR,
                    'selectors' => [
            ...
            $this->add_responsive_control(
                'labels_space',
                [
                    'label'   => __( 'Space(px)', 'amokit-addons' ),
            ...
            // Description style
            $this->add_control(
                'amokit_form_description_heading',
                [
                    'label' => __( 'Description Style', 'amokit-addons' ),
            ...
            $this->start_controls_tabs(
                ...
                $this->start_controls_tab(
                    ...
                    $this->add_responsive_control(
                        ...
                        [
                            'label'             => __( 'Textarea Height', 'amokit-addons' ),
                            'type'              => Controls_Manager::SLIDER,
                            'range'             => [
                                'px' => [
                                    'min'   => 0,
                    ...
                    $this->add_responsive_control(
                        'input_space',
                        [
                            'label'   => __( 'Input Space', 'amokit-addons' ),
                            'type'    => Controls_Manager::SLIDER,
                            'default' => [
                                'size' => 15,
                            ],
        ...
        $this->start_controls_section(
            ...
            [
                'label'     => __( 'Errors and Success Style', 'amokit-addons' ),
                'tab'       => Controls_Manager::TAB_STYLE,
            ]
        );
            ...
            $this->add_control(
                ...
                [
                    'label'     => __( 'Error Text Color', 'amokit-addons' ),
                    'type'      => Controls_Manager::COLOR,
                    'selectors' => [
            ...
            // Validation style
            $this->add_control(
                'amokit_success_style',
                [
                    'label' => __( 'Validation Pass Style', 'amokit-addons' ),
                    'type' => Controls_Manager::HEADING,
                    'separator' => 'before',
                ]
            );
            $this->add_control(
                'amokit_validation_text_color',
                [
                    'label'     => __( 'Color', 'amokit-addons' ),
                    'type'      => Controls_Manager::COLOR,
                    'selectors' => [
            ...
            $this->add_control(
                'amokit_validation_border_color',
                [
                    'label'     => __( 'Border Color', 'amokit-addons' ),
                    'type'      => Controls_Manager::COLOR,
                    'selectors' => [
            ...
            // Feedback style
            $this->add_control(
                'amokit_confirmation_style',
                [
                    'label' => __( 'Confirmation Style', 'amokit-addons' ),
                    'type' => Controls_Manager::HEADING,
                    'separator' => 'before',
                ]
            );
            $this->add_control(
                'amokit__confirmation_text_color',
                [
                    'label'     => __( 'Color', 'amokit-addons' ),
                    'type'      => Controls_Manager::COLOR,
                    'selectors' => [
            ...
            $this->add_control(
                'amokit_confirmation_border_color',
                [
                    'label'     => __( 'Border Color', 'amokit-addons' ),
                    'type'      => Controls_Manager::COLOR,
                    'selectors' => [
            ...
            $this->add_group_control(
                Group_Control_Typography::get_type(),
                [
                    'name' => 'amokit__confirmation_text_typography',
    ...
    protected function render( $instance = [] ) {
        ...
        if ( !$settings['caldera_form_list'] ) {
            echo '<div class="amo-notices"><p>'.esc_html__('Please select a Contact Form From Setting!', 'amokit-addons').'</p></div>';
        }else{
