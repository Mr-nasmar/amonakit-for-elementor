...
class AmoKit_Elementor_Widget_Verticle_Time_Line extends Widget_Base {

    public function get_name() {
        return 'amokit-verticletimeline-addons';
    }
    
    public function get_title() {
        return __( 'Vertical Timeline', 'amokit-addons' );
    }

    public function get_icon() {
        return 'amokit-icon eicon-time-line';
    }
    ...
    public function get_keywords() {
        return ['amokit', 'Amona Kit', 'vertical timeline', 'timeline', 'content', 'addons','widget'];
    }

    public function get_help_url() {
        return 'https://nasdesigns.rf.gd/docs/creative-widgets/vertical-timeline-widget/';
    }
    protected function register_controls() {
        ...
        $this->start_controls_section(
            'button_content',
            [
                'label' => __( 'Vertical Timeline Layout', 'amokit-addons' ),
            ]
        );
            ...
            $this->add_control(
              'verticle_timeline_layout',
                ...
                'label'         => esc_html__( 'Layout', 'amokit-addons' ),
                    ...
                    'label_block'   => false,
                    'options'       => [
                        '1'    => esc_html__( 'Layout One', 'amokit-addons' ),
                        '2'   => esc_html__( 'Layout Two', 'amokit-addons' ),
                        '3'   => esc_html__( 'Layout Three', 'amokit-addons' ),
                        '4'   => esc_html__( 'Layout Four', 'amokit-addons' ),
                    ],
                ]
            );
        ...
        $this->start_controls_section(
            ...
            $repeater->add_control(
                'content_date',
                [
                    'label'   => __( 'Content Date', 'amokit-addons' ),
                    'type'    => Controls_Manager::TEXT,
                    'default' => __( 'Sep<br/>2018', 'amokit-addons' ),
                ]
            );
            ...
            $repeater->add_control(
                ...
                [
                    ...
                    'default' => __( 'Lorem ipsum dolor sit amet, consectetur adipis icing elit, sed do eiusmod tempor incid ut labore et dolore magna aliqua Ut enim ad min.', 'amokit-addons' ),
                ]
            );
            ...
            $this->add_control(
                ...
                [
                    ...
                    'default' => [
                        [
                            'content_date' => __( 'Sep<br/>2018', 'amokit-addons' ),
                            'content_text' => __( 'Lorem ipsum dolor sit amet, consectetur adipis icing elit, sed do eiusmod tempor incid ut labore et dolore magna aliqua Ut enim ad min.', 'amokit-addons' ),
                        ],
                        [
                            'content_date' => __( 'Oct<br/>2018', 'amokit-addons' ),
                            'content_text' => __( 'Lorem ipsum dolor sit amet, consectetur adipis icing elit, sed do eiusmod tempor incid ut labore et dolore magna aliqua Ut enim ad min.', 'amokit-addons' ),
                        ],
                        [
                            'content_date' => __( 'Aug<br/>2018', 'amokit-addons' ),
                            'content_text' => __( 'Lorem ipsum dolor sit amet, consectetur adipis icing elit, sed do eiusmod tempor incid ut labore et dolore magna aliqua Ut enim ad min.', 'amokit-addons' ),
                        ]
        ...
        $this->start_controls_section(
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'size_units' => [ 'px', '%', 'em' ],
                    'selectors' => [
                        '{{WRAPPER}} .amo-verticletimeline-style-4 .ht-ver-timeline .vertical-time .vertical-date,{{WRAPPER}} .htc-verctimeline-wrapper .ht-ver-timeline--2 .vertical-time .vertical-date span.month' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    ],
                    'condition' => [
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'type' => Controls_Manager::DIMENSIONS,
                    'selectors' => [
                        '{{WRAPPER}} .amo-verticletimeline-style-4 .ht-ver-timeline .vertical-time .vertical-date,
                        {{WRAPPER}} .amo-verticletimeline-style-4 .ht-ver-timeline .vertical-time .vertical-date:after,
                        {{WRAPPER}} .amo-verticletimeline-style-4 .ht-ver-timeline .vertical-time .vertical-date span.month,
            ...
            $this->add_control(
                'date_border_heading',
                [
                    'label' => __( 'Box Border', 'amokit-addons' ),
            ...
            $this->add_group_control(
                ...
                [
                    ...
                    'selector' => '{{WRAPPER}} .amo-verticletimeline-style-4 .ht-ver-timeline .vertical-time .vertical-date:after,{{WRAPPER}} .htc-verctimeline-wrapper .ht-ver-timeline--2 .vertical-time .vertical-date span.month:after,{{WRAPPER}} .htc-verctimeline-wrapper .ht-ver-timeline--3 .vertical-time .vertical-date span.month',
                    'condition' => [
            ...
            $this->add_control(
                ...
                [
                    ...
                    'selectors' => [
                        ...
                        '{{WRAPPER}} .htc-verctimeline-wrapper.amo-verticletimeline-style-4 .ht-ver-timeline .vertical-time::before' => 'border-color: {{VALUE}};',
            ...
            $this->add_control(
                ...
                [
                    'label' => __( 'Box Style Reverse', 'amokit-addons' ),
                    'type' => Controls_Manager::HEADING,
                    'separator' => 'before',
                    'condition' => [
                        'verticle_timeline_layout' =>array( '4','2'),
            ...
            $this->add_group_control(
                ...
                [
                    ...
                    'label' => __( 'Background', 'amokit-addons' ),
                    'types' => [ 'classic', 'gradient' ],
                    'selector' => '{{WRAPPER}} .amo-verticletimeline-style-4 .ht-ver-timeline.vertical-reverse .vertical-time .vertical-date:after,{{WRAPPER}} .htc-verctimeline-wrapper .ht-ver-timeline--2.vertical-reverse .vertical-time .vertical-date span.month:after',
                    'condition' => [
                        'verticle_timeline_layout' =>array( '4','2'),
                    ],
                ]
            ...
            $this->add_control(
                ...
                [
                    ...
                    'default'   =>'',
                    'selectors' => [
                        '{{WRAPPER}} .htc-verctimeline-wrapper.amo-verticletimeline-style-4 .ht-ver-timeline.vertical-reverse .vertical-time::before' => 'border-color: {{VALUE}};',
            ...
            $this->add_control(
                ...
                [
                    'label' => __( 'Box Background', 'amokit-addons' ),
                    'type' => Controls_Manager::HEADING,
                    'condition' => [
            ...
            $this->add_group_control(
                ...
                [
                    ...
                    'label' => __( 'Background', 'amokit-addons' ),
                    'types' => [ 'classic', 'gradient' ],
                    'selector' => '{{WRAPPER}} .amo-verticletimeline-style-4 .ht-ver-timeline .vertical-time .vertical-date span.month',
                    'condition' => [
                        'verticle_timeline_layout' =>'4',
                    ],
                ]
        ...
        $this->start_controls_section(
            ...
            [
                'label' => __( 'Timeline Style', 'amokit-addons' ),
                'tab' => Controls_Manager::TAB_STYLE,
            ]
        );
            ...
            $this->add_control(
                ...
                [
                    'label'     => __( 'Timeline Primary Color', 'amokit-addons' ),
                    'type'      => Controls_Manager::COLOR,
                    'default'   =>'',
                    'selectors' => [
            ...
            $this->add_control(
                'timeline_line_color',
                [
                    'label'     => __( 'Timeline Line Color', 'amokit-addons' ),
                    'type'      => Controls_Manager::COLOR,
                    'default'   =>'',
                    'selectors' => [
                        ...
                        '{{WRAPPER}} .htc-verctimeline-wrapper.amo-verticletimeline-style-2::before' => 'background-color: {{VALUE}};',
            ...
            $this->add_control(
                ...
                [
                    'label'     => __( 'Timeline Dot Color', 'amokit-addons' ),
                    'type'      => Controls_Manager::COLOR,
                    'default'   =>'',
                    'selectors' => [
                        '{{WRAPPER}} .htc-verctimeline-wrapper .ht-ver-timeline .vertical-time::before' => 'border-color: {{VALUE}};',
            ...
            $this->add_control(
                ...
                [
                    'label'     => __( 'Timeline Dot BG Color', 'amokit-addons' ),
                    'type'      => Controls_Manager::COLOR,
                    'default'   =>'',
                    'selectors' => [
            ...
            $this->add_control(
                ...
                [
                    'label'     => __( 'Timeline Dot Hover BG Color', 'amokit-addons' ),
                    'type'      => Controls_Manager::COLOR,
                    'default'   =>'',
                    'selectors' => [
            ...
            $this->add_control(
                ...
                [
                    'label'     => __( 'Timeline Hover Line Color', 'amokit-addons' ),
                    'type'      => Controls_Manager::COLOR,
                    'default'   =>'',
                    'selectors' => [
            ...
            $this->add_control(
                'dot_hover_gradient',
                [
                    'label' => __( ' Dot Border Hover Gradient Color', 'amokit-addons' ),
                    'type' => Controls_Manager::HEADING,
                    'separator' => 'before',
                    'condition' => [
                        'verticle_timeline_layout' =>array('2'),
    ...
    protected function render( $instance = [] ) {
        ...
        if( '4' == $settings['verticle_timeline_layout'] ){
            $this->add_render_attribute( 'verticle_timeline_attr', 'class', 'htc-verctimeline-wrapper amokit-verticletimeline-style-1 amokit-verticletimeline-style-' . esc_attr( $settings['verticle_timeline_layout'] ) );
        }else{
            $this->add_render_attribute( 'verticle_timeline_attr', 'class', 'htc-verctimeline-wrapper amokit-verticletimeline-style-' . esc_attr( $settings['verticle_timeline_layout'] ) );
        }
