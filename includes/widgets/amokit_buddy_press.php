...
class AmoKit_Elementor_Widget_Buddy_Press extends Widget_Base {

    public function get_name() {
        return 'amokit-buddypress-addons';
    }
    
    public function get_title() {
        return __( 'BuddyPress', 'amokit-addons' );
    }
    ...
    public function get_keywords() {
        return [ 'buddypress', 'buddypress widget', 'Social','amokit','amokit' ];
    }

    public function get_help_url() {
		return 'https://nasdesigns.rf.gd/docs/3rd-party-plugin-widgets/buddypress-widget/';
	}
    protected function register_controls() {
        ...
        $this->start_controls_section(
            'buddypress_content',
            [
                'label' => __( 'BuddyPress', 'amokit-addons' ),
            ]
        );
            ...
            $this->add_control(
                'buddypress_type',
                [
                    'label'   => __( 'Type', 'amokit-addons' ),
                    'type'    => Controls_Manager::SELECT,
                    'default' => 'member',
                    'options' => [
                        'member'    => __('Member', 'amokit-addons'),
                        'group'     => __('Group', 'amokit-addons'),
                    ],
                    'label_block'=>true,
                ]
            );
            ...
            $this->add_control(
                'content_type',
                [
                    'label'   => __( 'Content Type', 'amokit-addons' ),
                    'type'    => Controls_Manager::SELECT,
                    'default' => 'newest',
                    'options' => [
                        'newest'  => __('Newest', 'amokit-addons'),
                        'popular' => __('Popular', 'amokit-addons'),
                        'active'  => __('Active', 'amokit-addons'),
                    ],
                    'separator' =>'before',
                ]
            );
            ...
            $this->add_responsive_control(
                'max_items',
                [
                    'label'   => esc_html__( 'Max Item', 'amokit-addons' ),
            ...
            $this->add_control(
                'avatar_size',
                [
                    'label'     => __( 'Image Size', 'amokit-addons' ),
                    'type'      => Controls_Manager::SLIDER,
                    'default' => [
                        'size' => 80,
                    ],
            ...
            $this->add_control(
                'show_content_meta',
                [
                    'label' => __( 'Show Meta Info', 'amokit-addons' ),
            ...
            $this->add_control(
                'show_active_time',
                [
                    'label' => __( 'Show Active Time', 'amokit-addons' ),
                    'type' => Controls_Manager::SWITCHER,
                    'label_on' => __( 'Show', 'amokit-addons' ),
                    'label_off' => __( 'Hide', 'amokit-addons' ),
                    'return_value' => 'yes',
            ...
            $this->add_control(
                'show_register_time',
                [
                    'label' => __( 'Show Register Time', 'amokit-addons' ),
                    'type' => Controls_Manager::SWITCHER,
                    'label_on' => __( 'Show', 'amokit-addons' ),
                    'label_off' => __( 'Hide', 'amokit-addons' ),
                    'return_value' => 'yes',
            ...
            $this->add_control(
                'show_friend_count',
                [
                    'label' => __( 'Show Friend Count', 'amokit-addons' ),
                    'type' => Controls_Manager::SWITCHER,
                    'label_on' => __( 'Show', 'amokit-addons' ),
                    'label_off' => __( 'Hide', 'amokit-addons' ),
                    'return_value' => 'yes',
        ...
        $this->start_controls_section(
            ...
            $this->add_group_control(
                ...
                [
                    ...
                    'selector' => '{{WRAPPER}} .amo_buddypress_single',
                ]
            );
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'selectors' => [
                        '{{WRAPPER}} .amo_buddypress_single' => 'border-radius: {{TOP}}px {{RIGHT}}px {{BOTTOM}}px {{LEFT}}px;',
                    ],
                ]
            );
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'size_units' => [ 'px', '%', 'em' ],
                    'selectors' => [
                        '{{WRAPPER}} .amo_buddypress_single' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    ],
                    'separator' => 'before',
                ]
            );
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'size_units' => [ 'px', '%', 'em' ],
                    'selectors' => [
                        '{{WRAPPER}} .amo_buddypress_single' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                        '{{WRAPPER}} .amo_buddy_press_area' => 'margin-right:-{{RIGHT}}{{UNIT}};margin-left: -{{LEFT}}{{UNIT}};',
                    ],
                    'separator' => 'before',
                ]
            );
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'default' => '',
                    'selectors' => [
                        '{{WRAPPER}} .amo_buddypress_single' => 'text-align: {{VALUE}};',
                        '{{WRAPPER}} .amo_buddy_press_area' => 'text-align: {{VALUE}};',
                    ],
                ]
            );
            $this->add_responsive_control(
                'show_column',
                [
                    'label' => esc_html__( 'Column Width', 'amokit-addons' ),
                    'type' => Controls_Manager::SLIDER,
                    'description' => esc_html__( 'Add Column Width Ex. 25%', 'amokit-addons' ),
                    'size_units' => [ 'px', '%' ],
                    'range' => [
                        'px' => [
                            'min' => 0,
                    ...
                    'selectors' => [
                        '{{WRAPPER}} .amo_buddypress_single' => 'width: {{SIZE}}{{UNIT}};',
                    ],
                ]
            );
        $this->end_controls_section();
