...
class AmoKit_Elementor_Widget_Gravity_Forms extends Widget_Base {

    public function get_name() {
        return 'amokit-gravityforms-addons';
    }
    
    public function get_title() {
        return __( 'Gravity Forms', 'amokit-addons' );
    }

    public function get_keywords() {
        return [ 'form', 'contact', 'gravity', 'contact form','gravity form','amokit' ];
    }
    ...
    public function get_help_url() {
		return 'https://nasdesigns.rf.gd/docs/forms-widgets/gravity-forms-widget/';
	}
    ...
    public function amokit_gravity_forms_options() {
    ...
    protected function register_controls() {
        ...
        $this->start_controls_section(
            ...
            [
                'label' => __( 'Gravity Forms', 'amokit-addons' ),
            ]
        );
            ...
            $this->add_control(
                ...
                [
                    ...
                    'default' => '0',
                    'options' => $this->amokit_gravity_forms_options(),
                ]
            );
            ...
            $this->add_control(
                'show_description',
                [
                    'label'        => __( 'Show Description', 'amokit-addons' ),
                    'type'         => Controls_Manager::SWITCHER,
                    'default'      => 'no',
                    'label_on'     => __( 'Show', 'amokit-addons' ),
                    'label_off'    => __( 'Hide', 'amokit-addons' ),
            ...
            $this->add_control(
                'form_ajax',
                [
                    'label'        => __( 'From Ajax', 'amokit-addons' ),
                    'type'         => Controls_Manager::SWITCHER,
                    'default'      => 'no',
        ...
        $this->start_controls_section(
            ...
            $this->add_control(
                ...
                [
                    'label'     => __( 'Required Color', 'amokit-addons' ),
                    'type'      => Controls_Manager::COLOR,
                    'selectors' => [
            ...
            $this->add_group_control(
                Group_Control_Typography::get_type(),
                [
                    'name' => 'amokit_description_typography',
                    'selector' => '{{WRAPPER}} .gfield_description',
                ]
            );

            $this->add_responsive_control(
                'amokit_description_margin',
                [
                    'label' => __( 'Margin', 'amokit-addons' ),
                    'type' => Controls_Manager::DIMENSIONS,
                    'size_units' => [ 'px', '%', 'em' ],
        ...
        $this->start_controls_section(
            ...
            [
                'label'     => __( 'Errors and Confirmation Style', 'amokit-addons' ),
                'tab'       => Controls_Manager::TAB_STYLE,
            ]
        );
