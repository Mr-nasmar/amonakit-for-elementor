...
class AmoKit_Elementor_Widget_User_Login_Form extends Widget_Base {

    public function get_name() {
        return 'amokit-userlogin-form-addons';
    }
    
    public function get_title() {
        return __( 'User Login Form', 'amokit-addons' );
    }
    ...
    public function get_keywords() {
        return ['user login form', 'login form','amokit','Amona Kit'];
    }

    public function get_help_url() {
        return 'https://nasdesigns.rf.gd/docs/general-widgets/user-login-form-widget/';
    }
    ...
    protected function register_controls() {
        ...
        $this->start_controls_section(
            ...
            [
                'label' => __( 'Login Form', 'amokit-addons' ),
            ]
        );

            $this->add_control(
                'amokit_loginform_style',
                [
            ...
            $this->add_control(
                'amokit_loginform_header',
                [
                    'label' => __( 'Login Header', 'amokit-addons' ),
            ...
            $this->add_control(
                ...
                [
                    'label' => __( 'Login Header Title', 'amokit-addons' ),
            ...
            $this->add_control(
                ...
                [
                    'label' => __( 'Login Content', 'amokit-addons' ),
            ...
            $this->add_control(
                ...
                [
                    'label' => __( 'SingUp Text', 'amokit-addons' ),
                    'type' => Controls_Manager::TEXT,
                    'default' => __( 'Sign Up', 'amokit-addons' ),
                    'placeholder' => __( 'Sign Up', 'amokit-addons' ),
                    'condition'     => [
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'selectors' => [
                        '{{WRAPPER}} .amo-login-form-wrapper .user-register-header' => 'text-align: {{VALUE}};',
                    ],
                    'default' => 'left',
                    'condition'=>[
                        'show_loginform_heading'=>'yes',
            ...
            $this->add_control(
                'amokit_form_show_label',
                [
                    'label' => esc_html__( 'Label', 'amokit-addons' ),
                    'type' => Controls_Manager::SWITCHER,
                    'default' => 'yes',
            ...
            $this->add_control(
                'amokit_form_show_customlabel',
                [
                    'label' => esc_html__( 'Custom label', 'amokit-addons' ),
                    'type' => Controls_Manager::SWITCHER,
                    'default' => 'no',
                    'label_off' => esc_html__( 'Hide', 'amokit-addons' ),
                    'label_on' => esc_html__( 'Show', 'amokit-addons' ),
                    'condition' =>[
                        'amokit_form_show_label' => 'yes',
                    ]
                ]
            );
            ...
            $this->add_control(
                'amokit_user_label',
                    [
                    'label'     => esc_html__( 'Username Label', 'amokit-addons' ),
                    'type'      => Controls_Manager::TEXT,
                    'default'   => esc_html__( 'Username or Email', 'amokit-addons' ),
                    'condition' => [
                        'amokit_form_show_label'   => 'yes',
                        'amokit_form_show_customlabel' => 'yes',
                    ],
                ]
            );

            $this->add_control(
                'amokit_user_placeholder',
                [
                    'label'     => esc_html__( 'Username Placeholder', 'amokit-addons' ),
                    'type'      => Controls_Manager::TEXT,
                    'default'   => esc_html__( 'Username or Email', 'amokit-addons' ),
                    'condition' => [
                        'amokit_form_show_label'   => 'yes',
            ...
            $this->add_control(
                'amokit_password_label',
                [
                    'label'     => esc_html__( 'Password Label', 'amokit-addons' ),
                    'type'      => Controls_Manager::TEXT,
                    'default'   => esc_html__( 'Password', 'amokit-addons' ),
                    'condition' => [
                        'amokit_form_show_label'   => 'yes',
                        'amokit_form_show_customlabel' => 'yes',
                    ],
            ...
            $this->add_control(
                'lost_password_label',
                [
                    'label' => __( 'Lost Your Password ', 'amokit-addons' ) . ' <i class="eicon-pro-icon"></i>',
                    'type' => Controls_Manager::TEXT,
                    'default' => __( 'Lost your password?', 'amokit-addons' ),
            ...
            $this->add_control(
                'remember_me_label',
                [
                    'label' => __( 'Remember Me ', 'amokit-addons' ) . ' <i class="eicon-pro-icon"></i>',
                    'type' => Controls_Manager::TEXT,
                    'default' => __( 'Remember Me', 'amokit-addons' ),
                    'classes' => 'amokit-disable-control',
                    'condition'     => [
                        'amokit_form_show_customlabel' => 'yes',
                    ],
            ...
            $this->add_control(
                'redirect_page',
                [
                    'label' => __( 'Redirect page after Login', 'amokit-addons' ),
                    'type' => Controls_Manager::SWITCHER,
                    'default' => 'no',
                    'label_off' => __( 'No', 'amokit-addons' ),
                    'label_on' => __( 'Yes', 'amokit-addons' ),
            ...
            $this->add_control(
                'lost_password',
                [
                    'label'     => esc_html__( 'Lost your password?', 'amokit-addons' ),
                    'type'      => Controls_Manager::SWITCHER,
                    'default'   => 'yes',
                    'label_off' => esc_html__( 'Hide', 'amokit-addons' ),
                    'label_on'  => esc_html__( 'Show', 'amokit-addons' ),
            ...
            $this->add_control(
                ...
                [
                    'label' => __( 'Forget Password Position', 'amokit-addons' ),
                    'type' => Controls_Manager::SELECT,
                    'default' => 'before-login',
                    'options' => [
                        'before-login'    => __( 'Before/Top Login Button', 'amokit-addons' ),
                        'after-login'     => __( 'After/Bottom Login Button', 'amokit-addons' ),
                    ],
                    'condition'     => [
                        'lost_password' => 'yes',
                    ],
            ...
            $this->add_control(
                'remember_me',
                [
                    'label'     => esc_html__( 'Remember Me', 'amokit-addons' ),
                    'type'      => Controls_Manager::SWITCHER,
                    'default'   => 'yes',
                    'label_off' => esc_html__( 'Hide', 'amokit-addons' ),
                    'label_on'  => esc_html__( 'Show', 'amokit-addons' ),
            ...
            if ( get_option( 'users_can_register' ) ) {
                $this->add_control(
                    'register_link',
                    [
                        'label'     => esc_html__( 'Register Button', 'amokit-addons' ),
                        'type'      => Controls_Manager::SWITCHER,
                        'default'   => 'no',
                        'label_off' => esc_html__( 'Hide', 'amokit-addons' ),
                        'label_on'  => esc_html__( 'Show', 'amokit-addons' ),
                ...
                $this->add_control(
                    'register_link_text',
                    [
                        'label' => __( 'Register Link Text', 'amokit-addons' ),
                        'type' => Controls_Manager::TEXT,
                ...
                $this->add_control(
                    'custom_register_url',
                    [
                        'label' => __( 'Register Custom URL', 'amokit-addons' ).' <i class="eicon-pro-icon"></i>',
                        'type' => Controls_Manager::URL,
                        'placeholder' => __( 'https://your-link.com/register', 'amokit-addons' ),
                        'show_external' => true,
                        'classes' => 'amokit-disable-control',
                        'default' => [
                            'url'         => '#',
            ...
            $this->add_control(
                ...
                [
                    ...
                    'type' => Controls_Manager::TEXT,
                    'default' => __( 'Login', 'amokit-addons' ),
                ]
            );
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'selectors' => [
                        '{{WRAPPER}} .amo-login-form-wrapper .amo-login-button' => 'justify-content: {{VALUE}};',
                    ],
                    'default' => 'left',
                    'condition'     => [
                        'register_link!' => 'yes',
            ...
            $this->add_responsive_control(
                ...
                [
                    'label' => __( 'Display as', 'amokit-addons' ),
                    'type' => Controls_Manager::CHOOSE,
                    'options' => [
                        'row' => [
                            'title' => __( 'Row', 'amokit-addons' ),
                            'icon' => 'eicon-align-end-v',
                        ],
                        'column' => [
                            'title' => __( 'Column', 'amokit-addons' ),
                            'icon' => 'eicon-column',
                        ],
                        'row-reverse' => [
                            'title' => __( 'Row Reverse', 'amokit-addons' ),
                            'icon' => 'eicon-h-align-stretch',
                        ],
                    ],
                    'selectors' => [
                        '{{WRAPPER}} .amo-login-form-wrapper .amo-login-button' => 'flex-direction: {{VALUE}};',
                    ],
                    'default' => 'row',
                    'condition'     => [
                        'register_link' => 'yes',
            ...
            $this->add_control(
                ...
                [
                    'label' => __( 'Justify Content', 'amokit-addons' ),
                    'type' => Controls_Manager::SELECT,
                    'default' => 'space-between',
                    'options' => [
                        'flex-start'    => __( 'Start', 'amokit-addons' ),
                        'flex-end'      => __( 'End', 'amokit-addons' ),
                        'center'        => __( 'Center', 'amokit-addons' ),
                        'space-between' => __( 'Space Between', 'amokit-addons' ),
                        'space-around'  => __( 'Space Around', 'amokit-addons' ),
                        'space-evenly'  => __( 'Space Evenly', 'amokit-addons' ),
                    ],
                    'selectors' => [
                        '{{WRAPPER}} .amo-login-form-wrapper .amo-login-button' => 'justify-content: {{VALUE}};',
                    ],
            ...
            $this->add_responsive_control(
                ...
                [
                    'label' => __( 'Manual Space', 'amokit-addons' ),
                    ...
                    'selectors' => [
                        '{{WRAPPER}} .amo-login-form-wrapper .login-register-buit a.login_register_text' => 'margin-left: {{SIZE}}{{UNIT}};',
                    ],
                    'condition'     => [
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'selectors' => [
                        '{{WRAPPER}} .amo-login-form-wrapper .amo-login-button .login-register-buit' => 'margin-top: {{SIZE}}{{UNIT}};',
                    ],
                    'condition'     => [
                        'login_button_flex_direction' => 'column',
                        'register_link' => 'yes',
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'selectors' => [
                        '{{WRAPPER}} .amo-login-form-wrapper .login-register-buit a.login_register_text' => 'margin-right: {{SIZE}}{{UNIT}};',
                    ],
                    'condition'     => [
        ...
        // Style tab section
        $this->start_controls_section(
            'amokit_login_form_style_section',
            [
            ...
            $this->add_group_control(
                ...
                [
                    ...
                    'selector' => '{{WRAPPER}} .amo-login-form-wrapper',
                ]
            );
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'selectors' => [
                        '{{WRAPPER}} .amo-login-form-wrapper .input-alignment' => 'text-align: {{VALUE}};',
                        '{{WRAPPER}} .amo-rem-lost-alignment-single .log-remember' => 'justify-content: {{VALUE}};',
                    ],
                    'default' => 'left',
                    'separator' =>'before',
                ]
            ...
            $this->add_responsive_control(
                'amokit_login_area_border_radius',
                [
                    'label' => esc_html__( 'Border Radius', 'amokit-addons' ),
                    'type' => Controls_Manager::DIMENSIONS,
                    'selectors' => [
                        '{{WRAPPER}} .amo-login-form-wrapper' => 'border-radius: {{TOP}}px {{RIGHT}}px {{BOTTOM}}px {{LEFT}}px;',
                    ],
                ]
            );
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'size_units' => [ 'px', '%', 'em' ],
                    'selectors' => [
                        '{{WRAPPER}} .amo-login-form-wrapper' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    ],
                ]
            );
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'size_units' => [ 'px', '%', 'em' ],
                    'selectors' => [
                        '{{WRAPPER}} .amo-login-form-wrapper' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    ],
                ]
            );
        ...
        $this->start_controls_section(
            ...
            [
                'label' => __( 'Form Header', 'amokit-addons' ),
                'tab' => Controls_Manager::TAB_STYLE,
                'condition'=>[
                    'show_loginform_heading'=>'yes',
                ],
        ...
        $this->start_controls_section(
            ...
            $this->add_group_control(
                ...
                [
                    ...
                    'selector' => '{{WRAPPER}} .amo-login-form-wrapper input',
                ]
            );
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'size_units' => [ 'px', '%', 'em' ],
                    'selectors' => [
                        '{{WRAPPER}} .amo-login-form-wrapper input' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    ],
                ]
            );
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'size_units' => [ 'px', '%', 'em' ],
                    'selectors' => [
                        '{{WRAPPER}} .amo-login-form-wrapper input' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    ],
                    'separator' =>'before',
                ]
            );
            ...
            $this->add_control(
                ...
                [
                    ...
                    'selectors' => [
                        '{{WRAPPER}} .amo-login-form-wrapper input[type="text"],{{WRAPPER}} .amo-login-form-wrapper input[type="password"]' => 'height: {{SIZE}}{{UNIT}};',
                    ],
                    'separator' =>'before',
                ]
            );
            $this->add_responsive_control(
                ...
                [
                    ...
                    'selectors' => [
                        '{{WRAPPER}} .amo-login-form-wrapper .input-alignment input' => 'text-align: {{VALUE}};',
                    ],
                ]
            );  
            $this->add_control(
                ...
                $this->start_controls_tab(
                    ...
                    $this->add_control(
                        ...
                        [
                            ...
                            'type'      => Controls_Manager::COLOR,
                            'selectors' => [
                                '{{WRAPPER}} .amo-login-form-wrapper input'   => 'color: {{VALUE}};',
                            ],
                        ]
                    );
                    ...
                    $this->add_control(
                        ...
                        [
                            ...
                            'type'      => Controls_Manager::COLOR,
                            'selectors' => [
                                '{{WRAPPER}} .amo-login-form-wrapper input[type*="text"]::-webkit-input-placeholder'  => 'color: {{VALUE}};',
                                '{{WRAPPER}} .amo-login-form-wrapper input[type*="text"]::-moz-placeholder'  => 'color: {{VALUE}};',
                                '{{WRAPPER}} .amo-login-form-wrapper input[type*="text"]:-ms-input-placeholder'  => 'color: {{VALUE}};',
                                '{{WRAPPER}} .amo-login-form-wrapper input[type*="password"]::-webkit-input-placeholder'  => 'color: {{VALUE}};',
                                '{{WRAPPER}} .amo-login-form-wrapper input[type*="password"]::-moz-placeholder'  => 'color: {{VALUE}};',
                                '{{WRAPPER}} .amo-login-form-wrapper input[type*="password"]:-ms-input-placeholder'  => 'color: {{VALUE}};',
                                '{{WRAPPER}} .amo-login-form-wrapper input[type*="email"]::-webkit-input-placeholder'  => 'color: {{VALUE}};',
                                '{{WRAPPER}} .amo-login-form-wrapper input[type*="email"]::-moz-placeholder'  => 'color: {{VALUE}};',
                                '{{WRAPPER}} .amo-login-form-wrapper input[type*="email"]:-ms-input-placeholder'  => 'color: {{VALUE}};',
                            ],
                        ]
                    );
                    ...
                    $this->add_responsive_control(
                        ...
                        [
                            ...
                            'type' => Controls_Manager::DIMENSIONS,
                            'selectors' => [
                                '{{WRAPPER}} .amo-login-form-wrapper input' => 'border-radius: {{TOP}}px {{RIGHT}}px {{BOTTOM}}px {{LEFT}}px;',
                            ],
                        ]
                    );
                    $this->add_group_control(
                        ...
                        [
                            ...
                            'label' => __( 'Box Shadow', 'amokit-addons' ),
                            'selector' => '{{WRAPPER}} .amo-login-form-wrapper .input-alignment input',
                            'separator' =>'before',
                        ]
                    );
                ...
                $this->start_controls_tab(
                    ...
                    $this->add_control(
                        ...
                        [
                            ...
                            'type'      => Controls_Manager::COLOR,
                            'selectors' => [
                                '{{WRAPPER}} .amo-login-form-wrapper input:focus'   => 'color: {{VALUE}};',
                            ],
                        ]
                    );
                    ...
                    $this->add_group_control(
                        ...
                        [
                            ...
                            'label' => __( 'Background', 'amokit-addons' ),
                            'types' => [ 'classic', 'gradient' ],
                            'selector' => '{{WRAPPER}} .amo-login-form-wrapper input:focus',
                        ]
                    );
                    ...
                    $this->add_responsive_control(
                        ...
                        [
                            ...
                            'type' => Controls_Manager::DIMENSIONS,
                            'selectors' => [
                                '{{WRAPPER}} .amo-login-form-wrapper input:focus' => 'border-radius: {{TOP}}px {{RIGHT}}px {{BOTTOM}}px {{LEFT}}px;',
                            ],
                        ]
                    );
                    $this->add_group_control(
                        ...
                        [
                            ...
                            'label' => __( 'Box Shadow', 'amokit-addons' ),
                            'selector' => '{{WRAPPER}} .amo-login-form-wrapper .input-alignment input:focus',
                            'separator' =>'before',
                        ]
                    );
                $this->end_controls_tab();
        ...
        $this->start_controls_section(
            ...
            [
                'label' => __( 'Lost Password', 'amokit-addons' ),
                'tab' => Controls_Manager::TAB_STYLE,
                'condition' => [
                    'lost_password' => 'yes'
                ]
            ...
            $this->add_control(
                ...
                [
                    'label'     => __( 'Forget Text Color', 'amokit-addons' ),
                    'type'      => Controls_Manager::COLOR,
                    'selectors' => [
            ...
            $this->add_control(
                ...
                [
                    'label'     => __( 'Forget Text Hover Color', 'amokit-addons' ),
                    'type'      => Controls_Manager::COLOR,
                    'selectors' => [
        ...
        $this->start_controls_section(
            ...
            [
                'label' => __( 'Remember Me Checkbox', 'amokit-addons' ),
                'tab' => Controls_Manager::TAB_STYLE,
                 'condition' => [
                    'remember_me' => 'yes'
                 ]
            ...
            $this->add_control(
                ...
                [
                    'label'     => __( 'Checkbox Icon Color', 'amokit-addons' ),
                    'type'      => Controls_Manager::COLOR,
                    'selectors' => [
                        '{{WRAPPER}} .amo-login-form-wrapper span.checkmark, {{WRAPPER}} .lable-content .checkmark:after'   => 'color: {{VALUE}};border-color: {{VALUE}}',
                    ],
                ]
            );
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'size_units' => [ 'px', '%', 'em' ],
                    'selectors' => [
                        '{{WRAPPER}} .amo-login-form-wrapper span.checkmark' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    ],
                    'separator' =>'before',
                ]
            );
            ...
            $this->add_control(
                ...
                [
                    ...
                    'selectors' => [
                        '{{WRAPPER}} .amo-login-form-wrapper span.checkmark' => 'height: {{SIZE}}{{UNIT}};',
                    ],
                    'separator' =>'before',
                ]
            );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .amo-login-form-wrapper input[type="submit"]',
            ]
        );
            $this->add_responsive_control(
                ...
                [
                    ...
                    'size_units' => [ 'px', '%', 'em' ],
                    'selectors' => [
                        '{{WRAPPER}} .amo-login-form-wrapper input[type="submit"]' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    ],
                ]
            );
            $this->add_responsive_control(
                ...
                [
                    ...
                    'size_units' => [ 'px', '%', 'em' ],
                    'selectors' => [
                        '{{WRAPPER}} .amo-login-form-wrapper .amo-login-button' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    ],
                    'separator' =>'before',
                ]
            );
            $this->add_control(
                ...
                [
                    ...
                    'selectors' => [
                        '{{WRAPPER}} .amo-login-form-wrapper input[type="submit"]' => 'height: {{SIZE}}{{UNIT}};',
                    ],
                    'separator' =>'before',
                ]
            );
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'selectors' => [
                        '{{WRAPPER}} .amo-login-form-wrapper input[type="submit"]' => 'width: {{SIZE}}{{UNIT}};',
                    ],
                ]
            );
            $this->add_control(
                ...
                $this->start_controls_tab(
                    ...
                    $this->add_control(
                        ...
                        [
                            ...
                            'type'      => Controls_Manager::COLOR,
                            'selectors' => [
                                '{{WRAPPER}} .amo-login-form-wrapper input[type="submit"]'   => 'color: {{VALUE}};',
                            ],
                        ]
                    );
                    ...
                    $this->add_responsive_control(
                        ...
                        [
                            ...
                            'type' => Controls_Manager::DIMENSIONS,
                            'selectors' => [
                                '{{WRAPPER}} .amo-login-form-wrapper input[type="submit"]' => 'border-radius: {{TOP}}px {{RIGHT}}px {{BOTTOM}}px {{LEFT}}px;',
                            ],
                        ]
                    );
                ...
                $this->start_controls_tab(
                    ...
                    $this->add_control(
                        ...
                        [
                            ...
                            'type'      => Controls_Manager::COLOR,
                            'selectors' => [
                                '{{WRAPPER}} .amo-login-form-wrapper input[type="submit"]:hover'   => 'color: {{VALUE}};',
                            ],
                        ]
                    );
                    ...
                    $this->add_group_control(
                        ...
                        [
                            ...
                            'label' => __( 'Background', 'amokit-addons' ),
                            'types' => [ 'classic', 'gradient' ],
                            'selector' => '{{WRAPPER}} .amo-login-form-wrapper input[type="submit"]:hover',
                        ]
                    );
                    ...
                    $this->add_responsive_control(
                        ...
                        [
                            ...
                            'type' => Controls_Manager::DIMENSIONS,
                            'selectors' => [
                                '{{WRAPPER}} .amo-login-form-wrapper input[type="submit"]:hover' => 'border-radius: {{TOP}}px {{RIGHT}}px {{BOTTOM}}px {{LEFT}}px;',
                            ],
                        ]
                    );
        ...
        $this->start_controls_section(
            ...
            [
                'label' => __( 'Register Button', 'amokit-addons' ),
                'tab' => Controls_Manager::TAB_STYLE,
                'condition'=>[
                    'register_link'=>'yes',
                ],
                ...
                $this->start_controls_tab(
                    ...
                    $this->add_control(
                        ...
                        [
                            ...
                            'type'      => Controls_Manager::COLOR,
                            'selectors' => [
                                '{{WRAPPER}} .amo-login-form-wrapper .login-register-buit a.login_register_text' => 'color: {{VALUE}};',
                            ],
                        ]
                    );
                    ...
                    $this->add_group_control(
                        ...
                        [
                            ...
                            'selector' => '{{WRAPPER}} .amo-login-form-wrapper .login-register-buit a.login_register_text',
                        ]
                    );
                    ...
                    $this->add_responsive_control(
                        ...
                        [
                            ...
                            'size_units' => [ 'px', '%', 'em' ],
                            'selectors' => [
                                '{{WRAPPER}} .amo-login-form-wrapper .login-register-buit a.login_register_text' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                            ],
                        ]
                    );
                    ...
                    $this->add_responsive_control(
                        ...
                        [
                            ...
                            'type' => Controls_Manager::DIMENSIONS,
                            'selectors' => [
                                '{{WRAPPER}} .amo-login-form-wrapper .login-register-buit a.login_register_text' => 'border-radius: {{TOP}}px {{RIGHT}}px {{BOTTOM}}px {{LEFT}}px;',
                            ],
                        ]
                    );
                ...
                $this->start_controls_tab(
                    ...
                    $this->add_control(
                        ...
                        [
                            ...
                            'type'      => Controls_Manager::COLOR,
                            'selectors' => [
                                '{{WRAPPER}} .amo-login-form-wrapper .login-register-buit a.login_register_text:hover'   => 'color: {{VALUE}};',
                            ],
                        ]
                    );
                    ...
                    $this->add_group_control(
                        ...
                        [
                            ...
                            'label' => __( 'Background', 'amokit-addons' ),
                            'types' => [ 'classic', 'gradient' ],
                            'selector' => '{{WRAPPER}} .amo-login-form-wrapper .login-register-buit a.login_register_text:hover',
                        ]
                    );
                    ...
                    $this->add_responsive_control(
                        ...
                        [
                            ...
                            'type' => Controls_Manager::DIMENSIONS,
                            'selectors' => [
                                '{{WRAPPER}} .amo-login-form-wrapper .login-register-buit a.login_register_text:hover' => 'border-radius: {{TOP}}px {{RIGHT}}px {{BOTTOM}}px {{LEFT}}px;',
                            ],
                        ]
                    );
        ...
        $this->start_controls_section(
            ...
            $this->add_control(
                ...
                [
                    ...
                    'type'      => Controls_Manager::COLOR,
                    'selectors' => [
                        '{{WRAPPER}} .amo-login-form-wrapper label , {{WRAPPER}} .amo-login-form-wrapper .login_register_text'   => 'color: {{VALUE}};',
                    ],
                ]
            );
            ...
            $this->add_group_control(
                ...
                [
                    ...
                    'selector' => '{{WRAPPER}} .amo-login-form-wrapper label,{{WRAPPER}} .amo-login-form-wrapper .login_register_text',
                ]
            );
            ...
            $this->add_group_control(
                ...
                [
                    ...
                    'label' => __( 'Background', 'amokit-addons' ),
                    'types' => [ 'classic', 'gradient' ],
                    'selector' => '{{WRAPPER}} .amo-login-form-wrapper label',
                ]
            );
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'size_units' => [ 'px', '%', 'em' ],
                    'selectors' => [
                        '{{WRAPPER}} .amo-login-form-wrapper label' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    ],
                    'separator' =>'before',
                ]
            );
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'size_units' => [ 'px', '%', 'em' ],
                    'selectors' => [
                        '{{WRAPPER}} .amo-login-form-wrapper label' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    ],
                ]
            );
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'type' => Controls_Manager::DIMENSIONS,
                    'selectors' => [
                        '{{WRAPPER}} .amo-login-form-wrapper label' => 'border-radius: {{TOP}}px {{RIGHT}}px {{BOTTOM}}px {{LEFT}}px;',
                    ],
                ]
            );
    ...
    protected function render( $instance = [] ) {
        ...
        if ( $settings['lost_password'] == 'yes' &&  'yes' == $settings['remember_me'] ) {
            $remember_lost_p_alignment = 'amokit-rem-lost-alignment-both';
        } else {
            $remember_lost_p_alignment = 'amokit-rem-lost-alignment-single';
        }



        $this->add_render_attribute( 'loginform_area_attr', 'class', 'amokit-login-form-wrapper' );
        $this->add_render_attribute( 'loginform_area_attr', 'class', 'amokit-login-form-style-' . esc_attr( $settings['amokit_loginform_style'].' '.$remember_lost_p_alignment ) );

        // Label Value
        $user_label = isset( $settings['amokit_user_label'] ) ? $settings['amokit_user_label'] : __('Username','amokit-addons');
        $user_placeholder = isset( $settings['amokit_user_placeholder'] ) ? $settings['amokit_user_placeholder'] : __('Username','amokit-addons');
        $pass_label = isset( $settings['amokit_password_label'] ) ? $settings['amokit_password_label'] : __('Password','amokit-addons');
        $pass_placeholder = isset( $settings['amokit_password_placeholder'] ) ? $settings['amokit_password_placeholder'] : __('Password','amokit-addons');
        ...
        ?>
            <div <?php echo $this->get_render_attribute_string( 'loginform_area_attr' ); ?> >
                ...
                ?>
                    ...
                    <div class="user-register-header">
                        <?php if($settings['loginform_header_title']):
                            echo '<h2>'. amokit_kses_title($settings['loginform_header_title']) .'</h2>';
                        endif; ?>
                ...
                <form id="amokit_login_form_<?php echo esc_attr( $id ); ?>" action="formloginaction" method="post">
                    ...
                    <div class="htb-row">
                        ...
                        <div class="htb-col-lg-12 input-alignment">
                            <?php
                                ...
                                if( $settings['amokit_form_show_label'] == 'yes'){
                                    echo sprintf('<label for="%1$s">%2$s</label>' , esc_attr('login_username'. $id ), amokit_kses_title( $user_label ));
                                }
                        ...
                        <div class="htb-col-lg-12 input-alignment">
                            <?php
                                if( $settings['amokit_form_show_label'] == 'yes'){
                                    echo sprintf('<label for="%1$s">%2$s</label>', esc_attr( 'login_password'. $id ) , amokit_kses_title( $pass_label ));
                                }
                            ?>
                            <input 
                                type="password" 
                        ...
                        <div class="htb-col-lg-12 lost-password">
                            <div class="log-remember">
                                <?php if( $settings['remember_me'] == 'yes' ): ?>
                                    <label class="lable-content"><?php esc_html_e('Remember Me','amokit-addons'); ?>
                                        <input name="rememberme" type="checkbox" id="rememberme" value="forever">
                                        <span class="checkmark"></span>
                                    </label>
                                <?php endif; if( $settings['lost_password'] == 'yes' && $settings['lost_password_position'] == 'before-login' ): ?>
                                    <a href="<?php echo esc_url( wp_lostpassword_url( $current_url ) ); ?>" class="fright"><?php esc_html_e('Forgot Password?','amokit-addons'); ?></a>
                                <?php endif;?>
                            </div>
                        </div>

                        <div class="htb-col-lg-12">
                            <div class="amo-login-button">
                                <input 
                                    type="submit" 
                                    id="login_form_submit_<?php echo esc_attr( $id ); ?>" 
                                    name="login_form_submit<?php echo esc_attr( $id ); ?>" 
                                    value="<?php if( !empty( $settings['login_button_text'] ) ){ echo esc_attr( $settings['login_button_text'] ); } else { esc_html_e( 'Login', 'amokit-addons' ); } ?>">
                                    <div class="login-register-buit">
                                        <?php if( get_option( 'users_can_register' ) && $settings['register_link'] == 'yes' ): ?>
                                            <a href="<?php echo esc_url( wp_registration_url() ); ?>" class="login_register_text">
                                                <?php if( !empty( $settings['register_link_text'] ) ){ echo esc_attr( $settings['register_link_text'] ); } else { esc_html_e( 'Register', 'amokit-addons' ); } ?>
                                            </a>
                                        <?php endif;?>    
                                    </div>
        ...
        $this->amokit_login_check( $settings['redirect_page'], $redirect_url, $id );

    }

    public function amokit_login_check( $reddirectstatus, $redirect_url, $id ) {
        ...
        <script type="text/javascript">
            ...
            jQuery(document).ready(function($) {
                ...
                var login_form_id = 'form#amokit_login_form_<?php echo esc_attr( $id ); ?>';
                    ...
                    $.ajax({  
                        ...
                        success: function(msg){
                            if ( msg.loggeauth == true ){
                                $('#amokit_message_<?php echo esc_js( $id ); ?>').html('<div class="amo_success_msg alert alert-success">'+ msg.message +'</div>').fadeIn();
                                if( redirect === 'yes' ){
                                ...
                                $('#amokit_message_<?php echo esc_js( $id ); ?>').html('<div class="amo_invalid_msg alert alert-danger">'+ msg.message +'</div>').fadeIn();
                            }
                        }  
                    });
