...
class AmoKit_Elementor_Widget_Booked_Calender extends Widget_Base {

    public function get_name() {
        return 'amokit-bookedcalender-addons';
    }
    
    public function get_title() {
        return __( 'Booked Calendar', 'amokit-addons' );
    }
    ...
    public function get_keywords() {
        return [ 'booked ', 'booked calendar', 'calendar','amokit','amokit' ];
    }

    public function get_help_url() {
		return 'https://nasdesigns.rf.gd/docs/general-widgets/booked-calendar-widget/';
	}
    ...
    protected function register_controls() {
        ...
        $this->start_controls_section(
            ...
            [
                'label' => __( 'Booked Calender', 'amokit-addons' ),
            ]
        );
            ...
            $this->add_control(
                ...
                [
                    ...
                    'default' => '',
                    'options' => [
                        ''     => __('Default', 'amokit-addons') ,
                        'list' => __('List', 'amokit-addons') ,
                    ],
                ]
            );
            ...
            $this->add_control(
                ...
                [
                    ...
                    'default' => gmdate('d'),
                    'options' => [
                        '01'     => __( '01', 'amokit-addons' ),
                        '02'     => __( '02', 'amokit-addons' ),
                        '03'     => __( '03', 'amokit-addons' ),
                        '04'     => __( '04', 'amokit-addons' ),
                        '05'     => __( '05', 'amokit-addons' ),
                        '06'     => __( '06', 'amokit-addons' ),
                        '07'     => __( '07', 'amokit-addons' ),
                        '08'     => __( '08', 'amokit-addons' ),
                        '09'     => __( '09', 'amokit-addons' ),
                        '10'     => __( '10', 'amokit-addons' ),
                        '11'     => __( '11', 'amokit-addons' ),
                        '12'     => __( '12', 'amokit-addons' ),
                        '13'     => __( '13', 'amokit-addons' ),
                        '14'     => __( '14', 'amokit-addons' ),
                        '15'     => __( '15', 'amokit-addons' ),
                        '16'     => __( '16', 'amokit-addons' ),
                        '17'     => __( '17', 'amokit-addons' ),
                        '18'     => __( '18', 'amokit-addons' ),
                        '19'     => __( '19', 'amokit-addons' ),
                        '20'     => __( '20', 'amokit-addons' ),
                        '21'     => __( '21', 'amokit-addons' ),
                        '22'     => __( '22', 'amokit-addons' ),
                        '23'     => __( '23', 'amokit-addons' ),
                        '24'     => __( '24', 'amokit-addons' ),
                        '25'     => __( '25', 'amokit-addons' ),
                        '26'     => __( '26', 'amokit-addons' ),
                        '27'     => __( '27', 'amokit-addons' ),
                        '28'     => __( '28', 'amokit-addons' ),
                        '29'     => __( '29', 'amokit-addons' ),
                        '30'     => __( '30', 'amokit-addons' ),
                        '31'     => __( '31', 'amokit-addons' ),
                    ],
                ]
            );
            ...
            $this->add_control(
                'calendar_month',
                [
                    'label'   => __( 'Month', 'amokit-addons' ),
                    'type'    => Controls_Manager::SELECT,
                    'default' => gmdate('m'),
                    'options' => [
                        '01' => __('January', 'amokit-addons'),
                        '02' => __('February', 'amokit-addons'),
                        '03' => __('March', 'amokit-addons'),
                        '04' => __('April', 'amokit-addons'),
                        '05' => __('May', 'amokit-addons'),
                        '06' => __('June', 'amokit-addons'),
                        '07' => __('July', 'amokit-addons'),
                        '08' => __('August', 'amokit-addons'),
                        '09' => __('September', 'amokit-addons'),
                        '10' => __('October', 'amokit-addons'),
                        '11' => __('November', 'amokit-addons'),
                        '12' => __('December', 'amokit-addons'),
                    ],
                ]
            );
            ...
            $this->add_control(
                'calendar_year',
                [
                    'label'   => __( 'Year', 'amokit-addons' ),
                    'type'    => Controls_Manager::SELECT,
                    'default' => gmdate('Y'),
                    'options' => [
                        '2018'     => __( '2018', 'amokit-addons' ),
                        '2019'     => __( '2019', 'amokit-addons' ),
                        '2020'     => __( '2020', 'amokit-addons' ),
                        '2021'     => __( '2021', 'amokit-addons' ),
                        '2022'     => __( '2022', 'amokit-addons' ),
                        '2023'     => __( '2023', 'amokit-addons' ),
                        '2024'     => __( '2024', 'amokit-addons' ),
                        '2025'     => __( '2025', 'amokit-addons' ),
                        '2026'     => __( '2026', 'amokit-addons' ),
                        '2027'     => __( '2027', 'amokit-addons' ),
                        '2028'     => __( '2028', 'amokit-addons' ),
                        '2029'     => __( '2029', 'amokit-addons' ),
                        '2030'     => __( '2030', 'amokit-addons' ),
                        '2031'     => __( '2031', 'amokit-addons' ),
                        '2032'     => __( '2032', 'amokit-addons' ),
                        '2033'     => __( '2033', 'amokit-addons' ),
                        '2034'     => __( '2034', 'amokit-addons' ),
                        '2035'     => __( '2035', 'amokit-addons' ),
                        '2036'     => __( '2036', 'amokit-addons' ),
                        '2037'     => __( '2037', 'amokit-addons' ),
                        '2038'     => __( '2038', 'amokit-addons' ),
                        '2039'     => __( '2039', 'amokit-addons' ),
                        '2040'     => __( '2040', 'amokit-addons' ),
                    ],
                ]
            );
            ...
            $this->add_control(
                'calendar_size',
                [
                    'label'   => __( 'Calendar Size', 'amokit-addons' ),
                    'type'    => Controls_Manager::SELECT,
                    'default' => '',
                    'options' => [
                        ''      => __('Default', 'amokit-addons') ,
                        'small' => __('Small', 'amokit-addons') ,
                    ],
                ]
            );
            ...
            $this->add_control(
                ...
                [
                    'label' => __( 'Members Only', 'amokit-addons' ),
        ...
        $this->start_controls_section(
            ...
            $this->add_control(
                'header_background',
                [
                    'label'     => __( 'Header Background', 'amokit-addons' ),
            ...
            $this->add_control(
                ...
                [
                    'label'     => __( 'Day Name Background', 'amokit-addons' ),
                    'type'      => Controls_Manager::COLOR,
                    'selectors' => [
            ...
            $this->add_control(
                'header_day_color',
                [
                    'label'     => __( 'Day Name Color', 'amokit-addons' ),
                    'type'      => Controls_Manager::COLOR,
                    'selectors' => [
        ...
        $this->start_controls_section(
            ...
            $this->start_controls_tabs( 'booked_calender_date_style_tabs' );
                ...
                $this->start_controls_tab(
                    ...
                    [
                        'label' => __( 'Available Date', 'amokit-addons' ),
                    ]
                );
                ...
                $this->start_controls_tab(
                    ...
                    [
                        'label' => __( 'Current Date', 'amokit-addons' ),
                    ]
                );
        ...
        $this->start_controls_section(
            ...
            [
                'label'     => __( 'Appointments', 'amokit-addons' ),
                'tab'       => Controls_Manager::TAB_STYLE,
                'condition' => [
                    'calendar_style!' => 'list',
                ],
            ...
            $this->add_control(
                ...
                [
                    'label'     => __( 'Active Date Background Color', 'amokit-addons' ),
                    'type'      => Controls_Manager::COLOR,
                    'selectors' => [
            ...
            $this->add_control(
                ...
                [
                    'label'     => __( 'Time Slot Color', 'amokit-addons' ),
                    'type'      => Controls_Manager::COLOR,
                    'selectors' => [
                        '{{WRAPPER}} .booked-calendar-wrap .booked-appt-list .timeslot .spots-available' => 'color: {{VALUE}};',
                    ],
        ...
        $this->start_controls_section(
            ...
            [
                'label'     => __( 'Heading', 'amokit-addons' ),
                'tab'       => Controls_Manager::TAB_STYLE,
                'condition' => [
                    'calendar_style' => 'list',
                ],
        ...
        $this->start_controls_section(
            ...
            [
                'label'     => __( 'Appointment Button', 'amokit-addons' ),
                'tab'       => Controls_Manager::TAB_STYLE,
        ...
        $this->start_controls_section(
            ...
            [
                'label'     => __( 'Calendar', 'amokit-addons' ),
                'tab'       => Controls_Manager::TAB_STYLE,
                'condition' => [
                    'calendar_style' => 'list',
                ],
            ...
            $this->add_control(
                ...
                [
                    'label'     => __( 'Calendar Icon Color', 'amokit-addons' ),
                    'type'      => Controls_Manager::COLOR,
                    'selectors' => [
            ...
            $this->add_control(
                ...
                [
                    'label'     => __( 'Calendar Icon Background', 'amokit-addons' ),
                    'type'      => Controls_Manager::COLOR,
                    'selectors' => [
            ...
            $this->add_control(
                ...
                [
                    'label'      => __( 'Calendar Icon Radius', 'amokit-addons' ),
                    'type'       => Controls_Manager::DIMENSIONS,
                    'size_units' => [ 'px', '%' ],
                    'selectors'  => [
            ...
            $this->add_control(
                ...
                [
                    'label'      => __( 'Calendar Icon Padding', 'amokit-addons' ),
                    'type'       => Controls_Manager::DIMENSIONS,
                    'size_units' => [ 'px', 'em', '%' ],
                    'selectors'  => [
            ...
            $this->add_control(
                ...
                [
                    'label'     => __( 'Row Border Color', 'amokit-addons' ),
                    'type'      => Controls_Manager::COLOR,
                    'selectors' => [
            ...
            $this->add_control(
                ...
                [
                    'label' => __( 'Row Border Width', 'amokit-addons' ),
