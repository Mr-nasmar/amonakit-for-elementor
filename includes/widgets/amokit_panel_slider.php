...
class AmoKit_Elementor_Widget_Panel_Slider extends Widget_Base {

    public function get_name() {
        return 'amokit-panelslider-addons';
    }
    
    public function get_title() {
        return __( 'Panel Slider', 'amokit-addons' );
    }
    ...
    public function get_keywords() {
        return [ 'panel slider', 'slider widget','amokit','Amona Kit' ];
    }

    public function get_help_url() {
		return 'https://nasdesigns.rf.gd/docs/creative-widgets/panel-slider-widget/';
	}
    ...
    protected function register_controls() {
        ...
        $this->start_controls_section(
            ...
            [
                'label' => __( 'Panel Slider', 'amokit-addons' ),
            ]
        );
            ...
            $repeater->add_control(
                'slider_title',
                [
                    'label'   => __( 'Slider Title', 'amokit-addons' ),
                    'type'    => Controls_Manager::TEXT,
                    'default' => __( 'Tattoo Boy From New York', 'amokit-addons' ),
                ]
            );
            ...
            $repeater->add_control(
                'slider_sub_title',
                [
                    'label'   => __( 'Slider Sub Title', 'amokit-addons' ),
                    'type'    => Controls_Manager::TEXT,
                    'default' => __( 'Made in 2017', 'amokit-addons' ),
                ]
            );
            ...
            $this->add_control(
                ...
                [
                    ...
                    'default' => [
                        [
                            'slider_title' => __( 'Tattoo Boy From New York', 'amokit-addons' ),
                            'slider_sub_title' => __( 'Made in 2019', 'amokit-addons' ),
                        ],
                        [
                            'slider_title' => __( 'Tattoo Boy From New York', 'amokit-addons' ),
                            'slider_sub_title' => __( 'Made in 2018', 'amokit-addons' ),
                        ],
                        [
                            'slider_title' => __( 'Tattoo Boy From New York', 'amokit-addons' ),
                            'slider_sub_title' => __( 'Made in 2017', 'amokit-addons' ),
                        ],
                        [
                            'slider_title' => __( 'Tattoo Boy From New York', 'amokit-addons' ),
                            'slider_sub_title' => __( 'Made in 2016', 'amokit-addons' ),
                        ]
            ...
            $this->add_control(
                'linkshow_title',
                [
                    'label'         => __( 'Show link on Title', 'amokit-addons' ),
            ...
            $this->add_control(
                'linkshow_image',
                [
                    'label'         => __( 'Show link on Image', 'amokit-addons' ),
                    'type'          => Controls_Manager::SWITCHER,
                    'label_on'      => __( 'Yes', 'amokit-addons' ),
                    'label_off'     => __( 'No', 'amokit-addons' ),
                    'return_value'  => 'yes',
        ...
        $this->start_controls_section(
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'selectors' => [
                        '{{WRAPPER}} .panel-slider-wrapper.amo-carousel-activation' => 'margin: 0 -{{SIZE}}px',
                        '{{WRAPPER}} .panel-slider-wrapper.amo-carousel-activation .slick-track' => 'margin: 0',
                        '{{WRAPPER}} .panel-slider-wrapper.amo-carousel-activation .slick-track .slick-slide' => 'padding-left:{{SIZE}}px;padding-right: {{SIZE}}px',
                        '{{WRAPPER}} .panel_slider_style-4 .amo-carousel-activation .slick-slide' => 'margin:0',
                    ],
                ]
            );
            $this->add_control(
                'variable_width',
                [
                    'label' => esc_html__( 'Custom Width', 'amokit-addons' ),
                    'type' => Controls_Manager::SWITCHER,
                    'description' => __('Column width according to image', 'amokit-addons'),
                    'return_value' => 'yes',
                    'default' => 'no',
                    'condition' => [
                        'slider_on' => 'yes',
        ...
        $this->start_controls_section(
            ...
            [
                'label'     => __( 'Content area', 'amokit-addons' ),
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'size_units' => [ 'px', '%', 'em' ],
                    'selectors' => [
                        '{{WRAPPER}} .panel-slider .content,{{WRAPPER}} .panel_slider_style-2 .amo-carousel-activation .panel-slider .content' => 'top: auto; right: {{RIGHT}}{{UNIT}};bottom: {{BOTTOM}}{{UNIT}}; left: {{LEFT}}{{UNIT}};width:auto',
                        '{{WRAPPER}} .panel_slider_style-2 .amo-carousel-activation .panel-slider .content' => 'margin-bottom: -{{BOTTOM}}{{UNIT}};',
                        '{{WRAPPER}} .panel_slider_style-2 .amo-carousel-activation .panel-slider:hover .content' => 'margin-bottom: 0;',
                    ],
                ]
            );
            ...
            $this->add_group_control(
                ...
                [
                    ...
                    'label' => __( 'Background', 'amokit-addons' ),
                    'types' => [ 'classic', 'gradient' ],
                    'selector' => '{{WRAPPER}} .panel_slider_style-4 .amo-carousel-activation .panel-slider::before',
                    'condition' => [
                        'panel_slider_style' => '4',
                    ]
                ]
            ...
            $this->add_responsive_control(
                'Image_box_padding',
                [
                    'label' => __( 'Image Box Padding', 'amokit-addons' ),
                    'type' => Controls_Manager::DIMENSIONS,
                    'size_units' => [ 'px', '%', 'em' ],
                    'selectors' => [
                ...
                $this->start_controls_tab(
                    ...
                    $this->add_responsive_control(
                        ...
                        [
                            ...
                            'type' => Controls_Manager::DIMENSIONS,
                            'selectors' => [
                                '{{WRAPPER}} .amo-carousel-activation button.slick-arrow.amo-carosul-next' => 'border-radius: {{TOP}}px {{RIGHT}}px {{BOTTOM}}px {{LEFT}}px;',
                            ],
                        ]
                    );
                    $this->add_group_control(
                    ...
                    $this->add_responsive_control(
                        ...
                        [
                            ...
                            'selectors' => [
                                '{{WRAPPER}} .amo-carousel-activation button.slick-arrow' => 'left: {{SIZE}}{{UNIT}};',
                                '{{WRAPPER}} .amo-carousel-activation button.slick-arrow.amo-carosul-next' => 'right: {{SIZE}}{{UNIT}}; left:auto;',
                            ],
                        ]
                    );
                    $this->add_responsive_control(
                        ...
                        [
                            ...
                            'selectors' => [
                                '{{WRAPPER}} .amo-carousel-activation button.slick-arrow' => 'margin-top: {{SIZE}}{{UNIT}};margin-bottom:0px;',
                            ],
                ...
                $this->start_controls_tab(
                    ...
                    $this->add_group_control(
                        ...
                        [
                            ...
                            'label' => __( 'Border', 'amokit-addons' ),
                            'selector' => '{{WRAPPER}} .amo-carousel-activation .slick-dots li button:hover, {{WRAPPER}} .amo-carousel-activation .slick-dots li.slick-active button',
                        ]
                    );
    ...
    protected function render( $instance = [] ) {
        ...
        $custom_width_class = ('yes' == $settings['slcentermode'] && 'yes' == $settings['variable_width']) ? 'amokit-custom-width' : '';

        $this->add_render_attribute( 'amokit_panel_sliderarea_attr', 'class', 'panel_slider_area panel_slider_style-'. esc_attr( $settings['panel_slider_style'] .' '.$custom_width_class ) );
        ...
        if( $settings['slider_on'] == 'yes' ){
            ...
            $this->add_render_attribute( 'amokit_panel_slider_attr', 'dir', $direction );
            
            $this->add_render_attribute( 'amokit_panel_slider_attr', 'class', 'panel-slider-wrapper amokit-carousel-activation' );
            ...
            $this->add_render_attribute( 'amokit_panel_slider_attr', 'data-settings', wp_json_encode( $slider_settings ) );
        }
       
        ?>
            <div <?php echo $this->get_render_attribute_string( 'amokit_panel_sliderarea_attr' ); ?> >
                <div <?php echo $this->get_render_attribute_string( 'amokit_panel_slider_attr' ); ?> style="display:none">
