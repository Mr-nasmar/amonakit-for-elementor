...
class AmoKit_Elementor_Widget_WC_Element_Pages extends Widget_Base {

    public function get_name() {
        return 'amokit-wcpages-addons';
    }
    
    public function get_title() {
        return __( 'WC : Pages', 'amokit-addons' );
    }

    public function get_icon() {
        return 'amokit-icon eicon-product-pages';
    }
    public function get_keywords(){
        return ['amokit','cart page','woocommerce','single product page','checkout page','order tracking form','my account'];
    }

    public function get_help_url(){
        return 'https://nasdesigns.rf.gd/docs/woocommerce-widgets/woocommerce-page-widget/';
    }
    ...
    protected function register_controls() {
        ...
        $this->start_controls_section(
            'wcpages_content',
            [
                'label' => __( 'Element', 'amokit-addons' ),
            ]
        );
            $this->add_control(
                'element',
                [
                    'label' => __( 'Page', 'amokit-addons' ),
                    'type' => Controls_Manager::SELECT,
                    'options' => [
                        '' => '— ' . __( 'Select', 'amokit-addons' ) . ' —',
                        'woocommerce_cart' => __( 'Cart Page', 'amokit-addons' ),
                        'product_page' => __( 'Single Product Page', 'amokit-addons' ),
                        'woocommerce_checkout' => __( 'Checkout Page', 'amokit-addons' ),
                        'woocommerce_order_tracking' => __( 'Order Tracking Form', 'amokit-addons' ),
                        'woocommerce_my_account' => __( 'My Account', 'amokit-addons' ),
                    ],
                ]
            );
            ...
            $this->add_control(
                'product_id',
                [
                    'label'       => esc_html__( 'Choose Product', 'amokit-addons' ),
                    'type'        => Controls_Manager::SELECT,
                    'options'     => amokit_post_name('product'),
                    'label_block' => true,
                    'filter_type' => 'by_id',
                    'object_type' => [ 'product' ],
                    'condition'   => [
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Table Heading', 'amokit-addons' ),
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Table Body', 'amokit-addons' ),
                'tab'   => Controls_Manager::TAB_STYLE,
                'condition'   => [
                    'element' => [ 'woocommerce_cart' ],
                ],
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Coupon / Update Button', 'amokit-addons' ),
                'tab' => Controls_Manager::TAB_STYLE,
                'condition'   => [
                    'element' => [ 'woocommerce_cart' ],
                ],
            ...
            $this->start_controls_tabs( 'tabs_cart_button_style' );
                ...
                $this->start_controls_tab(
                    ...
                    $this->add_control(
                        ...
                        [
                            'label' => esc_html__( 'Border Color', 'amokit-addons' ),
                            'type' => Controls_Manager::COLOR,
                            'condition' => [
                                'cart_button_border!' => '',
                            ],
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Checkout Button', 'amokit-addons' ),
                'tab' => Controls_Manager::TAB_STYLE,
                'condition'   => [
                    'element' => [ 'woocommerce_cart' ],
                ],
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Quantity Input Box', 'amokit-addons' ),
                'tab'   => Controls_Manager::TAB_STYLE,
                'condition'   => [
                    'element' => [ 'woocommerce_cart' ],
                ],
        ...
        $this->start_controls_section(
            ...
            $this->add_control(
                ...
                [
                    'label'     => esc_html__( 'Required Color', 'amokit-addons' ),
                    'type'      => Controls_Manager::COLOR,
                    'selectors' => [
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Input', 'amokit-addons' ),
                'tab'   => Controls_Manager::TAB_STYLE,
                'condition'   => [
                    'element' => [ 'woocommerce_checkout' ],
                ],
            ...
            $this->start_controls_tabs( 'page_checkout_input_style_tabs' );
                ...
                $this->start_controls_tab(
                    ...
                    $this->add_responsive_control(
                        ...
                        [
                            'label' => esc_html__( 'Textarea Height', 'amokit-addons' ),
                    ...
                    $this->add_responsive_control(
                        ...
                        [
                            'label' => esc_html__( 'Element Space', 'amokit-addons' ),
                            'type' => Controls_Manager::SLIDER,
                            'default' => [
                                'size' => 20,
                            ],
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Payment', 'amokit-addons' ),
                'tab' => Controls_Manager::TAB_STYLE,
                'condition'   => [
                    'element' => [ 'woocommerce_checkout' ],
                ],
            ...
            $this->add_control(
                ...
                [
                    'label' => esc_html__( 'Button Style', 'amokit-addons' ),
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Order Review', 'amokit-addons' ),
                'tab'   => Controls_Manager::TAB_STYLE,
                'condition'   => [
                    'element' => [ 'woocommerce_checkout' ],
                ],
            ...
            $this->add_control(
                ...
                [
                    'label'     => __( 'Table Head', 'amokit-addons' ),
                    'type'      => Controls_Manager::HEADING,
                    'separator' => 'before',
                ]
            );
            ...
            $this->add_control(
                ...
                [
                    'label'     => __( 'Table Body Row', 'amokit-addons' ),
                    'type'      => Controls_Manager::HEADING,
                    'separator' => 'before',
                ]
            );
            ...
            $this->add_control(
                ...
                [
                    'label'     => __( 'Table Footer', 'amokit-addons' ),
                    'type'      => Controls_Manager::HEADING,
                    'separator' => 'before',
                ]
            );
        ...
        $this->start_controls_section(
            ...
            $this->start_controls_tabs( 'page_order_tracking_input_style_tabs' );
                ...
                $this->start_controls_tab(
                    ...
                    $this->add_control(
                        'amokit_page_order_tracking_input_placeholder_color',
                        [
                            'label' => __( 'Placeholder Color', 'amokit-addons' ),
                            'type' => Controls_Manager::COLOR,
                            'selectors'         => [
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Button', 'amokit-addons' ),
                'tab' => Controls_Manager::TAB_STYLE,
                'condition'   => [
                    'element' => [ 'woocommerce_order_tracking' ],
                ],
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Menu Style', 'amokit-addons' ),
                'tab' => Controls_Manager::TAB_STYLE,
                'condition'   => [
        ...
        switch ( $settings['element'] ) {
            ...
            case 'product_page':
                ...
                if ( empty( $product ) && current_user_can( 'manage_options' ) ) {
                    return __( 'Please set a valid product', 'amokit-addons' );
                }
    ...
    protected function render() {
        ...
        if ( empty( $shortcode ) ) {
            ...
            if ( 'woocommerce_checkout' === $this->get_settings( 'element' ) && '<div class="woocommerce"></div>' === $html ) {
                $html = '<div class="woocommerce">' . __( 'Your cart is currently empty.', 'amokit-addons' ) . '</div>';
            }
