...
class AmoKit_Elementor_Widget_Popover extends Widget_Base {

    public function get_name() {
        return 'amokit-popover-addons';
    }
    
    public function get_title() {
        return __( 'Popover', 'amokit-addons' );
    }

    public function get_icon() {
        return 'amokit-icon eicon-info-box';
    }
    ...
    public function get_keywords() {
        return ['popover', 'tooltip', 'pop over', 'popovers', 'amokit', 'Amona Kit', 'addons','widget'];
    }

    public function get_help_url() {
        return 'https://nasdesigns.rf.gd/docs/creative-widgets/popover-widget/';
    }
    protected function register_controls() {
        ...
        $this->start_controls_section(
            'popover_content',
            [
                'label' => __( 'Popover Button', 'amokit-addons' ),
            ]
        );
            ...
            $this->add_control(
                ...
                [
                    ...
                    'label_block' => true,
                    'default' => esc_html__( 'Popover', 'amokit-addons' ),
                    'condition' => [
        ...
        $this->start_controls_section(
            'popover_options',
            [
                'label' => __( 'Popover Options', 'amokit-addons' ),
            ]
        );
            $this->add_control(
                'popover_text',
                [
                    'label' => esc_html__( 'Popover Text', 'amokit-addons' ),
                    'type' => Controls_Manager::TEXTAREA,
                    'label_block' => true,
                    'default' => esc_html__( 'Popover content Here', 'amokit-addons' ),
                    'dynamic' => [ 'active' => true ]
                ]
            );
            ...
            $this->add_control(
                'popover_header_text',
                [
                    'label' => esc_html__( 'Popover Header Text', 'amokit-addons' ),
                    'type' => Controls_Manager::TEXT,
                    'label_block' => true,
                    'default' => esc_html__( 'Popover Header Here', 'amokit-addons' ),
                    'dynamic' => [ 'active' => true ]
                ]
            );
        ...
        $this->start_controls_section(
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'selectors' => [
                        '{{WRAPPER}} .amo-popover' => 'text-align: {{VALUE}};',
                    ],
                    'default' => 'center',
                    'separator' =>'before',
                ]
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'size_units' => [ 'px', '%', 'em' ],
                    'selectors' => [
                        '{{WRAPPER}} .amo-popover' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    ],
                    'separator' =>'before',
                ]
            );
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'size_units' => [ 'px', '%', 'em' ],
                    'selectors' => [
                        '{{WRAPPER}} .amo-popover' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    ],
                    'separator' =>'before',
                ]
            );
                ...
                $this->start_controls_tab(
                    ...
                    $this->add_control(
                        ...
                        [
                            ...
                            'default' => '#ffffff',
                            'selectors' => [
                                '{{WRAPPER}} .amo-popover span' => 'color: {{VALUE}};',
                                '{{WRAPPER}} .amo-popover span a' => 'color: {{VALUE}};',
                                '{{WRAPPER}} .amo-popover span svg path,{{WRAPPER}} .amo-popover span a svg path' => 'fill: {{VALUE}}; transition:all 0.3s ease-in-out;',
                            ],
                        ]
                    );
                    ...
                    $this->add_group_control(
                        ...
                        [
                            ...
                            'selector' => '{{WRAPPER}} .amo-popover span',
                            'condition'=>[
                                'popover_button_type'=>'text',
                            ]
                        ]
                    ...
                    $this->add_control(
                        ...
                        [
                            ...
                            'selectors' => [
                                '{{WRAPPER}} .amo-popover span i' => 'font-size: {{SIZE}}{{UNIT}};',
                                '{{WRAPPER}} .amo-popover span svg' => 'width: {{SIZE}}{{UNIT}};',
                            ],
                            'condition'=>[
                                'popover_button_type'=>'icon',
                    ...
                    $this->add_responsive_control(
                        ...
                        [
                            ...
                            'type' => Controls_Manager::DIMENSIONS,
                            'selectors' => [
                                '{{WRAPPER}} .amo-popover span' => 'border-radius: {{TOP}}px {{RIGHT}}px {{BOTTOM}}px {{LEFT}}px;',
                            ],
                        ]
                    );
                    ...
                    $this->add_responsive_control(
                        ...
                        [
                            ...
                            'size_units' => [ 'px', '%', 'em' ],
                            'selectors' => [
                                '{{WRAPPER}} .amo-popover span' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                            ],
                            'separator' =>'before',
                        ]
                    );
                    ...
                    $this->add_responsive_control(
                        ...
                        [
                            ...
                            'size_units' => [ 'px', '%', 'em' ],
                            'selectors' => [
                                '{{WRAPPER}} .amo-popover span' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                            ],
                            'separator' =>'before',
                        ]
                    );
                ...
                $this->start_controls_tab(
                    ...
                    $this->add_control(
                        ...
                        [
                            ...
                            'default' => '#ffffff',
                            'selectors' => [
                                '{{WRAPPER}} .amo-popover span:hover' => 'color: {{VALUE}};',
                                '{{WRAPPER}} .amo-popover span:hover svg path' => 'fill: {{VALUE}};',
                            ],
                        ]
                    );
                    ...
                    $this->add_group_control(
                        ...
                        [
                            ...
                            'label' => __( 'Background', 'amokit-addons' ),
                            'types' => [ 'classic', 'gradient' ],
                            'selector' => '{{WRAPPER}} .amo-popover span:hover',
                        ]
                    );
        ...
        $this->start_controls_section(
            ...
            [
                'label' => __( 'Popover', 'amokit-addons' ),
                'tab' => Controls_Manager::TAB_STYLE,
            ]
        );
            ...
            $this->start_controls_tabs('hover_popover_style_tabs');
                ...
                $this->start_controls_tab(
                    ...
                    $this->add_control(
                        ...
                        [
                            'label' => __( 'Arrow Border Color', 'amokit-addons' ),
                            'type' => Controls_Manager::COLOR,
                            'default' => '#e0e0e0',
                            'selectors' => [
                    ...
                    $this->add_control(
                        ...
                        [
                            'label' => __( 'Arrow Background Color', 'amokit-addons' ),
                            'type' => Controls_Manager::COLOR,
                            'default' => '#ffffff',
                            'selectors' => [
    ...
    protected function render( $instance = [] ) {
        ...
        $id = $this->get_id();
        $this->add_render_attribute( 'amokit_popover_attr', 'class', 'amokit-popover amokit-popover-container-'.$id );

        ?>
            
            <div <?php echo $this->get_render_attribute_string( 'amokit_popover_attr' ); ?>>
                <?php
                    ...
                    if( isset( $settings['popover_button_icon']['value'] ) ){
                        $button_txt = AmoKit_Icon_manager::render_icon( $settings['popover_button_icon'], [ 'aria-hidden' => 'true' ] );
                    }
                    ...
                    echo sprintf('<span class="%1$s" data-container=".amo-popover-container-%6$s" data-toggle="popover" data-placement="%2$s" data-content="%3$s" title="%4$s">%5$s</span>', esc_attr( $active_class ), esc_attr( $settings['popover_dir'] ), amokit_kses_desc( htmlspecialchars( $settings['popover_text'] ) ), amokit_kses_title( htmlspecialchars( $settings['popover_header_text'] ) ),  $button_txt, esc_attr( $id ) ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
                ?>
            </div>
