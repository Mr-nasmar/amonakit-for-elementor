...
class AmoKit_Elementor_Widget_Section_Title extends Widget_Base {
    ...
    public function get_title() {
        return __( 'Section Title', 'amokit-addons' );
    }

    public function get_icon() {
        return 'amokit-icon eicon-t-letter';
    }
    ...
    public function get_keywords() {
        return ['heading','section title','title','amokit', 'Amona Kit'];
    }

    public function get_help_url() {
        return 'https://nasdesigns.rf.gd/docs/general-widgets/section-title-widget/';
    }
    protected function register_controls() {
        ...
        $this->start_controls_section(
            ...
            $this->add_control(
                ...
                [
                    ...
                    'options' => [
                        ...
                        'four'  => __( 'Style Four', 'amokit-addons' ),
                        'five'  => __( 'Style Five', 'amokit-addons' ),
                    ],
                ]
            );
            ...
            $this->add_control(
                ...
                [
                    ...
                    'placeholder' => __( 'Enter your title', 'amokit-addons' ),
                    'default' => __( 'Add Your Heading Text Here', 'amokit-addons' ),
                    'title' => __( 'Enter your title', 'amokit-addons' ),
                    'description' => __( 'Put the highlighted word in between the span tags!', 'amokit-addons' ),
                ]
            );
            ...
            $this->add_control(
                ...
                [
                    ...
                    'type' => Controls_Manager::TEXTAREA,
                    'placeholder' => __( 'Enter your sub title', 'amokit-addons' ),
                    'default' => '',
                    'title' => __( 'Enter your sub title', 'amokit-addons' ),
                ]
            );
            ...
            $this->add_control(
                ...
                [
                    'label' => __( 'Advance Title', 'amokit-addons' ),
                    'type' => Controls_Manager::TEXTAREA,
                    'placeholder' => __( 'Enter your advance title', 'amokit-addons' ),
                    'default' => '',
                    'title' => __( 'Enter your advance title', 'amokit-addons' ),
                    'condition' =>[
                        'titlestyle' => 'five',
                    ],
                ]
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Title Setting', 'amokit-addons' ),
                'condition' => [
                    'section_title_text!' => '',
                ]
            ]
            ...
            $this->add_control(
                'section_title_tag',
                [
                    'label' => __( 'HTML Tag', 'amokit-addons' ),
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Sub Title Setting', 'amokit-addons' ),
                'condition' => [
                    'section_subtitle_text!' => '',
                ]
            ]
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Advance Title Setting', 'amokit-addons' ),
                'condition' => [
                    'section_advancetitle_text!' => '',
                ]
            ]
            ...
            $this->add_responsive_control(
                ...
                [
                    'label'   => esc_html__( 'X Offset', 'amokit-addons' ),
            ...
            $this->add_responsive_control(
                ...
                [
                    'label'   => esc_html__( 'Y Offset', 'amokit-addons' ),
                    'type'    => Controls_Manager::SLIDER,
                    'default' => [
                        'size' => 0,
                    ],
            ...
            $this->add_responsive_control(
                ...
                [
                    'label'   => esc_html__( 'Rotate', 'amokit-addons' ),
                    'type'    => Controls_Manager::SLIDER,
                    'default' => [
                        'size' => 0,
                    ],
        ...
        $this->start_controls_section(
            ...
            $this->add_group_control(
                ...
                [
                    ...
                    'selector' => '{{WRAPPER}} .amo-section-title',
                ]
            );
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'size_units' => [ 'px', '%', 'em' ],
                    'selectors' => [
                        '{{WRAPPER}} .amo-section-title' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    ],
                ]
            );
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'size_units' => [ 'px', '%', 'em' ],
                    'selectors' => [
                        '{{WRAPPER}} .amo-section-title' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    ],
                ]
            );
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'selectors' => [
                        '{{WRAPPER}} .amo-section-title' => 'text-align: {{VALUE}}; align-items: {{VALUE}};',
                    ],
                    'default' => 'center',
                    'prefix_class' => 'amokit-title-align%s-',
                ]
            );
            ...
            $this->add_control(
                ...
                [
                    'label' => __( 'Before And After Border Color', 'amokit-addons' ),
            ...
            $this->add_control(
                ...
                [
                    'label' => __( 'Title Separator Color', 'amokit-addons' ),
                    'type' => Controls_Manager::COLOR,
                    'default' => '#412e51',
                    'selectors' => [
                        '{{WRAPPER}} .amo-section-title span.amo-title-sperator' => 'background-color: {{VALUE}};',
                        '{{WRAPPER}} .amo-section-title span.amo-title-sperator::before' => 'background-color: {{VALUE}};',
                    ],
                    'condition' => [
            ...
            $this->add_responsive_control(
                ...
                [
                    'label' => __( 'Separator Specing', 'amokit-addons' ),
                    'type' => Controls_Manager::DIMENSIONS,
                    'size_units' => [ 'px', '%', 'em' ],
                    'selectors' => [
                        '{{WRAPPER}} .amo-section-title span.amo-title-sperator' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    ],
                    'condition' => [
                        'titlestyle' => 'four',
                    ]
        ...
        $this->start_controls_section(
            ...
            $this->add_control(
                ...
                [
                    ...
                    'default' => '#23252a',
                    'selectors' => [
                        '{{WRAPPER}} .amo-section-title .section-title-txt' => 'color: {{VALUE}};',
                    ],
                ]
            );
            ...
            $this->add_group_control(
                ...
                [
                    ...
                    'selector' => '{{WRAPPER}} .amo-section-title .section-title-txt',
                ]
            );
            ...
            $this->add_control(
                ...
                [
                    'label' => __( 'Highlight Title Color', 'amokit-addons' ),
                    'type' => Controls_Manager::HEADING,
                    'separator' =>'before',
                ]
            );
            ...
            $this->add_control(
                ...
                [
                    ...
                    'default' => '#23252a',
                    'selectors' => [
                        '{{WRAPPER}} .amo-section-title .section-title-txt span' => 'color: {{VALUE}};',
                    ],
                ]
            );
            ...
            $this->add_group_control(
                ...
                [
                    ...
                    'selector' => '{{WRAPPER}} .amo-section-title .section-title-txt span',
                ]
            );
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'type' => Controls_Manager::DIMENSIONS,
                    'selectors' => [
                        '{{WRAPPER}} .amo-section-title .section-title-txt' => 'border-radius: {{TOP}}px {{RIGHT}}px {{BOTTOM}}px {{LEFT}}px;',
                    ],
                ]
            );
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'size_units' => [ 'px', '%', 'em' ],
                    'selectors' => [
                        '{{WRAPPER}} .amo-section-title .section-title-txt' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    ],
                ]
            );
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'size_units' => [ 'px', '%', 'em' ],
                    'selectors' => [
                        '{{WRAPPER}} .amo-section-title .section-title-txt' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    ],
                ]
            );
            ...
            $this->add_responsive_control(
                'titledisplay',
                [
                    'label' => __( 'Display', 'amokit-addons' ),
                    'type' => Controls_Manager::CHOOSE,
                    'options' => [
                        'block' => [
                            'title' => __( 'Block', 'amokit-addons' ),
                            'icon' => 'eicon-device-desktop',
                        ],
                        'inline-block' => [
                            'title' => __( 'Inline block', 'amokit-addons' ),
                            'icon' => 'eicon-slider-push',
                        ],
                    ],
                    'selectors' => [
                        '{{WRAPPER}} .amo-section-title .section-title-txt' => 'display: {{VALUE}};',
                    ],
            ...
            $this->add_control(
                'amokit_section_title_font_backround',
                [
                    'label' => esc_html__( 'Use Backround for Text', 'amokit-addons' ),
            ...
            $this->add_control(
                'amokit_section_title_font_stroke',
                [
            ...
            $this->add_control(
                'amokit_section_title_font_stroke_color',
                [
                    ...
                    'condition' =>[
                        'amokit_section_title_font_stroke' => 'yes',
                    ]
                ]
            );
            $this->add_control(
                'amokit_section_title_font_stroke_widht',
                [
            ...
            $this->add_control(
                'amokit_section_litle_border_both',
                [
                    'label' => esc_html__( 'Befor, After Border', 'amokit-addons' ),
                    'type' => Controls_Manager::SWITCHER,
                    'return_value' => 'yes',
                    'default' => 'no',
                    'separator' =>'before',
            ...
            $this->add_responsive_control(
                'amokit_section_litle_border_both_width',
                [
                    'label'   => esc_html__( 'Border Width', 'amokit-addons' ),
                    'type'    => Controls_Manager::SLIDER,
                    'range' => [
                        'px' => [
                            'min' => 0,
                    ...
                    'condition' => [
                        'amokit_section_litle_border_both' => 'yes',
                    ]
                ]
            );

            $this->add_control(
                'amokit_section_litle_border_both_hight',
                [
                    'label' => esc_html__( 'Border Height', 'amokit-addons' ),
        ...
        $this->start_controls_section(
            ...
            $this->add_control(
                ...
                [
                    ...
                    'default' => '#23252a',
                    'selectors' => [
                        '{{WRAPPER}} .amo-section-title .section-subtitle-txt' => 'color: {{VALUE}};',
                    ],
                ]
            );
            ...
            $this->add_group_control(
                ...
                [
                    ...
                    'selector' => '{{WRAPPER}} .amo-section-title .section-subtitle-txt',
                ]
            );
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'type' => Controls_Manager::DIMENSIONS,
                    'selectors' => [
                        '{{WRAPPER}} .amo-section-title .section-subtitle-txt' => 'border-radius: {{TOP}}px {{RIGHT}}px {{BOTTOM}}px {{LEFT}}px;',
                    ],
                ]
            );
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'size_units' => [ 'px', '%', 'em' ],
                    'selectors' => [
                        '{{WRAPPER}} .amo-section-title .section-subtitle-txt' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    ],
                ]
            );
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'size_units' => [ 'px', '%', 'em' ],
                    'selectors' => [
                        '{{WRAPPER}} .amo-section-title .section-subtitle-txt' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    ],
                ]
            );
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'selectors' => [
                        '{{WRAPPER}} .amo-section-title .section-subtitle-txt' => 'display: {{VALUE}};',
                    ],
                    'default' => 'block',
                ]
            );
            ...
            $this->add_control(
                'amokit_section_sublitle_border_both',
                [
                    'label' => esc_html__( 'Befor, After Border', 'amokit-addons' ),
                    'type' => Controls_Manager::SWITCHER,
                    'return_value' => 'yes',
            ...
            $this->add_responsive_control(
                'amokit_section_sublitle_border_both_width',
                [
                    'label'   => esc_html__( 'Border Width', 'amokit-addons' ),
                    'type'    => Controls_Manager::SLIDER,
                    'range' => [
                    ...
                    'selectors' => [
                        '{{WRAPPER}} .amo_sub_title_border_both::before' => 'width: {{SIZE}}px;',
                        '{{WRAPPER}} .amo_sub_title_border_both::after' => 'width: {{SIZE}}px;',
                    ],
                    'condition' => [
                        'amokit_section_sublitle_border_both' => 'yes',
                    ]
                ]
            );

            $this->add_control(
                'amokit_section_sublitle_border_both_hight',
                [
                    'label' => esc_html__( 'Border Height', 'amokit-addons' ),
                    'type' => Controls_Manager::NUMBER,
                    'min' => 0,
                    ...
                    'default' => 2,
                    'selectors' => [
                        '{{WRAPPER}} .amo_sub_title_border_both::before, {{WRAPPER}} .amo_sub_title_border_both::after' => 'height: {{SIZE}}px;',
                    ],
                    'condition' => [
                        'amokit_section_sublitle_border_both' => 'yes',
                    ]
        ...
        $this->start_controls_section(
            ...
            [
                'label' => __( 'Advance Title style', 'amokit-addons' ),
                'tab' => Controls_Manager::TAB_STYLE,
                'condition' => [
                    'section_advancetitle_text!' => '',
                ]
            ...
            $this->add_control(
                ...
                [
                    ...
                    'default' => '#f1f1f1',
                    'selectors' => [
                        '{{WRAPPER}} .amo-section-title .section-advancetitle-txt' => 'color: {{VALUE}};',
                    ],
                ]
            );
            ...
            $this->add_group_control(
                ...
                [
                    ...
                    'selector' => '{{WRAPPER}} .amo-section-title .section-advancetitle-txt',
                ]
            );
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'type' => Controls_Manager::DIMENSIONS,
                    'selectors' => [
                        '{{WRAPPER}} .amo-section-title .section-advancetitle-txt' => 'border-radius: {{TOP}}px {{RIGHT}}px {{BOTTOM}}px {{LEFT}}px;',
                    ],
                    'separator' =>'before',
                ]
            );
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'size_units' => [ 'px', '%', 'em' ],
                    'selectors' => [
                        '{{WRAPPER}} .amo-section-title .section-advancetitle-txt' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    ],
                    'separator' =>'before',
                ]
            );
            ...
            $this->add_control(
                ...
                [
                    ...
                    'selectors' => [
                        '{{WRAPPER}} .amo-section-title .section-advancetitle-txt' => 'opacity: {{SIZE}};',
                    ],
                    'separator' =>'before',
                ]
            );
            ...
            $this->add_control(
                'amokit_section_advance_title_stroke',
                [
                    'label' => esc_html__( 'Stroke', 'amokit-addons' ),
                    'type' => Controls_Manager::SWITCHER,
                    'return_value' => 'yes',
            ...
            $this->add_control(
                'amokit_section_advance_title_stroke_color',
                [
                    'label' => __( 'Stroke Color', 'amokit-addons' ),
                    'type' => Controls_Manager::COLOR,
                    'default' => '#838383',
                    ...
                    'condition' =>[
                        'amokit_section_advance_title_stroke' => 'yes',
                    ]
                ]
            );
            $this->add_control(
                'amokit_section_advance_title_stroke_widht',
                [
                    'label' => __( 'Stroke Fill Width', 'amokit-addons' ),
                    'type' => Controls_Manager::SLIDER,
                    'size_units' => [ 'px', '%' ],
    ...
    protected function render( $instance = [] ) {
        ...
        $this->add_render_attribute( 'section_area_attr', 'class', "$sectionid amokit-section-title" );
        $this->add_render_attribute( 'section_area_attr', 'class', 'amokit-subtitle-position-'. esc_attr( $settings['subtitle_position'] ) );

        $image_pasition_parent = ($settings['subtitle_position'] == 'bottom') ? 'amokit-section-title-order-parent' : ''; 
        ...
        $subTitleBoderBoth = '';
        if($settings['amokit_section_sublitle_border_both'] == 'yes'){
            $subTitleBoderBoth = ' amokit_sub_title_border_both';
        }
        ...
        $title_tag = amokit_validate_html_tag( $settings['section_title_tag'] );
        $sub_title_tag = amokit_validate_html_tag( $settings['section_subtitle_tag'] );
            ...
            <div <?php echo $this->get_render_attribute_string( 'section_area_attr' ); ?>>
                <?php
                    if( $titlestyle == 'one' ){
                        ...
                        if( !empty( $title ) ){
                            echo sprintf( '<%1$s %2$s>%3$s</%1$s>%4$s', $title_tag, $this->get_render_attribute_string( 'section_title_text' ), $title, '<div class=amokit-title-sperator-sec><span class="amo-title-sperator">&nbsp;</span></div>' );
                        }
                        ...
                        if( !empty( $settings['titleicon']['value'] ) ){
                            echo "<div {$title_image_pasition}>" .amo_Icon_manager::render_icon( $settings['titleicon'], [ 'aria-hidden' => 'true' ] ). '</div>';
                        }
        ...
        <?php
        if($settings['amokit_section_title_font_backround'] == 'yes' || !empty($settings['section_advancetitle_rotate']['size']) ||  !empty($settings['section_advancetitle_x_position']['size']) || !empty($settings['section_advancetitle_y_position']['size'])){ 
            $css_print = "";
            if($settings['amokit_section_title_font_backround'] == 'yes'){

                $css_print.= ".{$sectionid}.amo-section-title .section-title-txt{ -webkit-background-clip: text; -webkit-text-fill-color: transparent;}";
