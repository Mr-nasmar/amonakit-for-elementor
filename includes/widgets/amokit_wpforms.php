...
class AmoKit_Elementor_Widget_WPforms extends Widget_Base {

    public function get_name() {
        return 'amokit-wpforms-addons';
    }
    
    public function get_title() {
        return __( 'WP Form', 'amokit-addons' );
    }
    ...
    public function get_keywords() {
        return [ 'form', 'contact', 'wpforms','Amona Kit','amokit' ];
    }

    public function get_help_url() {
		return 'https://nasdesigns.rf.gd/docs/forms-widgets/wp-forms-widget/';
	}
    ...
    public function amokit_wpforms_forms(){
        $formlist = array();
        ...
        if( $forms ){
            ...
            $formlist[ __( 'Form not found', 'amokit-addons' ) ] = 0;
        }
        return $formlist;
    }
    ...
    protected function register_controls() {
        ...
        $this->start_controls_section(
            'wpforms_content',
            [
                'label' => __( 'WP Form', 'amokit-addons' ),
            ]
        );
            $this->add_control(
                'contact_form_list',
                [
                    ...
                    'label_block'       => true,
                    'options'           => $this->amokit_wpforms_forms(),
                    'default'           => '0',
                ]
            );
        ...
        $this->start_controls_section(
            ...
            $this->add_control(
                ...
                [
                    'label' => __( 'Required Label Style', 'amokit-addons' ),
                    'type' => Controls_Manager::HEADING,
                    'separator' => 'before',
                ]
            );
        ...
        $this->start_controls_section(
            ...
            [
                'label'     => __( 'Errors Style', 'amokit-addons' ),
                'tab'       => Controls_Manager::TAB_STYLE,
            ]
        );
    ...
    protected function render( $instance = [] ) {
        ...
        if ( !$settings['contact_form_list'] ) {
            echo '<p>'.esc_html__('Please Select form.','amokit-addons').'</p>';
        }else{
