...
class AmoKit_Elementor_Widget_QUforms extends Widget_Base {

    public function get_name() {
        return 'amokit-quforms-addons';
    }
    
    public function get_title() {
        return __( 'QU Form', 'amokit-addons' );
    }

    public function get_keywords() {
        return [ 'form', 'contact', 'qu', 'contact form','qu form','amokit' ];
    }
    ...
    public function get_help_url() {
		return 'https://nasdesigns.rf.gd/docs/forms-widgets/quform-widget/';
	}
    ...
    public function amokit_quform_list() {
    ...
    protected function register_controls() {
        ...
        $this->start_controls_section(
            'quform_content',
            [
                'label' => __( 'QU Form', 'amokit-addons' ),
            ]
        );
            ...
            $this->add_control(
                ...
                [
                    ...
                    'default' => '0',
                    'options' => $this->amokit_quform_list(),
                ]
            );
        ...
        $this->start_controls_section(
            ...
            [
                'label'     => __( 'Sub Label', 'amokit-addons' ),
                'tab'       => Controls_Manager::TAB_STYLE,
            ]
        );
            $this->add_responsive_control(
    ...
    protected function render( $instance = [] ) {
        ...
        if (!$settings['contact_form_list']) {
            echo '<p>'.esc_html__('Please select Contact Form', 'amokit-addons').'</p>';
        }else{
            $form_attributes = [
