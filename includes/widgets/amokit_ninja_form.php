...
class AmoKit_Elementor_Widget_Ninja_Form extends Widget_Base {

    public function get_name() {
        return 'amokit-ninjaform-addons';
    }
    
    public function get_title() {
        return __( 'Ninja Form', 'amokit-addons' );
    }
    ...
    public function get_keywords() {
        return [ 'form', 'contact', 'ninja', 'contact form','ninja form','amokit' ];
    }
    ...
    public function get_help_url() {
		return 'https://nasdesigns.rf.gd/docs/forms-widgets/ninja-form-widget/';
	}
    ...
    public function amokit_ninja_forms_list() {
        $form_options = array();
    ...
    protected function register_controls() {
        ...
        $this->start_controls_section(
            'ninjaform_content',
            [
                'label' => __( 'Ninja Form', 'amokit-addons' ),
            ]
        );
            ...
            $this->add_control(
                'ninja_form',
                [
                    'label'   => esc_html__( 'Select Form', 'amokit-addons' ),
                    'type'    => Controls_Manager::SELECT,
                    'options' => $this->amokit_ninja_forms_list(),
                ]
            );
        ...
        $this->start_controls_section(
            ...
            $this->add_control(
                'show_form_title',
                [
                    'label'                 => __( 'Title Hide', 'amokit-addons' ),
            ...
            $this->add_control(
                ...
                [
                    'label'                 => __( 'Description Hide', 'amokit-addons' ),
                    'type'                  => Controls_Manager::SWITCHER,
                    'selectors' => [
        ...
        $this->start_controls_section(
            ...
            $this->add_control(
                'amokit_form_description_text_color',
                [
                    'label'     => __( 'Color', 'amokit-addons' ),
                    'type'      => Controls_Manager::COLOR,
                    'selectors' => [
            ...
            $this->add_group_control(
                Group_Control_Typography::get_type(),
                [
                    'name' => 'amokit_form_description_typogra',
                    'selector' => '{{WRAPPER}} .nf-field-description',
                ]
            );
            $this->add_responsive_control(
                'amokit_form_input_description_margin',
                [
                    'label' => __( 'Margin', 'amokit-addons' ),
                    'type' => Controls_Manager::DIMENSIONS,
                    'size_units' => [ 'px', '%', 'em' ],
        ...
        $this->start_controls_tabs(
            ...
            $this->add_control(
                'amokit_input_placeholder_color',
                [
        ...
        $this->start_controls_section(
            ...
            $this->start_controls_tabs(
                ...
                $this->start_controls_tab(
                    ...
                    $this->add_control(
                        'amokit_textarea_placeholder_color',
                        [
                            'label' => __( 'Placeholder Color', 'amokit-addons' ),
                            'type' => Controls_Manager::COLOR,
                            'selectors'         => [
        ...
        $this->start_controls_section(
            ...
            $this->add_control(
                ...
                [
                    'label'     => __( 'Error Color', 'amokit-addons' ),
                    'type'      => Controls_Manager::COLOR,
                    'selectors' => [
            ...
            $this->add_control(
                ...
                [
                    'label' => __( 'Success Style', 'amokit-addons' ),
                    'type' => Controls_Manager::HEADING,
                    'separator' => 'before',
                ]
            );
