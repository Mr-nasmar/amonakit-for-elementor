...
class AmoKit_Elementor_Widget_Post_Grid_Tab extends Widget_Base {

    public function get_name() {
        return 'amokit-postgridtab-addons';
    }
    
    public function get_title() {
        return __( 'Post Grid Tab', 'amokit-addons' );
    }
    ...
    public function get_keywords() {
        return [ 'post grid tab', 'post tab','custom post grid','post grid','post','amokit addons' ];
    }
    
    public function get_help_url() {
		return 'https://nasdesigns.rf.gd/docs/post-widgets/post-grid-tab-widget/';
	}
    protected function register_controls() {
        ...
        $this->start_controls_section(
            ...
            [
                'label' => __( 'Post Grid Tab', 'amokit-addons' ),
            ]
        );
        ...
        $this->start_controls_section(
            ...
            $this->add_control(
                'show_date',
                [
                    'label' => esc_html__( 'Meta', 'amokit-addons' ),
                    'type' => Controls_Manager::SWITCHER,
                    'return_value' => 'yes',
                    'default' => 'yes',
                ]
        ...
        $this->start_controls_section(
            ...
            [
                'label' => __( 'Expand Box Style', 'amokit-addons' ),
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'selectors' => [
                        ...
                        {{WRAPPER}} .amo-post-gridtab-layout-2 .post-content,
                        {{WRAPPER}} .amo-post-gridtab-layout-4 .post-content,
                        {{WRAPPER}} .amo-post-gridtab-layout-5 .post-content
        ...
        $this->start_controls_section(
            ...
            [
                'label' => __( 'Group Item Style', 'amokit-addons' ),
                'tab' => Controls_Manager::TAB_STYLE,
            ]
        );
    ...
    protected function render( $instance = [] ) {
        ...
        $this->add_render_attribute( 'amokit_post_gridtab', 'class', 'ht-post-grid-tab amokit-post-gridtab-layout-'.$settings['post_grid_style'] );
        ...
        $this->add_render_attribute( 'amokit_post_gridtab', 'data-postgridtab', wp_json_encode( $tabs_options ) );
       
        ?>
            <div <?php echo $this->get_render_attribute_string( 'amokit_post_gridtab' ); ?>>
                <?php
                    ...
                    while( $grid_post->have_posts() ) : $grid_post->the_post();
                        ...
                        elseif( $settings['post_grid_style'] == 3 ):
                            ...
                            if( $countrow % 3 == 0 ){
                                ...
                                $image_size = 'amokit_size_585x295';
                            }else{
