...
class AmoKit_Elementor_Widget_Special_day_Banner extends Widget_Base {

    public function get_name() {
        return 'amokit-specialdaybanner-addons';
    }
    
    public function get_title() {
        return __( 'Special Day Offer', 'amokit-addons' );
    }
    ...
    public function get_keywords() {
        return ['special day', 'banner', 'product banner', 'adds', 'amokit', 'Amona Kit', 'addons','widget'];
    }

    public function get_help_url() {
        return 'https://nasdesigns.rf.gd/docs/creative-widgets/special-day-offer-widget/';
    }
    protected function register_controls() {
        ...
        $this->start_controls_section(
            ...
            $this->add_control(
                'banner_offer',
                [
                    'label' => __( 'Offer Amount', 'amokit-addons' ),
                    'type' => Controls_Manager::TEXT,
                    'placeholder' => __( '50%', 'amokit-addons' ),
                ]
            );
            ...
            $this->add_control(
                ...
                [
                    'label' => __( 'Offer Tag Line', 'amokit-addons' ),
                    'type' => Controls_Manager::TEXT,
                    'placeholder' => __( 'Off', 'amokit-addons' ),
                ]
            );
            ...
            $this->add_control(
                'banner_badge_toggle',
                [
                    'label' => __( 'Banner Badge', 'amokit-addons' ),
            ...
            $this->start_popover();
                ...
                $this->add_control(
                    'banner_badge_image',
                    [
                        'label' => __( 'Badge Image', 'amokit-addons' ),
                        'type' => Controls_Manager::MEDIA,
                    ]
                );
                ...
                $this->add_responsive_control(
                    ...
                    [
                        ...
                        'selectors' => [
                            '{{WRAPPER}} .amo-banner .htbanner-badgeimage' => 'width: {{SIZE}}{{UNIT}};',
                        ],
                    ]
                );
                ...
                $this->add_responsive_control(
                    'badge_x_position',
                    [
                        'label' => __( 'Horizontal Postion', 'amokit-addons' ),
                        'type' => Controls_Manager::SLIDER,
                        'size_units' => [ 'px', '%' ],
                        'default' => [
                            'size' => 25,
                        ...
                        'selectors' => [
                            '{{WRAPPER}} .amo-banner .htbanner-badgeimage' => 'left: {{SIZE}}{{UNIT}};',
                        ],
                    ]
                );
                ...
                $this->add_responsive_control(
                    'badge_y_position',
                    [
                        'label' => __( 'Vertical Postion', 'amokit-addons' ),
                        'type' => Controls_Manager::SLIDER,
                        'size_units' => [ 'px', '%' ],
                        'default' => [
                            'size' => 0,
                        ...
                        'selectors' => [
                            '{{WRAPPER}} .amo-banner .htbanner-badgeimage' => 'top: {{SIZE}}{{UNIT}};',
                        ],
                    ]
                );
        ...
        $this->start_controls_section(
            ...
            $this->add_control(
                ...
                [
                    'label' => __( 'Banner Hover Color', 'amokit-addons' ),
            ...
            $this->add_group_control(
                ...
                [
                    ...
                    'selector' => '{{WRAPPER}} .amo-banner .banner-thumb a::before,{{WRAPPER}} .amo-banner:hover .banner-thumb a::after',
                    'separator' =>'before',
                ]
            );
        ...
        $this->start_controls_section(
            ...
            $this->add_control(
                ...
                [
                    ...
                    'default' => '#1f1e26',
                    'selectors' => [
                        '{{WRAPPER}} .amo-banner .banner-content h5' => 'color: {{VALUE}};',
                    ]
                ]
            );
            ...
            $this->add_group_control(
                ...
                [
                    ...
                    'label' => __( 'Typography', 'amokit-addons' ),
                    'selector' => '{{WRAPPER}} .amo-banner .banner-content h5',
                ]
            );
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'size_units' => [ 'px', '%', 'em' ],
                    'selectors' => [
                        '{{WRAPPER}} .amo-banner .banner-content h5' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    ],
                ]
            );
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'size_units' => [ 'px', '%', 'em' ],
                    'selectors' => [
                        '{{WRAPPER}} .amo-banner .banner-content h5' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    ],
                ]
            );
        ...
        $this->start_controls_section(
            ...
            $this->add_control(
                ...
                [
                    ...
                    'default' => '#1f1e26',
                    'selectors' => [
                        '{{WRAPPER}} .amo-banner .banner-content h5 span' => 'color: {{VALUE}};',
                    ]
                ]
            );
            ...
            $this->add_group_control(
                ...
                [
                    ...
                    'label' => __( 'Typography', 'amokit-addons' ),
                    'selector' => '{{WRAPPER}} .amo-banner .banner-content h5 span',
                ]
            );
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'size_units' => [ 'px', '%', 'em' ],
                    'selectors' => [
                        '{{WRAPPER}} .amo-banner .banner-content h5 span' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    ],
                ]
            );
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'size_units' => [ 'px', '%', 'em' ],
                    'selectors' => [
                        '{{WRAPPER}} .amo-banner .banner-content h5 span' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    ],
                ]
            );
    ...
    protected function render( $instance = [] ) {
        ...
        $this->add_render_attribute( 'amokit_banner', 'class', 'amokitspcial-banner amokit-banner amokit-banner-content-pos-' . esc_attr( $settings['banner_content_pos'] ) );
                ...
                <div class="banner-content">
                    <?php
                        ...
                        if( !empty( $settings['banner_button_txt'] ) ){
                            echo '<a '.$this->get_render_attribute_string( 'url' ).'>'.amo_kses_desc( $settings['banner_button_txt'] ).'</a>';
                        }
                    ?>
                </div>
            </div>
