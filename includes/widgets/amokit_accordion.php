...
class AmoKit_Elementor_Widget_Accordion extends Widget_Base {

    public function get_name() {
        return 'amokit-accordion-addons';
    }
    
    public function get_title() {
        return __( 'Accordion / FAQ', 'amokit-addons' );
    }

    public function get_icon() {
        return 'amokit-icon eicon-accordion';
    }

    public function get_keywords() {
        return ['accordion', 'faq', 'amokit', 'Amona Kit', 'addons'];
    }

    public function get_help_url() {
        return 'https://nasdesigns.rf.gd/docs/general-widgets/faq-widget/';
    }
    ...
    protected function register_controls() {
        ...
        $this->start_controls_section(
            ...
            $repeater->add_control(
                'icon_type',
                [
                    'label' => __('Title Icon', 'amokit-addons') . ' <i class="eicon-pro-icon"></i>',
            ...
            $repeater->add_control(
                'accordion_content', 
                [
                    'label'       => __( 'Accordion Content', 'amokit-addons' ),
            ...
            $this->add_control(
            'amokit_accordion_list',
            [
                'label'     => __( 'Accordion Items', 'amokit-addons' ),
                ...
                'default' => [
                    [
                        'accordion_title'   => __( 'Accordion Title One', 'amokit-addons' ),
                    ...
                    [
                        'accordion_title'   => __( 'Accordion Title Two', 'amokit-addons' ),
                        'accordion_content' => __( 'Anim pariatur cliche reprehenderit, enim eiusmod high life accusamus terry richardson ad squid. 3 wolf moon officia aute, non cupidatat skateboard dolor brunch. Food truck quinoa nesciunt laborum eiusmod. Brunch 3 wolf moon tempor, sunt aliqua put a bird on it squid single-origin coffee nulla assumenda shoreditch et. Nihil anim keffiyeh helvetica, craft beer labore wes anderson cred nesciunt sapiente ea proident. Ad vegan excepteur butcher vice lomo. Leggings occaecat craft beer farm-to-table, raw denim aesthetic synth nesciunt you probably have not heard of them accusamus labore sustainable VHS.', 'amokit-addons' ),
                    ],
                    [
                        'accordion_title'   => __( 'Accordion Title Two', 'amokit-addons' ),
            ...
            [
                ...
                'default' => [
                    [
                        'accordion_title'   => __( 'Accordion Title', 'amokit-addons' ),
            ...
            $repeater3->add_control(
                ...
                [
                    ...
                    'label'      => __( 'Accordion Content', 'amokit-addons' ),
                    'type'       => Controls_Manager::WYSIWYG,
                    'default'    => __( 'Accordion Content', 'amokit-addons' ),
                    'condition' => [
                        'content_source' =>'custom',
                    ],
                ]
            ...
            $this->add_control(
                'accordion_open_icon',
                [
                    'label'       => __( 'Item Collapse Icon', 'amokit-addons' ),
            ...
            $this->add_control(
                ...
                [
                    'label'       => __( 'Open Item Icon', 'amokit-addons' ),
                    'type'        => Controls_Manager::ICONS,
                    'default' => [
                        'value' => 'fas fa-minus',
                        'library' => 'solid',
            ...
            $this->add_control(
                ...
                [
                    'label'   => __( 'Show Short Description ', 'amokit-addons' ) . ' <i class="eicon-pro-icon"></i>',
            ...
            $this->add_control(
                'accordion_close_all',
                [
                    'label'   => __( 'Close All Item', 'amokit-addons' ),
                    'type'    => Controls_Manager::SWITCHER,
                    'default' => 'yes',
                    'return_value' => 'yes',
                    'condition' => [
            ...
            $this->add_control(
                'accordion_multiple',
                [
                    'label' => __( 'Multiple Item Open', 'amokit-addons' ),
                    'type'  => Controls_Manager::SWITCHER,
                    'return_value' => 'yes',
                    'condition' => [
                        'accordiantstyle' => ['five','one'],
            ...
            $this->add_control(
                'current_item',
                [
                    'label' => __( 'Current Item No', 'amokit-addons' ),
            ...
            $this->add_control(
                'show_title_icon',
                [
                    'label'   => __( 'Show Title Icon ', 'amokit-addons' ) . ' <i class="eicon-pro-icon"></i>',
                    'type'    => Controls_Manager::SWITCHER,
                    'default' => 'no',
                    'return_value' => 'yes',
                    'condition' => [
        ...
        $this->start_controls_section(
            ...
            $this->add_control(
                ...
                [
                    'label' => __( 'Visible Item', 'amokit-addons' ),
             ...
             $this->add_control(
                ...
                [
                    'label' => __( 'Accordion Height', 'amokit-addons' ),
                    'type'  => Controls_Manager::SLIDER,
                    'range' => [
                        'px' => [
                            'min' => 0,
            ...
            $this->add_control(
                ...
                [
                    'label' => __( 'Expand Item Height', 'amokit-addons' ),
                    'type'  => Controls_Manager::SLIDER,
                    'range' => [
                        'px' => [
                            'min' => 0,
        ...
        $this->start_controls_section(
            ...
            [
                'label' => __( 'Accordion Item', 'amokit-addons' ),
            ...
            $this->add_control(
                ...
                [
                    'label' => __( 'Accordion Item Spacing', 'amokit-addons' ),
                    'type'  => Controls_Manager::SLIDER,
                    'range' => [
                        'px' => [
                            'min' => 0,
        ...
        $this->start_controls_section(
            'amokit_accordion_title_style',
            [
                'label'     => __( 'Accordion Title', 'amokit-addons' ),
                'tab'       => Controls_Manager::TAB_STYLE,
                'condition' => [
                    'accordiantstyle' => ['five','one'],
                ],
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'selectors' => [
                        '{{WRAPPER}} .amo-accourdion-title'   => 'text-align: {{VALUE}};',
                    ],
                ]
            );
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'size_units' => [ 'px', '%', 'em' ],
                    'selectors' => [
                        '{{WRAPPER}} .amo-items-hedding' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    ],
                    'separator' => 'before',
                ]
            );
            $this->add_group_control(
                ...
                [
                    ...
                    'selector' => '{{WRAPPER}} .amo-accourdion-title .amo-items-hedding',
                    'separator' => 'before',
                ]
            );
            ...
            $this->start_controls_tabs('amokit_accordion_title_style_tabs');
                ...
                $this->start_controls_tab(
                    ...
                    $this->add_control(
                        ...
                        [
                            ...
                            'selectors' => [
                                '{{WRAPPER}} .htb-collapsed.amo-items-hedding' => 'color: {{VALUE}};',
                            ],
                        ]
                    );
                    ...
                    $this->add_group_control(
                        ...
                        [
                            ...
                            'selector' => '{{WRAPPER}} .htb-collapsed.amo-items-hedding',
                        ]
                    );
                    ...
                    $this->add_responsive_control(
                        ...
                        [
                            ...
                            'type' => Controls_Manager::DIMENSIONS,
                            'selectors' => [
                                '{{WRAPPER}} .htb-collapsed.amo-items-hedding' => 'border-radius: {{TOP}}px {{RIGHT}}px {{BOTTOM}}px {{LEFT}}px;',
                            ],
                        ]
                    );
                ...
                $this->start_controls_tab(
                    ...
                    $this->add_control(
                        ...
                        [
                            ...
                            'type'      => Controls_Manager::COLOR,
                            'selectors' => [
                                '{{WRAPPER}} .amo-items-hedding' => 'color: {{VALUE}};',
                            ],
                        ]
                    );
                    $this->add_group_control(
                        ...
                        [
                            ...
                            'label' => __( 'Background', 'amokit-addons' ),
                            'types' => [ 'classic', 'gradient' ],
                            'selector' => '{{WRAPPER}} .amo-items-hedding',
                        ]
                    );
                    ...
                    $this->add_responsive_control(
                        ...
                        [
                            ...
                            'type' => Controls_Manager::DIMENSIONS,
                            'selectors' => [
                                '{{WRAPPER}} .amo-items-hedding' => 'border-radius: {{TOP}}px {{RIGHT}}px {{BOTTOM}}px {{LEFT}}px;',
                            ],
                        ]
                    );
        ...
        $this->start_controls_section(
            'amokit_accordion_title_three_collapsed_style',
            [
                'label'     => __( 'Accordion Title Collapsed', 'amokit-addons' ),
                'tab'       => Controls_Manager::TAB_STYLE,
                'condition' => [
        ...
        $this->start_controls_section(
            'amokit_accordion_item_two_style',
            [
                'label'     => __( 'Accordion Item Box', 'amokit-addons' ),
                'tab'       => Controls_Manager::TAB_STYLE,
                'condition' => [
        ...
        $this->start_controls_section(
            'amokit_accordion_title_three_style',
            [
                'label'     => __( 'Accordion Title', 'amokit-addons' ),
                'tab'       => Controls_Manager::TAB_STYLE,
                'condition' => [
            ...
            $this->add_responsive_control(
                'titlethree_margin',
                [
                    'label' => __( 'Active Title Space', 'amokit-addons' ),
                    'type' => Controls_Manager::SLIDER,
                    'size_units' => [ 'px', '%' ],
                    'selectors' => [
            ...
            $this->add_responsive_control(
                ...
                [
                    'label' => __( 'Active Title Line Height', 'amokit-addons' ),
                    'type' => Controls_Manager::SLIDER,
                    'size_units' => [ 'px', '%' ],
                    'selectors' => [
                        '{{WRAPPER}} .accordion--5 .single_accordion .va-title.amova-active' => 'line-height: {{SIZE}}{{UNIT}} !important;',
                    ],
                    'condition' => [
                        'accordiantstyle' =>'four',
                    ],
        ...
        $this->start_controls_section(
            'amokit_accordion_icon_style',
            [
                'label'     => __( 'Accordion Icon', 'amokit-addons' ),
                'tab'       => Controls_Manager::TAB_STYLE,
                'condition' => [
                    'accordiantstyle' => ['five','one'],
                ],
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'selectors' => [
                        '{{WRAPPER}} .amo-accourdion-title .amo-items-hedding .accourdion-icon i' => 'font-size: {{SIZE}}{{UNIT}};',
                        '{{WRAPPER}} .amo-accourdion-title .amo-items-hedding .accourdion-icon svg' => 'width: {{SIZE}}{{UNIT}};',
                    ],
                ]
            );
            ...
            $this->add_responsive_control(
                ...
                [
                    'label' => __( 'Icon Box Width', 'amokit-addons' ),
                    'type'  => Controls_Manager::SLIDER,
                    'range' => [
                        'px' => [
                            'min' => 0,
                    ...
                    'selectors' => [
                        '{{WRAPPER}} .amo-accourdion-title .amo-items-hedding .accourdion-icon' => 'width: {{SIZE}}{{UNIT}};',
                    ],
                ]
            );
            ...
            $this->add_responsive_control(
                ...
                [
                    'label' => __( 'Icon Box Height', 'amokit-addons' ),
                    'type'  => Controls_Manager::SLIDER,
                    'range' => [
                        'px' => [
                            'min' => 0,
                    ...
                    'selectors' => [
                        '{{WRAPPER}} .amo-accourdion-title .amo-items-hedding .accourdion-icon' => 'height: {{SIZE}}{{UNIT}};',
                    ],
                ]
            );
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'size_units' => [ 'px', '%', 'em' ],
                    'selectors' => [
                        '{{WRAPPER}} .amo-accourdion-title .amo-items-hedding .accourdion-icon' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    ],
                ]
            );
            $this->add_control(
            ...
            $this->start_controls_tabs('amokit_accordion_icon_style_tabs');
                ...
                $this->start_controls_tab(
                    ...
                    $this->add_control(
                        ...
                        [
                            ...
                            'type'      => Controls_Manager::COLOR,
                            'selectors' => [
                                '{{WRAPPER}} .amo-accourdion-title .amo-items-hedding.htb-collapsed .accourdion-icon' => 'color: {{VALUE}};',
                                '{{WRAPPER}} .amo-accourdion-title .amo-items-hedding.htb-collapsed .accourdion-icon svg' => 'fill: {{VALUE}};',
                            ],
                        ]
                    );
                    ...
                    $this->add_group_control(
                        ...
                        [
                            ...
                            'label' => __( 'Background', 'amokit-addons' ),
                            'types' => [ 'classic', 'gradient' ],
                            'selector' => '{{WRAPPER}} .amo-accourdion-title .amo-items-hedding.htb-collapsed .accourdion-icon',
                        ]
                    );
                    $this->add_group_control(
                        Group_Control_Border::get_type(),
                    ...
                    $this->add_responsive_control(
                        ...
                        [
                            ...
                            'type' => Controls_Manager::DIMENSIONS,
                            'selectors' => [
                                '{{WRAPPER}} .amo-accourdion-title .amo-items-hedding.htb-collapsed .accourdion-icon' => 'border-radius: {{TOP}}px {{RIGHT}}px {{BOTTOM}}px {{LEFT}}px;',
                            ],
                        ]
                    );
                ...
                $this->start_controls_tab(
                    ...
                    $this->add_control(
                        ...
                        [
                            ...
                            'type'      => Controls_Manager::COLOR,
                            'selectors' => [
                                '{{WRAPPER}} .amo-accourdion-title .amo-items-hedding .accourdion-icon' => 'color: {{VALUE}};',
                                '{{WRAPPER}} .amo-accourdion-title .amo-items-hedding .accourdion-icon svg' => 'fill: {{VALUE}};',
                            ],
                        ]
                    );
                    $this->add_group_control(
                        ...
                        [
                            ...
                            'label' => __( 'Background', 'amokit-addons' ),
                            'types' => [ 'classic', 'gradient' ],
                            'selector' => '{{WRAPPER}} .amo-accourdion-title .amo-items-hedding .accourdion-icon',
                        ]
                    );
                    ...
                    $this->add_responsive_control(
                        ...
                        [
                            ...
                            'type' => Controls_Manager::DIMENSIONS,
                            'selectors' => [
                                '{{WRAPPER}} .amo-accourdion-title .amo-items-hedding .accourdion-icon' => 'border-radius: {{TOP}}px {{RIGHT}}px {{BOTTOM}}px {{LEFT}}px;',
                            ],
                        ]
                    );
        ...
        $this->start_controls_section(
            'amokit_accordion_content_style',
            [
                'label'     => __( 'Accordion Content', 'amokit-addons' ),
                'tab'       => Controls_Manager::TAB_STYLE,
                'condition' => [
    ...
    protected function render( $instance = [] ) {
        ...
        $accordion_list     = $settings['amokit_accordion_list'];
        $accordion_list_two = $settings['amokit_accordion_list_two'];
        $accordion_list_three = $settings['amokit_accordion_list_three'];
        $accordion_id       = $this->get_id();
        $this->add_render_attribute( 'accordion_heading', 'data-toggle', 'htbcollapse' );

        $title_tag = amokit_validate_html_tag( $settings['accourdion_title_html_tag'] );
        ...
        if( $settings['accordiantstyle'] == 'two' ){
                    ...
                    foreach ( $accordion_list_three as $itemthree ) {
                        ?>
                            <li <?php if( !empty($itemthree['accordion_image']['url']) ){ echo 'style="background-image:url('. esc_url( $itemthree['accordion_image']['url'] ).')"'; } ?>>
                                <div class="heading"><?php echo amokit_kses_title( $itemthree['accordion_title'] ); ?></div>
                                <div class="bgDescription" style="background: transparent url(<?php echo esc_url( AMONAKIT_ADDONS_PL_URL.'/assets/images/bg/bgDescription.png' );?>) repeat-x top left;"></div>
                                <div class="description">
                                    <h2 class="heading-three"><?php echo amokit_kses_title( $itemthree['accordion_title'] ); ?></h2>
                    ...
                    foreach ( $accordion_list_three as $itemthree ) {
                        ?>
                            <div class="single_accordion" <?php if( !empty($itemthree['accordion_image']['url']) ){ echo 'style="background-image:url('. esc_url( $itemthree['accordion_image']['url'] ).')"'; } ?>>
                                <h3 class="va-title"><?php echo amokit_kses_title( $itemthree['accordion_title'] ); ?></h3>
            ...
            $buttonicon = '<span class="accourdion-icon close-accourdion">'.amo_Icon_manager::render_icon( $settings['accordion_close_icon'], [ 'aria-hidden' => 'true' ] ).'</span><span class="accourdion-icon open-accourdion">'.amo_Icon_manager::render_icon( $settings['accordion_open_icon'], [ 'aria-hidden' => 'true' ] ).'</span>';
            ...
            if ( $accordion_list ) {
                echo '<div class="accordion" id="accordionExample'. esc_attr( $accordion_id ).'">';
                    ...
                    foreach ( $accordion_list as $item ) {
                        ...
                        $j = $i.$accordion_id;
                        ?>
                            <div class="single_accourdion amokit-icon-align-<?php echo esc_attr( $settings['accordion_icon_align'] ); ?>">

                                <div class="amo-accourdion-title">
                                    <?php
                                        if( ( $current_item == $i ) && ( $settings['accordion_close_all'] != 'yes' ) ){
                                            printf('<%1$s %2$s data-target="#amokit-collapse%3$s" class="amo-items-hedding">%4$s %5$s</%1$s>', 
                                                esc_attr( $title_tag ), 
                                                $this->get_render_attribute_string( 'accordion_heading' ),
                                                esc_attr( $j ), 
                                                amokit_kses_title( $item['accordion_title'] ), 
                                                $buttonicon // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
                                            );
                                        }else{
                                            printf('<%1$s %2$s data-target="#amokit-collapse%3$s" class="htb-collapsed amokit-items-hedding">%4$s %5$s</%1$s>', 
                                                esc_attr( $title_tag ), 
                                                $this->get_render_attribute_string( 'accordion_heading' ),
                                                esc_attr( $j ), 
                                                amokit_kses_title( $item['accordion_title'] ),  
                                ...
                                <div id="amokit-collapse<?php echo esc_attr( $j );?>" class="htb-collapse <?php if( ( $current_item == $i ) && ( $settings['accordion_close_all'] != 'yes' ) ){ echo 'htb-show'; }?>" <?php if( $settings['accordion_multiple'] != 'yes' ){ echo 'data-parent="#accordionExample'. esc_attr( $accordion_id ).'"'; } ?> >
                                    <div class="accordion-content">
                                        <?php 
