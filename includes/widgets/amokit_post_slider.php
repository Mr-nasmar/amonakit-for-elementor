...
class AmoKit_Elementor_Widget_Post_Slider extends Widget_Base {

    public function get_name() {
        return 'amokit-postslider-addons';
    }
    
    public function get_title() {
        return __( 'Post Slider', 'amokit-addons' );
    }

    public function get_icon() {
        return 'amokit-icon eicon-post-slider';
    }
    ...
    public function get_keywords() {
        return [ 'post slider', 'slider','custom post slider','carousel','post','amokit addons' ];
    }
    
    public function get_help_url() {
		return 'https://nasdesigns.rf.gd/docs/post-widgets/post-slider-widget/';
	}
    protected function register_controls() {
        ...
        $this->start_controls_section(
            'post_slider_content',
            [
                'label' => __( 'Post Slider', 'amokit-addons' ),
            ]
        );
            ...
            $this->add_control(
                ...
                [
                    ...
                    'options' => [
                        ...
                        '6'   => __( 'Layout Six', 'amokit-addons' ),
                        '7'   => __( 'Layout Seven', 'amokit-addons' ),
                    ],
                ]
            );
        ...
        $this->start_controls_section(
            ...
            $this->add_control(
                'show_content',
                [
                    'label' => esc_html__( 'Content', 'amokit-addons' ),
                    'type' => Controls_Manager::SWITCHER,
                    'return_value' => 'yes',
                    'default' => 'yes',
                ]
        ...
        $this->start_controls_section(
            ...
            $this->add_control(
                'dot_style',
                [
                    'label' => esc_html__( 'Dot Style', 'amokit-addons' ),
                    'type' => Controls_Manager::SELECT,
                    'options' => [
                        'title'     => esc_html__('Post Title','amokit-addons'),
                        'thumb'     => esc_html__('Thumbnail','amokit-addons'),
                    ],
                    'default' => 'title',
                    'condition' => [
                        'slider_on' => 'yes',
        ...
        $this->start_controls_section(
            ...
            [
                'label' => __( 'Slider Image Style', 'amokit-addons' ),
            ...
            $this->add_responsive_control(
                'slider_height',
                [
                    'label' => __( 'Slider Image Max Height', 'amokit-addons' ),
            ...
            $this->add_responsive_control(
                ...
                [
                    'label' => esc_html__( 'Container Border Radius', 'amokit-addons' ),
                    'type' => Controls_Manager::DIMENSIONS,
                    'size_units' => [ 'px', '%', 'em' ],
                    'selectors' => [
                        '{{WRAPPER}} .amo-post-slider-st-7' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    ],
                    'separator' => 'before',
                    'condition'=>[
            ...
            $this->add_control(
                ...
                [
                    'label' => __( 'Container background', 'amokit-addons' ),
                    'type' => Controls_Manager::HEADING,
                    'separator' => 'before',
                    'condition'=>[
                        'post_slider_layout' => '7', 
            ...
            $this->add_group_control(
                ...
                [
                    ...
                    'label' => __( 'Background', 'amokit-addons' ),
                    'types' => [ 'classic', 'gradient' ],
                    'selector' => '{{WRAPPER}} .amo-post-slider-st-7',
                    'separator' => 'after',
                    'condition'=>[
                        'post_slider_layout' => '7', 
                    ]
        ...
        $this->start_controls_section(
            ...
            $this->add_group_control(
                ...
                [
                    ...
                    'label' => __( 'Background', 'amokit-addons' ),
                    'types' => [ 'classic', 'gradient' ],
                    'selector' => '{{WRAPPER}} .amo-postslider-layout-1 .content .post-inner,
                    {{WRAPPER}} .amo-post-slider-right .content,
                    {{WRAPPER}} .amo-postslider-layout-5 .content,
                    {{WRAPPER}} .amo-postslider-layout-4 .content .post-inner',
                    'separator' => 'after',
                ]
            );
            $this->add_responsive_control(
                ...
                [
                    ...
                    'size_units' => [ 'px', '%', 'em' ],
                    'selectors' => [
                        '{{WRAPPER}} .amo-postslider-layout-1 .content,{{WRAPPER}} .amo-postslider-layout-4 .content' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    ],
                    'separator' => 'before',
                    'condition'=>[
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'size_units' => [ 'px', '%', 'em' ],
                    'selectors' => [
                        '{{WRAPPER}} .amo-postslider-layout-5 .content' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    ],
                    'separator' => 'before',
                    'condition'=>[
                        'post_slider_layout' =>'5', 
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'size_units' => [ 'px', '%', 'em' ],
                    'selectors' => [
                        '{{WRAPPER}} .amo-postslider-layout-1 .content .post-inner,
                        {{WRAPPER}} .amo-post-slider-right .content,
                        {{WRAPPER}} .amo-postslider-layout-3 .content,
                        {{WRAPPER}} .amo-postslider-layout-5 .content,
                        {{WRAPPER}} .amo-postslider-layout-4 .content .post-inner
            ...
            $this->add_group_control(
                ...
                [
                    ...
                    'selector' => '{{WRAPPER}} .amo-postslider-layout-1 .content .post-inner,
                    {{WRAPPER}} .amo-post-slider-st-6 .amo-post-slider-right,
                    {{WRAPPER}} .amo-postslider-layout-5 .content,
                    {{WRAPPER}} .amo-postslider-layout-4 .content .post-inner',
                    'separator' => 'before',
                ]
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'selectors' => [
                        '{{WRAPPER}} .amo-postslider-layout-1 .content .post-inner,
                        {{WRAPPER}} .amo-postslider-layout-2 .content,
                        {{WRAPPER}} .amo-postslider-layout-4 .content .post-inner,
                        {{WRAPPER}} .amo-postslider-layout-5 .content,
                        {{WRAPPER}} .amo-post-slider-st-6 .amo-post-slider-right' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    ],
                    'separator' => 'before',
                ]
            );
            $this->add_responsive_control(
                ...
                [
                    ...
                    'selectors' => [
                        '{{WRAPPER}} .amo-postslider-layout-1 .content,{{WRAPPER}} .amo-postslider-layout-4 .content' => 'max-Width: {{SIZE}}%; Width: {{SIZE}}%;',
                    ],
                    'condition'=>[
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'selectors' => [
                        '{{WRAPPER}} .amo-single-post-slide .content .post-inner' => 'text-align: {{VALUE}};',
                        '{{WRAPPER}} .amo-single-post-slide ul.meta' => 'text-align: {{VALUE}};',
                        '{{WRAPPER}} .amo-single-post-slide .content ul.post-category' => 'text-align: {{VALUE}};',
                        '{{WRAPPER}} .amo-postslider-layout-5 .content .post-inner' => 'text-align: {{VALUE}};',
                    ],
                ]
            );
        ...
        $this->start_controls_section(
            ...
            $this->add_control(
                ...
                [
                    ...
                    'default'=>'#18012c',
                    'selectors' => [
                        '{{WRAPPER}} .amo-single-post-slide ul.meta li' => 'color: {{VALUE}}',
                        '{{WRAPPER}} .amo-single-post-slide .content .post-inner ul.meta li a' => 'color: {{VALUE}}',
                    ],
                ]
            );
            $this->add_control(
                ...
                [
                    ...
                    'type' => Controls_Manager::COLOR,
                    'selectors' => [
                        '{{WRAPPER}} .amo-single-post-slide ul.meta li i' => 'color: {{VALUE}}'
                    ],
                ]
            );
            $this->add_control(
                ...
                [
                    ...
                    'type' => Controls_Manager::COLOR,
                    'selectors' => [
                        '{{WRAPPER}} .amo-single-post-slide .content .post-inner ul.meta li a:hover' => 'color: {{VALUE}}'
                    ],
                ]
            );
            $this->add_group_control(
                ...
                [
                    ...
                    'label' => __( 'Typography', 'amokit-addons' ),
                    'selector' => '{{WRAPPER}} .amo-single-post-slide ul.meta li, {{WRAPPER}} .amo-single-post-slide ul.meta li a',
                ]
            );
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'size_units' => [ 'px', '%', 'em' ],
                    'selectors' => [
                        '{{WRAPPER}} .amo-single-post-slide ul.meta li' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    ],
                ]
            );
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'size_units' => [ 'px', '%', 'em' ],
                    'selectors' => [
                        '{{WRAPPER}} .amo-single-post-slide ul.meta li' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    ],
                ]
            );
                ...
                $this->start_controls_tab(
                    ...
                    $this->add_control(
                        ...
                        [
                            ...
                            'default'=>'#464545',
                            'selectors' => [
                                '{{WRAPPER}} .amo-single-post-slide .post-btn a.readmore-btn' => 'color: {{VALUE}}',
                            ],
                        ]
                    );
                    ...
                    $this->add_group_control(
                        ...
                        [
                            ...
                            'label' => __( 'Typography', 'amokit-addons' ),
                            'selector' => '{{WRAPPER}} .amo-single-post-slide .post-btn a.readmore-btn',
                        ]
                    );
                    ...
                    $this->add_responsive_control(
                        ...
                        [
                            ...
                            'size_units' => [ 'px', '%', 'em' ],
                            'selectors' => [
                                '{{WRAPPER}} .amo-single-post-slide .post-btn a.readmore-btn' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                            ],
                        ]
                    );
                    ...
                    $this->add_responsive_control(
                        ...
                        [
                            ...
                            'size_units' => [ 'px', '%', 'em' ],
                            'selectors' => [
                                '{{WRAPPER}} .amo-single-post-slide .post-btn a.readmore-btn' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                            ],
                        ]
                    );
                    ...
                    $this->add_responsive_control(
                        ...
                        [
                            ...
                            'type' => Controls_Manager::DIMENSIONS,
                            'selectors' => [
                                '{{WRAPPER}} .amo-single-post-slide .post-btn a.readmore-btn' => 'border-radius: {{TOP}}px {{RIGHT}}px {{BOTTOM}}px {{LEFT}}px;',
                            ],
                        ]
                    );
                ...
                $this->start_controls_tab(
                    ...
                    $this->add_control(
                        ...
                        [
                            ...
                            'default'=>'#ffffff',
                            'selectors' => [
                                '{{WRAPPER}} .amo-single-post-slide .post-btn a.readmore-btn:hover' => 'color: {{VALUE}}',
                            ],
                        ]
                    );
                    ...
                    $this->add_group_control(
                        ...
                        [
                            ...
                            'label' => __( 'Background', 'amokit-addons' ),
                            'types' => [ 'classic', 'gradient' ],
                            'selector' => '{{WRAPPER}} .amo-single-post-slide .post-btn a.readmore-btn:hover',
                        ]
                    );
                    ...
                    $this->add_responsive_control(
                        ...
                        [
                            ...
                            'type' => Controls_Manager::DIMENSIONS,
                            'selectors' => [
                                '{{WRAPPER}} .amo-single-post-slide .post-btn a.readmore-btn:hover' => 'border-radius: {{TOP}}px {{RIGHT}}px {{BOTTOM}}px {{LEFT}}px;',
                            ],
                        ]
                    );
        ...
        $this->start_controls_section(
            ...
            $this->add_responsive_control(
                'slider_arrow_left',
                [
                    'label' => __( 'Left Arrow position', 'amokit-addons' ),
                    'type' => Controls_Manager::SLIDER,
                    'size_units' => [ 'px' ],
                    'range' => [
                        'px' => [
                    ...
                    'selectors' => [
                        '{{WRAPPER}} .amo-arrow-2.amo-postslider-area button.slick-arrow' => 'left: {{SIZE}}{{UNIT}};',
                    ],
                    'condition'=>[
            ...
            $this->add_responsive_control(
                'slider_arrow_right',
                [
                    'label' => __( 'Right Arrow position', 'amokit-addons' ),
                    'type' => Controls_Manager::SLIDER,
                    'size_units' => [ 'px' ],
                    'range' => [
                        'px' => [
                    ...
                    'selectors' => [
                        '{{WRAPPER}} .amo-arrow-2.amo-postslider-area button.amo-carosul-next.slick-arrow' => 'right: {{SIZE}}{{UNIT}};',
                    ],
                    'condition'=>[
                        'post_slider_arrow_style'=>'2',
                    ]
            ...
            $this->add_responsive_control(
                ...
                [
                    'label' => __( 'Left Arrow Position vertical', 'amokit-addons' ),
                    'type' => Controls_Manager::SLIDER,
                    'size_units' => [ 'px' ],
                    'range' => [
                        'px' => [
                    ...
                    'selectors' => [
                        '{{WRAPPER}} .amo-arrow-2 button.amo-carosul-prev.slick-arrow' => 'margin-top: {{SIZE}}{{UNIT}};',
                        '{{WRAPPER}} button.amo-carosul-prev.slick-arrow' => 'bottom: {{SIZE}}{{UNIT}};',
                    ],
                ]
            );
            ...
            $this->add_responsive_control(
                ...
                [
                    'label' => __( 'Right Arrow position vertical', 'amokit-addons' ),
                    'type' => Controls_Manager::SLIDER,
                    'size_units' => [ 'px' ],
                    'range' => [
                        'px' => [
                    ...
                    'selectors' => [
                        '{{WRAPPER}} .amo-arrow-2 button.amo-carosul-next.slick-arrow' => 'margin-top: {{SIZE}}{{UNIT}};',
                        '{{WRAPPER}} button.amo-carosul-next.slick-arrow' => 'bottom: {{SIZE}}{{UNIT}};',
                    ],
                ]
            );
                ...
                $this->start_controls_tab(
                    ...
                    $this->add_control(
                        ...
                        [
                            ...
                            'default' => '#00282a',
                            'selectors' => [
                                '{{WRAPPER}} .amo-postslider-area button.slick-arrow' => 'color: {{VALUE}};',
                                '{{WRAPPER}} .amo-postslider-area button.slick-arrow svg path' => 'fill: {{VALUE}};',
                            ],
                        ]
                    );
                    ...
                    $this->add_responsive_control(
                        ...
                        [
                            ...
                            'selectors' => [
                                '{{WRAPPER}} .amo-postslider-area button.slick-arrow' => 'font-size: {{SIZE}}{{UNIT}};',
                                '{{WRAPPER}} .amo-postslider-area button.slick-arrow svg' => 'width: {{SIZE}}{{UNIT}};',
                            ],
                        ]
                    );
                    ...
                    $this->add_group_control(
                        ...
                        [
                            ...
                            'label' => __( 'Background', 'amokit-addons' ),
                            'types' => [ 'classic', 'gradient' ],
                            'selector' => '{{WRAPPER}} .amo-postslider-area button.slick-arrow',
                        ]
                    );
                    ...
                    $this->add_responsive_control(
                        ...
                        [
                            ...
                            'type' => Controls_Manager::DIMENSIONS,
                            'selectors' => [
                                '{{WRAPPER}} .amo-postslider-area button.slick-arrow' => 'border-radius: {{TOP}}px {{RIGHT}}px {{BOTTOM}}px {{LEFT}}px;',
                            ],
                        ]
                    );
                    ...
                    $this->add_responsive_control(
                        ...
                        [
                            ...
                            'selectors' => [
                                '{{WRAPPER}} .amo-postslider-area button.slick-arrow' => 'height: {{SIZE}}{{UNIT}};',
                            ],
                        ]
                    );
                    ...
                    $this->add_responsive_control(
                        ...
                        [
                            ...
                            'selectors' => [
                                '{{WRAPPER}} .amo-postslider-area button.slick-arrow' => 'width: {{SIZE}}{{UNIT}};',
                            ],
                        ]
                    );
                    ...
                    $this->add_responsive_control(
                        ...
                        [
                            ...
                            'size_units' => [ 'px', '%', 'em' ],
                            'selectors' => [
                                '{{WRAPPER}} .amo-postslider-area button.slick-arrow' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                            ],
                            'separator' =>'before',
                        ]
                    );
                ...
                $this->start_controls_tab(
                    ...
                    $this->add_control(
                        ...
                        [
                            ...
                            'default' => '#00282a',
                            'selectors' => [
                                '{{WRAPPER}} .amo-postslider-area button.slick-arrow:hover' => 'color: {{VALUE}};',
                                '{{WRAPPER}} .amo-postslider-area button.slick-arrow:hover svg path' => 'fill: {{VALUE}};',
                            ],
                        ]
                    );
                    ...
                    $this->add_group_control(
                        ...
                        [
                            ...
                            'label' => __( 'Background', 'amokit-addons' ),
                            'types' => [ 'classic', 'gradient' ],
                            'selector' => '{{WRAPPER}} .amo-postslider-area button.slick-arrow:hover',
                        ]
                    );
                    ...
                    $this->add_responsive_control(
                        ...
                        [
                            ...
                            'type' => Controls_Manager::DIMENSIONS,
                            'selectors' => [
                                '{{WRAPPER}} .amo-postslider-area button.slick-arrow:hover' => 'border-radius: {{TOP}}px {{RIGHT}}px {{BOTTOM}}px {{LEFT}}px;',
                            ],
                        ]
                    );
                ...
                $this->start_controls_tab(
                    ...
                    $this->add_responsive_control(
                        ...
                        [
                            ...
                            'selectors' => [
                                '{{WRAPPER}} .amo-postslider-area .slick-dots li button' => 'height: {{SIZE}}{{UNIT}};',
                            ],
                        ]
                    );
                    ...
                    $this->add_responsive_control(
                        ...
                        [
                            ...
                            'selectors' => [
                                '{{WRAPPER}} .amo-postslider-area .slick-dots li button' => 'width: {{SIZE}}{{UNIT}};',
                            ],
                        ]
                    );
                    ...
                    $this->add_group_control(
                        ...
                        [
                            ...
                            'label' => __( 'Background', 'amokit-addons' ),
                            'types' => [ 'classic', 'gradient' ],
                            'selector' => '{{WRAPPER}} .amo-postslider-area .slick-dots li button',
                        ]
                    );
                    ...
                    $this->add_responsive_control(
                        ...
                        [
                            ...
                            'size_units' => [ 'px', '%', 'em' ],
                            'selectors' => [
                                '{{WRAPPER}} .amo-postslider-area .slick-dots li' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                            ],
                        ]
                    );
                    ...
                    $this->add_responsive_control(
                        ...
                        [
                            ...
                            'type' => Controls_Manager::DIMENSIONS,
                            'selectors' => [
                                '{{WRAPPER}} .amo-postslider-area .slick-dots li button' => 'border-radius: {{TOP}}px {{RIGHT}}px {{BOTTOM}}px {{LEFT}}px;',
                            ],
                        ]
                    );
                ...
                $this->start_controls_tab(
                    ...
                    $this->add_group_control(
                        ...
                        [
                            ...
                            'label' => __( 'Background', 'amokit-addons' ),
                            'types' => [ 'classic', 'gradient' ],
                            'selector' => '{{WRAPPER}} .amo-postslider-area .slick-dots li:hover button, {{WRAPPER}} .amo-postslider-area .slick-dots li.slick-active button',
                        ]
                    );
                    ...
                    $this->add_responsive_control(
                        ...
                        [
                            ...
                            'type' => Controls_Manager::DIMENSIONS,
                            'selectors' => [
                                '{{WRAPPER}} .amo-postslider-area .slick-dots li.slick-active button' => 'border-radius: {{TOP}}px {{RIGHT}}px {{BOTTOM}}px {{LEFT}}px;',
                                '{{WRAPPER}} .amo-postslider-area .slick-dots li:hover button' => 'border-radius: {{TOP}}px {{RIGHT}}px {{BOTTOM}}px {{LEFT}}px;',
                            ],
                        ]
                    );
                ...
                $this->start_controls_tab(
                    ...
                    $this->add_group_control(
                        ...
                        [
                            ...
                            'selector' => '{{WRAPPER}} .amo-postslider-style-4.amo-postslider-area ul.slick-dots li h6',
                        ]
                    ); 
                    $this->add_responsive_control(
                        ...
                        [
                            ...
                            'size_units' => [ 'px', '%', 'em' ],
                            'selectors' => [
                                '{{WRAPPER}} .amo-postslider-style-4.amo-postslider-area ul.slick-dots li' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                            ],
                        ]
                    );
                    $this->add_responsive_control(
                        ...
                        [
                            ...
                            'size_units' => [ 'px', '%', 'em' ],
                            'selectors' => [
                                '{{WRAPPER}} .amo-postslider-style-4.amo-postslider-area ul.slick-dots li' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                            ],
                        ]
                    );
                    ...
                    $this->add_group_control(
                        ...
                        [
                            ...
                            'label' => __( 'Border', 'amokit-addons' ),
                            'selector' => '{{WRAPPER}} .amo-postslider-style-4.amo-postslider-area ul.slick-dots li',
                        ]
                    );
                    ...
                    $this->add_responsive_control(
                        ...
                        [
                            ...
                            'type' => Controls_Manager::DIMENSIONS,
                            'selectors' => [
                                '{{WRAPPER}} .amo-postslider-style-4.amo-postslider-area ul.slick-dots li' => 'border-radius: {{TOP}}px {{RIGHT}}px {{BOTTOM}}px {{LEFT}}px;',
                            ],
                        ]
                    );
                    $this->add_group_control(
                        ...
                        [
                            ...
                            'label' => __( 'Background', 'amokit-addons' ),
                            'types' => [ 'classic', 'gradient' ],
                            'selector' => '{{WRAPPER}} .amo-postslider-style-4.title-st-layout-4.amo-postslider-area ul.slick-dots li:after',
                            'condition'=>[
                                'dot_style!'=>'thumb'
                            ]
                        ]
                    ...
                    $this->add_responsive_control(
                        ...
                        [
                            'label' => __( 'Pagination Box Width', 'amokit-addons' ),
                            'type' => Controls_Manager::SLIDER,
                            ...
                            'selectors' => [
                                '{{WRAPPER}} .amo-postslider-style-4.amo-postslider-area ul.slick-dots' => 'Width: {{SIZE}}px;',
                                '{{WRAPPER}} .amo-postslider-layout-4.thumb-st-layout-4' => 'padding-right: {{SIZE}}px;',
                            ],
                            'condition'=>[
                                'post_slider_layout' =>'4', 
                            ]
                ...
                $this->start_controls_tab(
                    ...
                    $this->add_group_control(
                        ...
                        [
                            ...
                            'label' => __( 'Background', 'amokit-addons' ),
                            'types' => [ 'classic', 'gradient' ],
                            'selector' => '{{WRAPPER}} .amo-postslider-style-4.title-st-layout-4.amo-postslider-area ul.slick-dots li.slick-active:after,{{WRAPPER}} .amo-postslider-style-4.title-st-layout-4.amo-postslider-area ul.slick-dots li:hover:after,{{WRAPPER}} .amo-postslider-style-4.thumb-st-layout-4.amo-postslider-area ul.slick-dots li:after',
                        ]
                    );
                    ...
                    $this->add_group_control(
                        ...
                        [
                            ...
                            'label' => __( 'Border', 'amokit-addons' ),
                            'selector' => '{{WRAPPER}} .amo-postslider-style-4.amo-postslider-area ul.slick-dots li.slick-active',
                        ]
                    );
                    ...
                    $this->add_responsive_control(
                        ...
                        [
                            ...
                            'type' => Controls_Manager::DIMENSIONS,
                            'selectors' => [
                                '{{WRAPPER}} .amo-postslider-style-4.amo-postslider-area ul.slick-dots li.slick-active' => 'border-radius: {{TOP}}px {{RIGHT}}px {{BOTTOM}}px {{LEFT}}px;',
                            ],
                        ]
                    );
    ...
    protected function render( $instance = [] ) {
        ...
        $amokit_st_4_class = $dot_style."-st-layout-4";
        ...
        $amokit_post_image  = 'amokit_size_1170x536';
        $amokit_post_image  =  $this->get_settings_for_display('amokit_post_image_size');
        $this->add_render_attribute( 'amokit_post_slider_attr', 'class', 'amokit-postslider-area amokit-postslider-style-'. esc_attr( $settings['post_slider_layout'].' '.$amokit_st_4_class ) );

        $this->add_render_attribute( 'amokit_post_slider_item_attr', 'class', 'amokit-data-title amokit-single-post-slide amokit-postslider-layout-' . esc_attr( $settings['post_slider_layout'].' '.$amokit_st_4_class ) );
        ...
        if( $settings['slider_on'] == 'yes' ){
            ...
            $this->add_render_attribute( 'amokit_post_slider_attr', 'class', 'amokit-carousel-activation amokit-arrow-'. esc_attr( $settings['post_slider_arrow_style'] ) );
        ...
        ?>
            <div <?php echo $this->get_render_attribute_string( 'amokit_post_slider_attr' ); ?> style='display:none;'>
                ...
                if( $slider_post->have_posts() ):
                    ...
                    ?>
                    <div <?php echo $this->get_render_attribute_string( 'amokit_post_slider_item_attr' ); ?> data-title="<?php echo esc_attr( wp_trim_words( get_the_title(), 10, '' ) ); ?>" data-thumbnail="<?php  if( 'thumb' == $dot_style ){ echo esc_url( the_post_thumbnail_url() ); }else { echo ''; } ?>" >

                        <?php if( $settings['post_slider_layout'] == 2 ): ?>
                            <div class="htb-row">
                                <div class="htb-col-lg-6 amokit-post-slider-left">
                                    <div class="thumb">
                                        <a href="<?php the_permalink();?>"><?php 
                                        if( 'amokit_size_1170x536' ==  $amokit_post_image ){
                                            $amokit_post_image = 'large';
                                        }
                                        $this->amokit_render_loop_thumbnail( $amokit_post_image ); ?></a>
                                    </div>
                                </div>
                                <div class="htb-col-lg-6 amokit-post-slider-right">
                                    <?php $this->amokit_render_loop_content($slider_post->ID); ?>
                                </div>
                            </div>
                            <?php elseif ( $settings['post_slider_layout'] == 6 || $settings['post_slider_layout'] == 7 ): ?>
                            
                                <div class="amo-post-slider-st-6 <?php if( $settings['post_slider_layout'] == 7 ){ echo esc_attr( " amokit-post-slider-st-7" ); } ?>">
                                    <div class="amo-post-slider-left">
                                        <div class="thumb">
                                            <a href="<?php the_permalink();?>"><?php 
                                            if( 'amokit_size_1170x536' ==  $amokit_post_image ){
                                                $amokit_post_image = 'large';
                                    ...
                                    <div class="amo-post-slider-right">
                                        <?php $this->amokit_render_loop_content($slider_post->ID); ?>
                                    </div>
                                </div>
                            <?php else: ?>
    ...
    // Loop Content
    public function amokit_render_loop_content($post_id = null){
        $settings   = $this->get_settings_for_display();
