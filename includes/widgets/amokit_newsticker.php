...
class AmoKit_Elementor_Widget_Newsticker extends Widget_Base {

    public function get_name() {
        return 'amokit-newtsicker-addons';
    }
    
    public function get_title() {
        return __( 'News Ticker', 'amokit-addons' );
    }

    public function get_icon() {
        return 'amokit-icon eicon-posts-ticker';
    }
    ...
    public function get_keywords() {
        return [ 'newsticker', 'news ticker widget','news','amokit','Amona Kit' ];
    }

    public function get_help_url() {
		return 'https://nasdesigns.rf.gd/docs/post-widgets/news-ticker-widget/';
	}
    protected function register_controls() {
        ...
        $this->start_controls_section(
            'news_ticker',
            [
                'label' => __( 'News Ticker', 'amokit-addons' ),
            ]
        );
            ...
            $this->add_control(
                'ticker_label',
                [
                    'label' => __( 'Ticker Label', 'amokit-addons' ),
                    'type' => Controls_Manager::TEXT,
                    'placeholder' => __( 'Breaking News', 'amokit-addons' ),
                    'separator'=>'after',
                ]
            );
            ...
            $this->add_control(
                'label_icon',
                [
                    'label' => __( 'Label Icon', 'amokit-addons' ),
            ...
            $this->add_control(
                'rowheight',
                [
                    'label' => __('Row Height', 'amokit-addons'),
            ...
            $this->add_control(
                'maxrow',
                [
                    'label' => __('Maximum Row', 'amokit-addons'),
                    'type' => Controls_Manager::NUMBER,
                    'default' => 1,
                ]
            );
            ...
            $this->add_control(
                'animateduration',
                [
                    'label' => __('Animated duration', 'amokit-addons'),
                    'type' => Controls_Manager::NUMBER,
                    'default' => 5000,
                ]
            );
            ...
            $this->add_control(
                ...
                [
                    ...
                    'default' => 'up',
                    'options' => [
                        'up'   => __( 'Up', 'amokit-addons' ),
                        'down'   => __( 'Down', 'amokit-addons' ),
                    ],
                ]
            );
            ...
            $this->add_control(
                ...
                [
                    'label' => esc_html__( 'Date Position In Left', 'amokit-addons' ),
                    'type' => Controls_Manager::SWITCHER,
                    'return_value' => 'yes',
                    'default' => 'no',
                    'condition' =>[
            ...
            $this->add_control(
                'autostart',
                [
                    'label' => esc_html__( 'Auto Start', 'amokit-addons' ),
                    'type' => Controls_Manager::SWITCHER,
                    'return_value' => 'yes',
                    'default' => 'yes',
                    'separator'=>'before',
            ...
            $this->add_control(
                'pauseonhover',
                [
                    'label' => esc_html__( 'Pause on hover', 'amokit-addons' ),
                    'type' => Controls_Manager::SWITCHER,
                    'return_value' => 'yes',
                    'default' => 'no',
                ]
        ...
        $this->start_controls_section(
            'news_ticker_content',
            [
                'label' => __( 'Content Option', 'amokit-addons' ),
            ]
        );
        ...
        $this->start_controls_section(
            'news_navigation',
            [
                'label' => __( 'Navigation Button', 'amokit-addons' ),
            ]
        );
            ...
            $this->add_control(
                'navigation_show',
                [
                    'label' => esc_html__( 'Show', 'amokit-addons' ),
                    'type' => Controls_Manager::SWITCHER,
                    'return_value' => 'yes',
                    'default' => 'yes',
                ]
        ...
        // Style tab section
        $this->start_controls_section(
            'amokit_newsticker_style_section',
            [
                'label' => __( 'News Box Style', 'amokit-addons' ),
            ...
            $this->add_group_control(
                ...
                [
                    'name' => 'amokit_newsticker_background',
                    'label' => __( 'Background', 'amokit-addons' ),
                    'types' => [ 'classic', 'gradient' ],
                    'selector' => '{{WRAPPER}} .breaking-news-default::before,{{WRAPPER}} .amo-newsticker-style-2.breaking-news-default,{{WRAPPER}} .amo-newsticker-style-4,{{WRAPPER}} .amo-newsticker-style-6,{{WRAPPER}} .amo-newsticker-style-5,{{WRAPPER}} .amo-newsticker-style-7',
                ]
            );
            ...
            $this->add_responsive_control(
                'amokit_newsticker_border_radius',
                [
            ...
            $this->add_responsive_control(
                'amokit_newsticker_section_padding',
                [
            ...
            $this->add_responsive_control(
                'amokit_newsticker_section_margin',
                [
        ...
        $this->start_controls_section(
            'amokit_newsticker_contnet_style',
            [
            ...
            $this->add_control(
                'amokit_newsticker_contnet_color',
                [
            ...
            $this->add_group_control(
                ...
                [
                    'name' => 'amokit_newsticker_contnet_typography',
                    'selector' => '{{WRAPPER}} .breaking-news-ticker li a',
                ]
            );
            $this->add_responsive_control(
                'amokit_newsticker_contnet_padding',
                [
                    'label' => __( 'Padding', 'amokit-addons' ),
                    'type' => Controls_Manager::DIMENSIONS,
                    'size_units' => [ 'px', '%', 'em' ],
        ...
        $this->start_controls_section(
            ...
            $this->add_group_control(
                Group_Control_Typography::get_type(),
                [
                    'name' => 'amokit_newsticker_label_typography',
            ...
            $this->add_group_control(
                Group_Control_Background::get_type(),
                [
                    'name' => 'amokit_newsticker_label_background',
                    'label' => __( 'Background', 'amokit-addons' ),
                    'types' => [ 'classic', 'gradient' ],
                    'selector' => '{{WRAPPER}} .breaking-news-default .breaking-news-title h5::before, {{WRAPPER}} .amo-newsticker-style-2 .breaking-news-title h5,{{WRAPPER}} .amo-newsticker-style-3 .breaking-news-title,{{WRAPPER}} .amo-newsticker-style-4 .breaking-news-title,{{WRAPPER}} .amo-newsticker-style-5 .breaking-news-title,{{WRAPPER}} .amo-newsticker-style-6 .breaking-news-title::before,{{WRAPPER}} .amo-newsticker-style-7 .breaking-news-title::before', 
                ]
            );
            $this->add_control(
                'amokit_newsticker_label_shap_color',
                [
                    'label' => __( 'Shape Color', 'amokit-addons' ),
                    'type' => Controls_Manager::COLOR,
                    'selectors' => [
                        '{{WRAPPER}} .amo-newsticker-style-2 .breaking-news-title h5::before,{{WRAPPER}} .amo-newsticker-style-5 .breaking-news-title::before' => 'border-left-color: {{VALUE}};',
                        '{{WRAPPER}} .amo-newsticker-style-3 .breaking-news-title h5::before' => 'border-right-color: {{VALUE}};',
                    ],
                    'condition' => [
            ...
            $this->add_group_control(
                Group_Control_Border::get_type(),
                [
                    'name' => 'amokit_newsticker_label_border',
                    'label' => __( 'Border', 'amokit-addons' ),
                    'selector' => '{{WRAPPER}} .breaking-news-default .breaking-news-title h5,{{WRAPPER}} .amo-newsticker-style-3 .breaking-news-title',
                    'condition' => [
            ...
            $this->add_responsive_control(
                'amokit_newsticker_border_label_radius',
                [
                    'label' => esc_html__( 'Border Radius', 'amokit-addons' ),
                    'type' => Controls_Manager::DIMENSIONS,
                    'selectors' => [
                        '{{WRAPPER}} .breaking-news-default .breaking-news-title h5,{{WRAPPER}} .amo-newsticker-style-3 .breaking-news-title,{{WRAPPER}} .amo-newsticker-style-7 .breaking-news-title::before' => 'border-radius: {{TOP}}px {{RIGHT}}px {{BOTTOM}}px {{LEFT}}px;',
                    ],
                    'condition' => [
                        'news_ticker_style!' =>'1',
                    ],
            ...
            $this->add_responsive_control(
                'label_height',
                [
                    'label' => __( 'Label Height', 'amokit-addons' ),
                    ...
                    'selectors' => [
                        '{{WRAPPER}} .amo-newsticker-style-1 .breaking-news-title h5' => 'height: {{SIZE}}{{UNIT}};',
                    ],
                    'separator' =>'before',
                    'condition' => [
            ...
            $this->add_responsive_control(
                'amokit_newsticker_label_padding',
                [
                    'label' => __( 'Padding', 'amokit-addons' ),
                    'type' => Controls_Manager::DIMENSIONS,
                    'size_units' => [ 'px', '%', 'em' ],
            ...
            $this->add_control(
                ...
                [
                    ...
                    'selectors' => [
                        '{{WRAPPER}} .amo-newsticker-style-1 .breaking-news-title h5 i,{{WRAPPER}} .breaking-news-title h5 i' => 'font-size: {{SIZE}}{{UNIT}};',
                        '{{WRAPPER}} .amo-newsticker-style-1 .breaking-news-title h5 svg,{{WRAPPER}} .breaking-news-title h5 svg' => 'width: {{SIZE}}{{UNIT}};',
                    ],
                    'separator' =>'before',
                    'condition' => [
                        'label_icon[value]!' =>'',
            ...
            $this->add_control(
                ...
                [
                    ...
                    'type' => Controls_Manager::COLOR,
                    'selectors' => [
                        '{{WRAPPER}} .amo-newsticker-style-1 .breaking-news-title h5 i,{{WRAPPER}} .breaking-news-title h5 i' => 'color: {{VALUE}};',
                        '{{WRAPPER}} .amo-newsticker-style-1 .breaking-news-title h5 svg path,{{WRAPPER}} .breaking-news-title h5 svg path' => 'fill: {{VALUE}};',
                    ],
                    'condition' => [
                        'label_icon[value]!' =>'',
                   ]
            ...
            $this->add_group_control(
                ...
                [
                    ...
                    'label' => __( 'Background', 'amokit-addons' ),
                    'types' => [ 'classic', 'gradient' ],
                    'selector' => '{{WRAPPER}} .amo-newsticker-style-1 .breaking-news-title h5 i,{{WRAPPER}} .amo-newsticker-style-1 .breaking-news-title h5 .amo-news-tickr-svg-icon-box',
                    'condition' => [
                        'news_ticker_style' =>'1',
                        'label_icon[value]!' =>'',
                    ],
            ...
            $this->add_responsive_control(
                ...
                [
                    'label' => __( 'Box Height and Width', 'amokit-addons' ),
                    'type' => Controls_Manager::SLIDER,
                    'size_units' => [ 'px', '%' ],
                    'range' => [
                        'px' => [
                    ...
                    'selectors' => [
                        '{{WRAPPER}} .amo-newsticker-style-1 .breaking-news-title h5 i,{{WRAPPER}} .amo-newsticker-style-1 .breaking-news-title h5 .amo-news-tickr-svg-icon-box' => 'height: {{SIZE}}{{UNIT}}; width:{{SIZE}}{{UNIT}}; line-height:{{SIZE}}{{UNIT}};',
                    ],
                    'condition' => [
                        'news_ticker_style' =>'1',
                        'label_icon[value]!' =>'',
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'type' => Controls_Manager::DIMENSIONS,
                    'selectors' => [
                        '{{WRAPPER}} .amo-newsticker-style-1 .breaking-news-title h5 i,{{WRAPPER}} .amo-newsticker-style-1 .breaking-news-title h5 .amo-news-tickr-svg-icon-box' => 'border-radius: {{TOP}}px {{RIGHT}}px {{BOTTOM}}px {{LEFT}}px;',
                    ],
                    'condition' => [
                        'news_ticker_style' =>'1',
                        'label_icon[value]!' =>'',
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'size_units' => [ 'px', '%', 'em' ],
                    'selectors' => [
                        '{{WRAPPER}} .amo-newsticker-style-1 .breaking-news-title h5 i,{{WRAPPER}} .amo-newsticker-style-1 .breaking-news-title h5 .amo-news-tickr-svg-icon-box,{{WRAPPER}} .breaking-news-title h5 i,{{WRAPPER}} .breaking-news-title h5 .amo-news-tickr-svg-icon-box' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    ],
                    'separator' =>'before',
                    'condition' => [
                        'label_icon[value]!' =>'',
        ...
        $this->start_controls_section(
            'amokit_newsticker_navigation_style',
            [
            ...
            $this->start_controls_tabs('button_style_tabs');
                ...
                $this->start_controls_tab(
                    ...
                    $this->add_control(
                        'amokit_newsticker_button_color',
                        [
                            'label' => __( 'Color', 'amokit-addons' ),
                            'type' => Controls_Manager::COLOR,
                            'selectors' => [
                    ...
                    $this->add_group_control(
                        Group_Control_Background::get_type(),
                        [
                            'name' => 'amokit_newsticker_button_background',
                            'label' => __( 'Background', 'amokit-addons' ),
                            'types' => [ 'classic', 'gradient' ],
                    ...
                    $this->add_control(
                        ...
                        [
                            'label' => __( 'Icon Box Height/Width', 'amokit-addons' ),
                            'type'  => Controls_Manager::SLIDER,
                            'range' => [
                                'px' => [
                                    'min' => 0,
                    ...
                    $this->add_group_control(
                        Group_Control_Border::get_type(),
                        [
                            'name' => 'amokit_newsticker_button_border',
                            'label' => __( 'Border', 'amokit-addons' ),
                            'selector' => '{{WRAPPER}} .breaking-news-default .breaking-news-nav button',
                        ]
                    );
                    ...
                    $this->add_responsive_control(
                        'amokit_newsticker_button_border_radius',
                        [
                            'label' => esc_html__( 'Border Radius', 'amokit-addons' ),
                            'type' => Controls_Manager::DIMENSIONS,
                            'selectors' => [
                    ...
                    $this->add_responsive_control(
                        'amokit_newsticker_button_border_radius_next',
                        [
                            'label' => esc_html__( 'Border Radius Next Button', 'amokit-addons' ),
                            'description' => esc_html__( 'If need to different from prev button', 'amokit-addons' ),
                            'type' => Controls_Manager::DIMENSIONS,
                            'selectors' => [
                    ...
                    $this->add_responsive_control(
                        'amokit_newsticker_button_padding',
                        [
                            'label' => __( 'Padding', 'amokit-addons' ),
                            'type' => Controls_Manager::DIMENSIONS,
                            'size_units' => [ 'px', '%', 'em' ],
                    ...
                    $this->add_responsive_control(
                        'amokit_newsticker_button_margin',
                        [
                            'label' => __( 'Margin', 'amokit-addons' ),
                            'type' => Controls_Manager::DIMENSIONS,
                            'size_units' => [ 'px', '%', 'em' ],
                ...
                $this->start_controls_tab(
                    ...
                    $this->add_control(
                        'amokit_newsticker_button_hover_color',
                        [
                            'label' => __( 'Color', 'amokit-addons' ),
                            'type' => Controls_Manager::COLOR,
                            'selectors' => [
                    ...
                    $this->add_group_control(
                        Group_Control_Background::get_type(),
                        [
                            'name' => 'amokit_newsticker_button_hover_background',
                            'label' => __( 'Background', 'amokit-addons' ),
                            'types' => [ 'classic', 'gradient' ],
                    ...
                    $this->add_group_control(
                        Group_Control_Border::get_type(),
                        [
                            'name' => 'amokit_newsticker_button_hover_border',
                            'label' => __( 'Border', 'amokit-addons' ),
                            'selector' => '{{WRAPPER}} .breaking-news-default .breaking-news-nav button:hover',
                        ]
                    );
        ...
        $this->start_controls_section(
            ...
            $this->add_group_control(
                Group_Control_Typography::get_type(),
                [
                    'name' => 'amokit_newsticker_date_typography',
            ...
            $this->add_group_control(
                Group_Control_Background::get_type(),
                [
                    'name' => 'amokit_newsticker_date_background',
                    'label' => __( 'Background', 'amokit-addons' ),
                    'types' => [ 'classic', 'gradient' ],
                    'selector' => '{{WRAPPER}} .breaking-news-default .breaking-news-ticker li span.news_date',
                ]
            ...
            $this->add_group_control(
                Group_Control_Border::get_type(),
                [
                    'name' => 'amokit_newsticker_date_border',
                    'label' => __( 'Border', 'amokit-addons' ),
                    'selector' => '{{WRAPPER}} .breaking-news-default .breaking-news-ticker li span.news_date',
                ]
            );
            ...
            $this->add_responsive_control(
                'amokit_newsticker_border_date_radius',
                [
                    'label' => esc_html__( 'Border Radius', 'amokit-addons' ),
                    'type' => Controls_Manager::DIMENSIONS,
                    'selectors' => [
            ...
            $this->add_responsive_control(
                'amokit_newsticker_date_padding',
                [
                    'label' => __( 'Padding', 'amokit-addons' ),
                    'type' => Controls_Manager::DIMENSIONS,
                    'size_units' => [ 'px', '%', 'em' ],
    ...
    protected function render( $instance = [] ) {
        ...
        // Section Attr
        $this->add_render_attribute( 'amokit_newsticker_section_attr', 'class', 'amokit-newsticker breaking-news-default' );
        $this->add_render_attribute( 'amokit_newsticker_section_attr', 'class', 'amokit-newsticker-style-'. esc_attr( $settings['news_ticker_style'].' '.$sectionid ) );
        ...
        // List UL attr
        $this->add_render_attribute('amokit_newsticker_options_attr', 'data-newstrickeropt', wp_json_encode( $newsticker_slider_settings ));
        $this->add_render_attribute( 'amokit_newsticker_options_attr', 'class', 'breaking-news-ticker float-left amokit-newstricker' );
        ...
        ?>
            <div <?php echo $this->get_render_attribute_string( 'amokit_newsticker_section_attr' ); ?> style="display:none;">
                <?php
                    ...
                    <?php
                            if( !empty($settings['label_icon']['value']) ){
                                ...
                                if( 'svg' == $settings['label_icon']['library']){
                                    echo '<h5>'.esc_html($settings['ticker_label'] ).'<div class="amo-news-tickr-svg-icon-box">'. AmoKit_Icon_manager::render_icon( $settings['label_icon'], [ 'aria-hidden' => 'true' ] ).'</div></h5>';
                                }else{
                                        echo '<h5>'.esc_html($settings['ticker_label'] ).amo_Icon_manager::render_icon( $settings['label_icon'], [ 'aria-hidden' => 'true' ] ).'</h5>';
                                }
                            }else{
                ...
                <?php } ?>
                <ul <?php echo $this->get_render_attribute_string( 'amokit_newsticker_options_attr' ); ?>  >
                    <?php
                        if( $news_ticker->have_posts() ){
                            ...
                            ?>
                                <li><a href="#"><?php esc_html_e('Content Not Found','amokit-addons') ?></a></li>
                            <?php
                        }
                        wp_reset_postdata();
                    ?>
                ...
                <?php if( $settings['navigation_show'] == 'yes' ): ?>
                    <div class="breaking-news-nav">
                        <button class="news-ticker-prev"><?php echo AmoKit_Icon_manager::render_icon( $settings['button_prev_icon'], [ 'aria-hidden' => 'true' ] ); ?></button>
                        <button class="news-ticker-next"><?php echo AmoKit_Icon_manager::render_icon( $settings['button_next_icon'], [ 'aria-hidden' => 'true' ] ); ?></button>
                    </div>
                <?php endif; ?>
        ...
        if( 'yes'== $settings['news_ticker_date_position'] ){
            $amokit_print_css =  ".{$sectionid}.amo-newsticker-style-3 .breaking-news-ticker li a span.news_date {
                float:left;
                margin-right:15px;
            }";
            ?>
