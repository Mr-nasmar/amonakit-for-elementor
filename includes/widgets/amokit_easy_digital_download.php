...
class AmoKit_Elementor_Widget_Easy_Digital_Download extends Widget_Base {

    public function get_name() {
        return 'amokit-easydigitaldownload-addons';
    }
    
    public function get_title() {
        return __( 'Easy Digital Downloads', 'amokit-addons' );
    }
    ...
    public function get_keywords() {
        return [ 'easy downloads', 'download', 'easy digital downloads', 'widget','Amona Kit','amokit addons' ];
    }

    public function get_help_url() {
		return 'https://nasdesigns.rf.gd/docs/3rd-party-plugin-widgets/easy-digital-downloads-widget/';
	}
    ...
    protected function register_controls() {
        ...
        $this->start_controls_section(
            ...
            [
                'label' => __( 'Easy Digital Downloads', 'amokit-addons' ),
            ]
        );
            ...
            $this->add_control(
                'number',
                [
                    'label'   => __( 'Number of Item', 'amokit-addons' ),
            ...
            $this->add_control(
                ...
                [
                    'label'        => __( 'Show Thumbnail', 'amokit-addons' ),
            ...
            $this->add_control(
                ...
                [
                    'label'        => __( 'Show Content', 'amokit-addons' ),
                    'type'         => Controls_Manager::SWITCHER,
                    'return_value' => 'yes',
                    'default'      => 'yes',
                ]
            ...
            $this->add_control(
                ...
                [
                    'label'        => __( 'Show Price', 'amokit-addons' ),
                    'type'         => Controls_Manager::SWITCHER,
                    'return_value' => 'yes',
                    'default'      => 'yes',
                ]
            ...
            $this->add_control(
                ...
                [
                    'label'        => __( 'Show Buy Button', 'amokit-addons' ),
                    'type'         => Controls_Manager::SWITCHER,
                    'return_value' => 'yes',
                    'default'      => 'yes',
                ]
            ...
            $this->add_control(
                ...
                [
                    'label'        => __( 'Show Pagination', 'amokit-addons' ),
                    'type'         => Controls_Manager::SWITCHER,
                    'return_value' => 'yes',
                    'default'      => 'yes',
                ]
        ...
        $this->start_controls_section(
            ...
            $this->add_control(
                'source',
                [
                    'label'   => _x( 'Source', 'Posts Query Control', 'amokit-addons' ),
                    'type'    => Controls_Manager::SELECT,
                    'options' => [
            ...
            $parent_options = array( '0' => __( 'Only Top Level', 'amokit-addons' ) ) + $options;
            $this->add_control(
                'parent',
                [
            ...
            $this->add_control(
                ...
                [
                    ...
                    'default' => 'desc',
                    'options' => [
                        'asc'  => __( 'ASC', 'amokit-addons' ),
                        'desc' => __( 'DESC', 'amokit-addons' ),
                    ],
                ]
            );
        ...
        $this->start_controls_section(
            ...
            $this->add_responsive_control(
                'single_item_gap',
                [
                    'label'   => esc_html__( 'Item Gap', 'amokit-addons' ),
            ...
            $this->add_group_control(
                ...
                [
                    ...
                    'label' => __( 'Item Background', 'amokit-addons' ),
            ...
            $this->start_controls_tabs('title_style_tabs');
                ...
                $this->start_controls_tab(
                    ...
                    $this->add_control(
                        'title_hover_color',
                        [
                            'label'     => esc_html__( 'Hover Color', 'amokit-addons' ),
                            'type'      => Controls_Manager::COLOR,
                            'selectors' => [
        ...
        $this->start_controls_section(
            ...
            $this->add_control(
                ...
                [
                    'label'     => esc_html__( 'Price Color', 'amokit-addons' ),
                    'type'      => Controls_Manager::COLOR,
                    'default'   => '',
                    'selectors' => [
            ...
            $this->add_responsive_control(
                ...
                [
                    'label'      => esc_html__( 'Price Margin', 'amokit-addons' ),
                    'type'       => Controls_Manager::DIMENSIONS,
                    'size_units' => [ 'px', '%' ],
                    'selectors'  => [
                        '{{WRAPPER}} .edd_downloads_list .edd_download .edd_download_inner span.edd_price, 
        ...
        $this->start_controls_section(
            ...
            $this->add_control(
                ...
                [
                    'label'     => esc_html__( 'Active Color', 'amokit-addons' ),
                    'type'      => Controls_Manager::COLOR,
                    'default'   => '',
                    'selectors' => [
