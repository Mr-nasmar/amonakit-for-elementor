...
class AmoKit_Elementor_Widget_Scroll_Navigation extends Widget_Base {

    public function get_name() {
        return 'amokit-scrollnavigation-addons';
    }
    
    public function get_title() {
        return __( 'Scroll Navigation', 'amokit-addons' );
    }

    public function get_icon() {
        return 'amokit-icon eicon-slider-full-screen';
    }
    ...
    public function get_keywords() {
        return ['navigation image','fullscreen scroll','horizontal navigation','vertical navigation','amokit', 'Amona Kit','navigation slider', 'scroll navigation'];
    }

    public function get_help_url() {
        return 'https://nasdesigns.rf.gd/docs/creative-widgets/scroll-navigation-widget/';
    }
    ...
    protected function register_controls() {
        ...
        $this->start_controls_section(
            ...
            [
                'label' => __( 'Scroll Navigation', 'amokit-addons' ),
            ]
        );
            ...
            $repeater->add_control(
                ...
                [
                    ...
                    'default'    => __( 'Content', 'amokit-addons' ),
                    'condition' => [
            ...
            $this->add_control(
                ...
                [
                    ...
                    'default' => [
                        ...
                        [
                            'navigation_content'    => __( 'Lorem ipsum dolor sit amet consectetur adipisicing elit sed do eiusmod tempor incididunt ut labore et dolore Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.', 'amokit-addons' ),
                            'content_source' => 'custom'
                        ],
        ...
        $this->start_controls_section(
            ...
            [
                'label' => __( 'Slider Options', 'amokit-addons' ),
            ]
        );
        $this->add_control(
            ...
            [
                ...
                'label' => esc_html__( 'Slider Direction', 'amokit-addons' ),
        ...
        $this->start_popover();
            ...
            $this->add_control(
                'slider_direction',
                [
                    'label' => __( 'Desktop Direction', 'amokit-addons' ),
                    'type' => Controls_Manager::SELECT,
                    'default' => 'vertical',
                    'options' => [
            ...
            $this->add_control(
                'heading_tablet',
                [
                    'label' => __( 'Tablet Device', 'amokit-addons' ),
            ...
            $this->add_control(
                'tablet_width',
                [
                    'label' => __('Resolution', 'amokit-addons'),
                    'description' => __('The resolution to tablet device.', 'amokit-addons'),
            ...
            $this->add_control(
                'heading_mobile',
                [
                    'label' => __( 'Mobile Device', 'amokit-addons' ),
                    'type' => Controls_Manager::HEADING,
                ]
            );
            ...
            $this->add_control(
                ...
                [
                    'label' => __('Resolution', 'amokit-addons'),
                    'description' => __('The resolution to mobile device.', 'amokit-addons'),
                    'type' => Controls_Manager::NUMBER,
                    'default' => 768,
                ]
            );
            ...
            $this->add_control(
                ...
                [
                    ...
                    'default' => 'full_screen',
                    'options' => [
                        'full_screen'    => __( 'Full Screen', 'amokit-addons' ),
                        'custom_height'  => __( 'Custom', 'amokit-addons' ),
                    ],
                ]
            );
            ...
            $this->add_control(
                ...
                [
                    'label' => __( 'Custom Height', 'amokit-addons' ),
            ...
            $this->add_control(
                'slider_item',
                [
                    'label' => __('Slider Visible Item', 'amokit-addons'),
                    'type' => Controls_Manager::NUMBER,
                    'default' => 1,
                ]
            );
            ...
            $this->add_control(
                'initial_slider',
                [
                    'label' => __('Initial Slide', 'amokit-addons'),
                    'type' => Controls_Manager::NUMBER,
                    'default' => 1,
                ]
            );
            ...
            $this->add_control(
                'slider_mousewheel',
                [
                    'label' => esc_html__( 'Mouse Wheel', 'amokit-addons' ),
            ...
            $this->add_control(
                ...
                [
                    'label' => esc_html__( 'Keyboard Scroll', 'amokit-addons' ),
                    'type' => Controls_Manager::SWITCHER,
                    'return_value' => 'yes',
                    'default' => 'no',
                ]
            ...
            $this->add_control(
                ...
                [
                    'label' => esc_html__( 'Simulate Touch', 'amokit-addons' ),
                    'type' => Controls_Manager::SWITCHER,
                    'return_value' => 'yes',
                    'default' => 'yes',
                ]
            ...
            $this->add_control(
                'slider_arrow',
                [
                    'label' => esc_html__( 'Slider Navigation', 'amokit-addons' ),
                    'type' => Controls_Manager::SWITCHER,
                    'return_value' => 'yes',
                    'default' => 'no',
                ]
            ...
            $this->add_control(
                'slider_dots',
                [
                    'label' => esc_html__( 'Slider Pagination', 'amokit-addons' ),
                    'type' => Controls_Manager::SWITCHER,
                    'return_value' => 'yes',
                    'default' => 'yes',
                ]
            ...
            $this->add_control(
                'slide_custom_menup',
                [
                    'label' => esc_html__( 'External menu for Navigation', 'amokit-addons' ),
                    'type' => Controls_Manager::SWITCHER,
                    'return_value' => 'yes',
                    'default' => 'no',
                ]
            );
            amokit_pro_notice( $this,'slide_custom_menup', 'yes', Controls_Manager::RAW_HTML );
        ...
        $this->start_controls_section(
            ...
            [
                'label' => __( 'Custom Content', 'amokit-addons' ),
            ...
            <div <?php echo $this->get_render_attribute_string( 'swiperslider_area_attr' ); ?>>
                ...
                <?php
                    ...
                    if( $settings['slider_dots'] == 'yes' ){
                        echo '<div class="amo-swiper-pagination swiper-pagination"></div>';
                    }
                ?>
