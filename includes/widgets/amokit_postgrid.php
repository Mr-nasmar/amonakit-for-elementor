...
class AmoKit_Elementor_Widget_PostGrid extends Widget_Base {

    public function get_name() {
        return 'amokit-postgrid-addons';
    }
    
    public function get_title() {
        return __( 'Post Grid', 'amokit-addons' );
    }

    public function get_icon() {
        return 'amokit-icon eicon-posts-grid';
    }
    ...
    public function get_keywords() {
        return [ 'post grid', 'post grid layout','custom post grid','post','amokit addons' ];
    }
    
    public function get_help_url() {
		return 'https://nasdesigns.rf.gd/docs/post-widgets/post-grid-widget/';
	}
    protected function register_controls() {
        ...
        $this->start_controls_section(
            'post_content_option',
            [
                'label' => __( 'Post Query', 'amokit-addons' ),
            ]
            );
        ...
        $this->start_controls_section(
                'post_grid_content',
                [
                    'label' => __( 'Display Settings', 'amokit-addons' ),
                ]
            );
            $this->add_control(
                'post_grid_style',
            ...
            $this->add_control(
                'show_title',
                [
                    'label' => esc_html__( 'Show Title', 'amokit-addons' ),
            ...
            $this->add_control(
                'show_category',
                [
                    'label' => esc_html__( 'Show Category', 'amokit-addons' ),
                    'type' => Controls_Manager::SWITCHER,
                    'return_value' => 'yes',
                    'default' => 'yes',
                ]
            ...
            $this->add_control(
                'show_date',
                [
                    'label' => esc_html__( 'Show Date', 'amokit-addons' ),
                    'type' => Controls_Manager::SWITCHER,
                    'return_value' => 'yes',
                    'default' => 'yes',
                ]
            ...
            $this->add_control(
                'show_read_more_btn',
                [
                    'label' => esc_html__( 'Read More Button', 'amokit-addons' ),
                    'type' => Controls_Manager::SWITCHER,
                    'return_value' => 'yes',
                    'default' => 'no',
                ]
        ...
        $this->start_controls_section(
            ...
            $this->add_responsive_control(
                'post_items_margin',
                [
                    'label' => __( 'Item Gap', 'amokit-addons' ),
                    'type' => Controls_Manager::DIMENSIONS,
                    'size_units' => [ 'px', '%', 'em' ],
                    'selectors' => [
                        '{{WRAPPER}} .amo-post-grid-layout-1 .row-1 > [class*="col"] .ht-post,{{WRAPPER}} .amo-post-grid-layout-3 .row-1 > [class*="col"] .ht-post ' =>'margin-top:0;',
                        '{{WRAPPER}} .amo-post-grid-layout-1 .row-1 > [class*="col"], {{WRAPPER}} .amo-post-grid-layout-3 .row-1 > [class*="col"]' =>'padding-bottom:1px; padding-top:1px;',
                        '{{WRAPPER}} .ht-post.black-overlay.mt--30, {{WRAPPER}} .ht-post.mt--20' =>'margin-top:{{TOP}}{{UNIT}};',

                        '{{WRAPPER}} .amo-post-grid-layout-1 .row-1 > [class*="col"],
                        {{WRAPPER}} .amo-post-grid-layout-3 .row-1 > [class*="col"],
                        {{WRAPPER}} .amo-post-grid-layout-4 .row--10 > [class*="col"],
                        {{WRAPPER}} .amo-post-grid-layout-5 .row--10 > [class*="col"]
                        
                        ' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',                        
                        '{{WRAPPER}} .amo-post-grid-layout-1 .htb-row,
                        {{WRAPPER}} .amo-post-grid-layout-3 .htb-row,
                        {{WRAPPER}} .amo-post-grid-layout-4 .htb-row,
                        {{WRAPPER}} .amo-post-grid-layout-5 .htb-row
                        ' => 'margin: -{{TOP}}{{UNIT}} -{{RIGHT}}{{UNIT}} -{{BOTTOM}}{{UNIT}} -{{LEFT}}{{UNIT}};',

                        '{{WRAPPER}} .amo-post-grid-layout-2 .ht-post' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}}; float:left',
                        '{{WRAPPER}} .amo-post-grid-layout-2 .htb-row' => 'margin: -{{TOP}}{{UNIT}} -{{RIGHT}}{{UNIT}} -{{BOTTOM}}{{UNIT}} -{{LEFT}}{{UNIT}};',
            ...
            $this->add_responsive_control(
                'item_box_padding',
                [
                    'label' => esc_html__('Item Padding', 'amokit-addons'),
                    'type' => Controls_Manager::DIMENSIONS,
                    'size_units' => ['px', 'em', '%'],
                    'selectors' => [
       ...
       $this->start_controls_section(
        ...
        [
            'label' => __( 'Custom Gradient Color', 'amokit-addons' ),
            'tab' => Controls_Manager::TAB_STYLE,
            'condition'=> [
        ...
        $this->add_control(
            'gradient1_heading',
            [
                'label' => __( 'Item One Gradient', 'amokit-addons' ),
                'type' => Controls_Manager::HEADING,
            ]
        );  
        $this->add_group_control(
            ...
            [
                'name' => 'gradient1',
                'label' => __( 'Gradient One', 'amokit-addons' ),
                'types' => [ 'classic', 'gradient' ],
        ...
        $this->add_control(
            'gradient2_heading',
            [
                'label' => __( 'Item Two Gradient', 'amokit-addons' ),
                'type' => Controls_Manager::HEADING,
                'separator'=>'before'
            ]
        );  
        ...
        $this->add_control(
            'gradient3_heading',
            [
                'label' => __( 'Item Three Gradient', 'amokit-addons' ),
                'type' => Controls_Manager::HEADING,
                'separator'=>'before'
            ]
        );  
        $this->add_group_control(
            ...
            [
                'name' => 'gradient3',
                'label' => __( 'Gradient Three', 'amokit-addons' ),
                'types' => [ 'classic', 'gradient' ],
        ...
        $this->add_control(
            'gradient4_heading',
            [
                'label' => __( 'Item Four Gradient', 'amokit-addons' ),
                'type' => Controls_Manager::HEADING,
                'separator'=>'before'
            ]
        );  
        $this->add_group_control(
            ...
            [
                'name' => 'gradient4',
                'label' => __( 'Gradient Four', 'amokit-addons' ),
                'types' => [ 'classic', 'gradient' ],
        ...
        $this->add_control(
            'gradient5_heading',
            [
                'label' => __( 'Item Five Gradient', 'amokit-addons' ),
                'type' => Controls_Manager::HEADING,
                'separator'=>'before'
            ]
        );  
        $this->add_group_control(
            ...
            [
                'name' => 'gradient5',
                'label' => __( 'Gradient Five', 'amokit-addons' ),
                'types' => [ 'classic', 'gradient' ],
        ...
        $this->add_control(
            'gradient6_heading',
            [
                'label' => __( 'Item Six Gradient', 'amokit-addons' ),
                'type' => Controls_Manager::HEADING,
                'separator'=>'before'
            ]
        );  
        $this->add_group_control(
            ...
            [
                'name' => 'gradient6',
                'label' => __( 'Gradient ', 'amokit-addons' ),
                'types' => [ 'classic', 'gradient' ],
        ...
        $this->add_control(
            'gradient7_heading',
            [
                'label' => __( 'Item Seven Gradient', 'amokit-addons' ),
                'type' => Controls_Manager::HEADING,
                'separator'=>'before'
            ]
        );
    $this->end_controls_section();     
        ...
        $this->start_controls_section(
            ...
            $this->add_group_control(
                ...
                [
                    'name' => 'amokit_image',
                    'label' => esc_html__( 'Image Size', 'amokit-addons' ),
                    'exclude'      => ['custom'],
                    'default'      => 'full',
                    'separator' => 'none',
                ]
            ...
            $this->add_responsive_control(
                ...
                [
                    'label' => esc_html__( 'Image Border Radius', 'amokit-addons' ),
                    'type' => Controls_Manager::DIMENSIONS,
                    'selectors' => [
        ...
        $this->start_controls_section(
            ...
            $this->add_control(
                ...
                [
                    ...
                    'selectors' => [
                        ...
                        {{WRAPPER}} .ht-post .post-content .content .amo-post-g-title a' => 'color: {{VALUE}}',
                    ],
                ]
            );
            $this->add_control(
                ...
                [
                    ...
                    'selectors' => [
                        ...
                        {{WRAPPER}} .ht-post .post-content .content .amo-post-g-title a:hover' => 'color: {{VALUE}}',
                    ],
                ]
            );
            ...
            $this->add_group_control(
                ...
                [
                    ...
                    'selector' => '{{WRAPPER}} .ht-post .post-content .content h4, {{WRAPPER}} .ht-post .post-content .content h2,{{WRAPPER}} .ht-post .post-content .content .amo-post-g-title',
                ]
            );
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'selectors' => [
                        ...
                        {{WRAPPER}} .ht-post .post-content .content h2,{{WRAPPER}} .ht-post .post-content .content .amo-post-g-title' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    ],
                ]
            );
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'selectors' => [
                        ...
                        {{WRAPPER}} .ht-post .post-content .content .amo-post-g-title' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    ],
                ]
            );
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'selectors' => [
                        '{{WRAPPER}} .ht-post .post-content .content h2,{{WRAPPER}} .ht-post .post-content .content h4,{{WRAPPER}} .ht-post .post-content .content .amo-post-g-title' => 'text-align: {{VALUE}};',
                    ],
                ]
            );
            $this->add_control(
                ...
                [
                    'label' => __( 'Title Two Style', 'amokit-addons' ),
                    'type' => Controls_Manager::HEADING,
                    'separator' => 'before',
                    'condition' => [
            ...
            $this->add_group_control(
                ...
                [
                    ...
                    'label' => __( 'Typography', 'amokit-addons' ),
                    'selector' => '{{WRAPPER}} .amo-post-grid-layout-2 .htb-col-lg-6 .ht-post .post-content .content h4,{{WRAPPER}} .ht-post .post-content .content h2,{{WRAPPER}} .amo-post-grid-layout-5 .htb-col-lg-8 .ht-post .post-content .content h4,
                    {{WRAPPER}} .amo-post-grid-layout-2 .htb-col-lg-6 .ht-post .post-content .content .amo-post-g-title,
                    {{WRAPPER}} .amo-post-grid-layout-5 .htb-col-lg-8 .ht-post .post-content .content .amo-post-g-title',
                    'condition' => [
                        'post_grid_style' => array( '2','3','5' ),
                    ]
                ]
        ...
        $this->start_controls_section(
            ...
            $this->add_control(
                ...
                [
                    ...
                    'type' => Controls_Manager::COLOR,
                    'selectors' => [
                        '{{WRAPPER}} p.amo-post-g-description' => 'color: {{VALUE}};',
                    ],
            ...
            $this->add_group_control(
                ...
                [
                    ...
                    'selector' => '{{WRAPPER}} p.amo-post-g-description',
                ]
            );
            $this->add_responsive_control(
                ...
                [
                    ...
                    'size_units' => [ 'px', '%', 'em' ],
                    'selectors' => [
                        '{{WRAPPER}} p.amo-post-g-description' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    ],                
                ]
            );
                ...
                $this->start_controls_tab(
                    ...
                    $this->add_control(
                        ...
                        [
                            ...
                            'type' => Controls_Manager::COLOR,
                            'selectors' => [
                                '{{WRAPPER}} a.amo-post-g-read-more' => 'color: {{VALUE}};',
                            ],
                        ]
                    );
                    ...
                    $this->add_group_control(
                        ...
                        [
                            ...
                            'label' => __( 'Typography', 'amokit-addons' ),
                            'selector' => '{{WRAPPER}} a.amo-post-g-read-more',
                        ]
                    );
                    $this->add_group_control(
                        Group_Control_Background::get_type(),
                    ...
                    $this->add_responsive_control(
                        ...
                        [
                            ...
                            'type' => Controls_Manager::DIMENSIONS,
                            'selectors' => [
                                '{{WRAPPER}} a.amo-post-g-read-more' => 'border-radius: {{TOP}}px {{RIGHT}}px {{BOTTOM}}px {{LEFT}}px;',
                            ],
                        ]
                    );
                    $this->add_responsive_control(
                        ...
                        [
                            ...
                            'size_units' => [ 'px', '%', 'em' ],
                            'selectors' => [
                                '{{WRAPPER}} a.amo-post-g-read-more' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                            ],
                        ]
                    );
                    $this->add_responsive_control(
                        ...
                        [
                            ...
                            'size_units' => [ 'px', '%', 'em' ],
                            'selectors' => [
                                '{{WRAPPER}} a.amo-post-g-read-more' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                            ],
                        ]
                    );
                ...
                $this->start_controls_tab(
                    ...
                    $this->add_control(
                        ...
                        [
                            ...
                            'type' => Controls_Manager::COLOR,
                            'selectors' => [
                                '{{WRAPPER}} a.amo-post-g-read-more:hover' => 'color: {{VALUE}}',
                            ],
                        ]
                    );
                    ...
                    $this->add_group_control(
                        ...
                        [
                            ...
                            'label' => __( 'Background', 'amokit-addons' ),
                            'types' => [ 'classic', 'gradient' ],
                            'selector' => '{{WRAPPER}} a.amo-post-g-read-more:hover',
                        ]
                    );
                    ...
                    $this->add_responsive_control(
                        ...
                        [
                            ...
                            'type' => Controls_Manager::DIMENSIONS,
                            'selectors' => [
                                '{{WRAPPER}} a.amo-post-g-read-more:hover' => 'border-radius: {{TOP}}px {{RIGHT}}px {{BOTTOM}}px {{LEFT}}px;',
                            ],
                        ]
                    );
    ...
    protected function render( $instance = [] ) {
        ...
        $this->add_render_attribute( 'amokit_post_grid', 'class', 'amokit-post-grid-area amokit-post-grid-layout-'.$settings['post_grid_style'] );
        ...
        $this->add_render_attribute( 'amokit_post_attr', 'class', 'amokit-post-g-title' );
        $amokit_image_size  = $this->get_settings_for_display('amokit_image_size');
        ?>
            
        <div <?php echo $this->get_render_attribute_string( 'amokit_post_grid' ); ?>>
            <div class="htb-col">
                                            ...
                                            <a href="<?php the_permalink(); ?>">
                                                <?php 
                                                    if ( has_post_thumbnail() ){
                                                        the_post_thumbnail( $amokit_image_size ); 
                                                    }else{
                                            ...
                                            <div class="post-content">
                                                <div class="content">
                                                    ...
                                                    if( $settings['show_title'] == 'yes' ): 
                                                        ...
                                                        amokit_escape_tags( $settings['title_tag'], 'h4' ),
                                                        $this->get_render_attribute_string( 'amokit_post_attr' ),
                                                        $title_link_text);
                                                    endif;
                                                    ...
                                                    if( $settings['show_content'] == 'yes' ):
                                                        if( $settings['content_type'] == 'excerpt' ){
                                                            echo '<p class="amo-post-g-description">'. esc_html( wp_trim_words( get_the_excerpt(), floatval( $settings['content_length'] ),'' ) ) .'</p>';
                                                        } else {
                                                            echo '<p class="amo-post-g-description">'. wp_kses_post( wp_trim_words( strip_shortcodes( get_the_content() ), floatval( $settings['content_length'] ), '' ) ).'</p>'; 
                                                        }
                                                    endif;
                                                    if( $settings['show_read_more_btn'] == 'yes' && !empty( $settings['read_more_txt'] ) ): ?>
                                                        <a class="amo-post-g-read-more" href="<?php the_permalink();?>">
                                                            <?php echo amokit_kses_desc( $settings['read_more_txt'] ); ?>
                                                        </a>
                                                        <?php
                                                    endif; ?>
                                                </div>
                                        ...
                                        if ( $settings['show_title'] == 'yes' || $settings['show_date'] == 'yes' || $settings['show_content'] == 'yes' || $settings['show_read_more_btn'] == 'yes' ) {
                                            ...
                                            <div class="post-content">
                                                <div class="content">
                                                    <?php if( $settings['show_title'] == 'yes' ):
                                                    printf( '<%1$s %2$s>%3$s</%1$s>',
                                                    amokit_escape_tags( $settings['title_tag'], 'h2' ),
                                                    $this->get_render_attribute_string( 'amokit_post_attr' ),
                                                    $title_link_text);
                                                    endif;
                                                    if( $settings['show_date'] == 'yes' ): ?>
                                            ...
                                            <div class="ht-post">
                                                <div class="thumb">
                                                    <a href="<?php the_permalink();?>">
                                                        <?php 
                                                            if ( has_post_thumbnail() ){
                                                                the_post_thumbnail('amokit_size_585x295'); 
                                                            }else{
                                                                echo '<img src="' . esc_url( AMONAKIT_ADDONS_PL_URL . '/assets/images/image-placeholder.png' ) . '" alt="' . esc_attr( get_the_title() ) . '" />';
                                                            }
                                                        ?>
