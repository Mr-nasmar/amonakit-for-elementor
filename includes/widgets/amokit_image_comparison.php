...
class AmoKit_Elementor_Widget_Image_Comparison extends Widget_Base {

    public function get_name() {
        return 'amokit-imagecomparison-addons';
    }
    
    public function get_title() {
        return __( 'Image Comparison', 'amokit-addons' );
    }

    public function get_icon() {
        return 'amokit-icon eicon-image-before-after';
    }
    ...
    public function get_keywords() {
        return ['image comparison', 'comparison', 'photo comparison', 'image compare','before after image','image before after', 'amokit', 'Amona Kit', 'addons','widget'];
    }

    public function get_help_url() {
        return 'https://nasdesigns.rf.gd/docs/general-widgets/image-comparison-widget/';
    }
    protected function register_controls() {
        ...
        $this->start_controls_section(
            ...
            [
                'label' => __( 'Image Comparison', 'amokit-addons' ),
            ]
        );
            ...
            $this->add_control(
                'before_image',
                [
                    'label' => __( 'Before Image', 'amokit-addons' ),
            ...
            $this->add_control(
                'after_image',
                [
                    'label' => __( 'After Image', 'amokit-addons' ),
                    'type' => Controls_Manager::MEDIA,
                    'default' => [
                        'url' => Utils::get_placeholder_image_src(),
                    ],
        ...
        $this->start_controls_section(
            ...
            $this->add_group_control(
                ...
                [
                    ...
                    'selector' => '{{WRAPPER}} .amo-imagecomparison .beer-slider',
                ]
            );
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'size_units' => [ 'px', '%', 'em' ],
                    'selectors' => [
                        '{{WRAPPER}} .amo-imagecomparison .beer-slider' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    ],
                    'separator' =>'before',
                ]
            );
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'type' => Controls_Manager::DIMENSIONS,
                    'selectors' => [
                        '{{WRAPPER}} .amo-imagecomparison .beer-slider' => 'border-radius: {{TOP}}px {{RIGHT}}px {{BOTTOM}}px {{LEFT}}px;',
                    ],
                ]
            );
        ...
        $this->start_controls_section(
            ...
            [
                'label' => __( 'Additional Setting', 'amokit-addons' ),
            ]
        );
            ...
            $this->add_control(
                'before_title',
                [
                    'label' => __( 'Before Title', 'amokit-addons' ),
                    'type' => Controls_Manager::TEXT,
                    'placeholder'=>__('Before','amokit-addons'),
                ]
            );
            ...
            $this->add_control(
                'after_title',
                [
                    'label' => __( 'After Title', 'amokit-addons' ),
                    'type' => Controls_Manager::TEXT,
                    'placeholder'=>__('After','amokit-addons'),
                ]
            );
            ...
            $this->add_control(
                'start_amount',
                [
                    'label' => __( 'Before Start Amount', 'amokit-addons' ),
            ...
            $this->add_control(
                ...
                [
                    'label' => __( 'Level Position', 'amokit-addons' ),
            ...
            $this->add_control(
                ...
                [
                    'label' => __( 'Positioning Lebel', 'amokit-addons' ),
        ...
        $this->add_group_control(
            ...
            [
                'name' => 'reveal_border',
                'label' => __( 'Border', 'amokit-addons' ),
                'selector' => '{{WRAPPER}} .amo-imagecomparison .beer-reveal',
            ]
        );
        ...
        $this->start_controls_section(
            ...
            [
                'label' => __( 'Handler', 'amokit-addons' ),
                'tab' => Controls_Manager::TAB_STYLE,
            ]
        );
        ...
        $this->start_controls_section(
            ...
            [
                'label' => __( 'Image Before', 'amokit-addons' ),
                'tab' => Controls_Manager::TAB_STYLE,
            ]
        );
            $this->add_group_control(
        ...
        $this->start_controls_section(
            ...
            [
                'label' => __( 'Image After', 'amokit-addons' ),
                'tab' => Controls_Manager::TAB_STYLE,
            ]
        );
            $this->add_group_control(
    ...
    protected function render( $instance = [] ) {
        ...
        $this->add_render_attribute( 'amokit_image_comparison', 'class', 'amokit-imagecomparison amokit-label-pos-' . esc_attr( $settings['imagecomparison_laben_pos'] ) );
        ...
        ?>
            <div <?php echo $this->get_render_attribute_string( 'amokit_image_comparison' ); ?> >
