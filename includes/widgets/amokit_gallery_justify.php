...
class AmoKit_Elementor_Widget_Gallery_Justify extends Widget_Base {

    public function get_name() {
        return 'amokit-galleryjustify-addons';
    }
    
    public function get_title() {
        return __( 'Gallery Justify', 'amokit-addons' );
    }

    public function get_icon() {
        return 'amokit-icon eicon-gallery-justified';
    }
    ...
    public function get_keywords() {
        return [ 'image justify', 'justify gallery','image gallery','gallery justify','gallery images','amokit','Amona Kit' ];
    }

    public function get_help_url() {
		return 'https://nasdesigns.rf.gd/docs/general-widgets/image-justify-widget/';
	}
    protected function register_controls() {
        $this->start_controls_section(
            'gallery_content',
            [
                'label' => __( 'Gallery Justify', 'amokit-addons' ),
            ]
        );
            ...
            $this->add_control(
                'gallery_images',
                [
                    'label' => __( 'Add Images', 'amokit-addons' ),
            ...
            $this->add_group_control(
                ...
                [
                    ...
                    'selector' => '{{WRAPPER}} .amo-justify-single-image',
                ]
            );
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'size_units' => [ 'px', '%', 'em' ],
                    'selectors' => [
                        '{{WRAPPER}} .amo-justify-single-image' => 'border-radius: {{TOP}}px {{RIGHT}}px {{BOTTOM}}px {{LEFT}}px;',
                    ],
                ]
            );
            ...
            $this->add_control(
                'popup_options',
                [
                    'label' => __( 'Popup options', 'amokit-addons' ),
                    'type' => Controls_Manager::SELECT,
                    'default' => '2',
                    'options' => [
                        '1'   => __( 'Popup None', 'amokit-addons' ),
                        '2'   => __( 'Default Popup', 'amokit-addons' ),
                        '3'   => __( 'Gallery Popup ', 'amokit-addons' ),
                    ],
                ]
            );
            $this->add_control(
                ...
                [
                    'label'         => __( 'Show Gallery Title', 'amokit-addons' ),
            ...
            $this->add_control(
                ...
                [
                    'label'         => __( 'Show Image Counter', 'amokit-addons' ),
                    'type'          => Controls_Manager::SWITCHER,
                    'return_value'  => 'yes',
                    'default'       => 'no',
                    'condition'     => [
            ...
            $this->add_control(
                'counter_color',
                [
                    'label' => __( 'Counter Color', 'amokit-addons' ),
                    'type' => Controls_Manager::COLOR,
                    'selectors' => [
                        '.amo.mfp-counter' => 'color: {{VALUE}};',
                    ],
                    'condition'     => [
        ...
        if( isset( $settings['gallery_images'] ) ):
            ...
            echo '<div '.$this->get_render_attribute_string( 'justify_gallery_attr' ).'style="display:none;">';
                foreach ( $settings['gallery_images'] as $image ) {
                    ...
                    ?>
                        <div class="amo-justify-single-image">
                            <div class="thumb">
                    ...
                    $('.npgallery_active<?php echo esc_js( $id ); ?>').magnificPopup({
                        ...
                        image: {
                            ...
                            markup: '<div class="mfp-figure">'+
                                        ...
                                        '<div class="amo mfp-title"></div>'+
                                        '<div class="amo mfp-counter"></div>'+
                                        '</div>'+
