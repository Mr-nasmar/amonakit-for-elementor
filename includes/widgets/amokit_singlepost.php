...
class AmoKit_Elementor_Widget_SinglePost extends Widget_Base {

    public function get_name() {
        return 'amokit-singlepost-addons';
    }
    
    public function get_title() {
        return __( 'Single Post', 'amokit-addons' );
    }

    public function get_icon() {
        return 'amokit-icon eicon-posts-group';
    }
    ...
    public function get_keywords() {
        return ['single post','post widget','post details','amokit', 'Amona Kit'];
    }

    public function get_help_url() {
        return 'https://nasdesigns.rf.gd/docs/post-widgets/single-post-widget/';
    }
    protected function register_controls() {
        ...
        $this->start_controls_section(
            'single_post_content',
            [
                'label' => __( 'Single Post', 'amokit-addons' ),
            ]
        );
            $this->add_control(
                'post_style',
                [
                    ...
                    'default' => '1',
                    'options' => [
                        '1' => esc_html__( 'Style One', 'amokit-addons' ),
                        '2' => esc_html__( 'Style Two', 'amokit-addons' ),
                        '3' => esc_html__( 'Style Three', 'amokit-addons' ),
                        '4' => esc_html__( 'Style Four', 'amokit-addons' ),
                    ],
                ]
            );
            ...
            $this->add_control(
                ...
                [
                    'label' => esc_html__( 'Content Position', 'amokit-addons' ),
        ...
        $this->start_controls_section(
            ...
            [
                'label' => __( 'Additional Option', 'amokit-addons' ),
            ]
        );
        ...
        $this->start_controls_section(
            ...
            $this->add_control(
                ...
                [
                    ...
                    'selectors' => [
                        '{{WRAPPER}} .amo-single-post .content h2 a' => 'color: {{VALUE}}',
                    ],
                ]
            );
            $this->add_control(
                ...
                [
                    ...
                    'type' => Controls_Manager::COLOR,
                    'selectors' => [
                        '{{WRAPPER}} .amo-single-post .content h2 a:hover' => 'color: {{VALUE}}',
                    ],
                ]
            );
            ...
            $this->add_group_control(
                ...
                [
                    ...
                    'selector' => '{{WRAPPER}} .amo-single-post .content h2',
                ]
            );
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'size_units' => [ 'px', '%', 'em' ],
                    'selectors' => [
                        '{{WRAPPER}} .amo-single-post .content h2' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    ],
                ]
            );
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'size_units' => [ 'px', '%', 'em' ],
                    'selectors' => [
                        '{{WRAPPER}} .amo-single-post .content h2' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    ],
                ]
            );
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'selectors' => [
                        '{{WRAPPER}} .amo-single-post .content h2' => 'text-align: {{VALUE}};',
                    ],
                ]
            );
        ...
        $this->start_controls_section(
            ...
            $this->add_control(
                ...
                [
                    ...
                    'default'=>'#ffffff',
                    'selectors' => [
                        '{{WRAPPER}} .amo-single-post .post-category a' => 'color: {{VALUE}}',
                    ],
                ]
            );
            ...
            $this->add_group_control(
                ...
                [
                    ...
                    'label' => __( 'Typography', 'amokit-addons' ),
                    'selector' => '{{WRAPPER}} .amo-single-post .post-category a',
                ]
            );
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'size_units' => [ 'px', '%', 'em' ],
                    'selectors' => [
                        '{{WRAPPER}} .amo-single-post .post-category a' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    ],
                ]
            );
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'size_units' => [ 'px', '%', 'em' ],
                    'selectors' => [
                        '{{WRAPPER}} .amo-single-post .post-category a' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    ],
                ]
            );
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'selectors' => [
                        '{{WRAPPER}} .amo-single-post .post-category' => 'text-align: {{VALUE}};',
                    ],
        ...
        $this->start_controls_tabs(
            ...
            $this->add_control(
                ...
                [
                    ...
                    'type' => Controls_Manager::COLOR,
                    'selectors' => [
                        '{{WRAPPER}} .amo-single-post ul.meta li a,
                        {{WRAPPER}} .amo-single-post ul.meta li' => 'color: {{VALUE}}',
                    ],
                ]
            );
            $this->add_control(
                ...
                [
                    ...
                    'type' => Controls_Manager::COLOR,
                    'selectors' => [
                        '{{WRAPPER}} .amo-single-post ul.meta li a i,
                        {{WRAPPER}} .amo-single-post ul.meta li i' => 'color: {{VALUE}}',
                    ],
                ]
            );
            ...
            $this->add_group_control(
                ...
                [
                    ...
                    'label' => __( 'Typography', 'amokit-addons' ),
                    'selector' => '{{WRAPPER}} .amo-single-post ul.meta li a,
                    {{WRAPPER}} .amo-single-post ul.meta li',
                ]
            );
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'size_units' => [ 'px', '%', 'em' ],
                    'selectors' => [
                        '{{WRAPPER}} .amo-single-post ul.meta li' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                        '{{WRAPPER}} .amo-single-post ul.meta' => 'margin-left:-{{LEFT}}{{UNIT}};margin-right:-{{RIGHT}}{{UNIT}};',
                    ],
                ]
            );
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'size_units' => [ 'px', '%', 'em' ],
                    'selectors' => [
                        '{{WRAPPER}} .amo-single-post ul.meta li' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    ],
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'selectors' => [
                        '{{WRAPPER}} .amo-single-post ul.meta' => 'justify-content: {{VALUE}};',
                    ],
            ...
            $this->add_control(
                ...
                [
                    ...
                    'type' => Controls_Manager::COLOR,
                    'selectors' => [
                        '{{WRAPPER}} .amo-single-post ul.meta li a:hover' => 'color: {{VALUE}}',
                    ],
                ]
            );
        ...
        $this->start_controls_section(
            ...
            $this->add_group_control(
                ...
                [
                    ...
                    'label' => __( 'Background', 'amokit-addons' ),
                    'types' => [ 'classic', 'gradient' ],
                    'selector' => '{{WRAPPER}} .amo-single-post .content',
                ]
            );
            $this->add_responsive_control(
                'box_margin',
                [
                    ...
                    'size_units' => [ 'px', '%', 'em' ],
                    'selectors' => [
                        '{{WRAPPER}} .amo-single-post .content' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'size_units' => [ 'px', '%', 'em' ],
                    'selectors' => [
                        '{{WRAPPER}} .amo-single-post .content' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    ],
                ]
            );
        $this->end_controls_section();
    ...
    protected function render( $instance = [] ) {
        ...
        $this->add_render_attribute( 'amokit_single_post_attr', 'class', 'amokit-single-post amokit-single-post-style-'. esc_attr( $settings['post_style'] ." ". $sectionid ) );
        ...
        ?>
            ...
            ?>
                <div <?php echo $this->get_render_attribute_string( 'amokit_single_post_attr' ); ?>>
                    <div class="thumb">
            ...
            <?php endwhile; wp_reset_postdata(); wp_reset_query(); 
                    ...
                    echo esc_html__( 'No selected post', 'amokit-addons' );
                endif;
            if( 'top' == $post_content_position ){
                 $amokit_print_css = ".{$sectionid}.amo-single-post-style-1 .content {
                        bottom: auto;
                        top: 0;
                    }
                    ";
                ...
                <script>
                    var marginLeft = jQuery(".<?php echo esc_js( $sectionid ); ?>.amo-single-post-style-1 .content").css("margin-left");
                    var marginRight = jQuery(".<?php echo esc_js( $sectionid ); ?>.amo-single-post-style-1 .content").css("margin-right");
                    ...
                    if( marginLeft2 || marginRight2 ){
                        ...
                        jQuery(".<?php echo esc_js( $sectionid ); ?>.amo-single-post-style-1 .content").css("width", calcevalue);
                    }
                </script>
            <?php
            }
    ...
    public function get_posts_by_post_type(){
        ...
        $this->add_control(
            'select_post_type',
            [
                'label' => esc_html__( 'Select Post Type', 'amokit-addons' ),
                'type' => Controls_Manager::SELECT,
                'default' => 'bottom',
        ...
        $post_list = amokit_get_post_types();       
        foreach( $post_list as $post_key => $post_value ){
            if ( 'post' == $post_key ){
            $this->add_control(
                'post_name',
                    [
                        'label' => esc_html__( 'Post Name', 'amokit-addons' ),
                        'type' => Controls_Manager::SELECT2,
                        'label_block' => true,
                        'multiple' => true,
                        'options' =>  amokit_post_name('post', -1),
                        'condition' => [
                ...
                $this->add_control(
                    ...
                    [
                        ...
                        'type' => Controls_Manager::SELECT2,
                        'label_block' => true,
                        'options' => amokit_post_name($post_key, -1),
                        'multiple' => true,
                        'condition' => [
