...
class AmoKit_Elementor_Widget_Calendly extends Widget_Base {

    public function get_name() {
        return 'amokit-calendly-addons';
    }
    
    public function get_title() {
        return __( 'Calendly', 'amokit-addons' );
    }

    public function get_icon() {
        return 'amokit-icon eicon-calendar';
    }
    public function get_categories() {
        return [ 'amokit-addons' ];
    }
    public function get_keywords() {
        return ['calendly', 'calender', 'booking', 'booked', 'appointment','metting schedule','amokit', 'Amona Kit'];
    }
    ...
    protected function register_controls() {
        ...
        $this->start_controls_section(
            ...
            [
                'label' => __( 'Calendly', 'amokit-addons' ),
            ]
        );
		$this->add_control(
			'calendly_username',
			[
				...
				'default'     => '',
				'placeholder' => __( 'Type calendly username here', 'amokit-addons' ),
				'dynamic'     => ['active' => true],
		...
		$this->add_control(
			'calendly_time',
			[
				'label'   => __( 'Select Time', 'amokit-addons' ),
				'type'    => Controls_Manager::SELECT,
				'options' => [
					'15min' => __( '15 Minutes', 'amokit-addons' ),
					'30min' => __( '30 Minutes', 'amokit-addons' ),
					'60min' => __( '60 Minutes', 'amokit-addons' ),
					'' => __( 'All', 'amokit-addons' ),
				],
				'default' => '30min'
			]
		);
		...
		$this->add_control(
			'event_type_details',
			[
				'label'        => __( 'Hide Event Type Details', 'amokit-addons' ),
		...
		$this->start_controls_section(
			...
			$this->add_control(
				'button_link_color',
				[
					'label' => __( 'Button & Link Color', 'amokit-addons' ),
					'type'  => Controls_Manager::COLOR,
					'alpha' => false,
				]
			);
    ...
    protected function render( $instance = [] ) {
			...
			if ( ! empty( $settings['calendly_username'] ) ) {
				...
				echo '<div class="amo-error-notice">' . esc_html__( "Please enter a valid Calendly username.", "amokit-addons" ) . '</div>';
			}
		}
