<div class="htm-weather-wraper" style="background:transparent url('<?php echo esc_url(AMONAKIT_ADDONS_PL_URL . 'assets/images/weather/weather-background.jpg');?>') no-repeat center center/cover;">
