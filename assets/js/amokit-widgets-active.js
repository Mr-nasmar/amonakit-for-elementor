...
let areaBtnNext = AMOKITF['buttion_area_text_next'];
let areaBtnPrev = AMOKITF['buttion_area_text_prev'];
    var WidgetTestimonialCarouselHandler = function ($scope, $) {

        var carousel_elem = $scope.find('.amo-testimonial-activation').eq(0);
        ...
        if (carousel_elem.length > 0) {
            ...
            if( testimonial_style_ck == 5 || testimonial_style_ck == 11){
                ...
                var carousel_elem_for = $scope.find('.amo-testimonial-activation .amo-testimonial-for').eq(0);
                if( carousel_elem_for.length > 0 ){ carousel_elem_for[0].style.display='block'; }
                var carousel_elem_nav = $scope.find('.amo-testimonial-activation .amo-testimonal-nav').eq(0);
                ...
                carousel_elem_for.slick({
                    ...
                    dots: dots,
                    fade: true,
                    asNavFor: '.amo-testimonal-nav'
                });

                carousel_elem_nav.slick({
                    slidesToShow: display_columns,
                    slidesToScroll: scroll_columns,
                    asNavFor: '.amo-testimonial-for',
                    dots: false,
                    arrows: false,
    ...
    // Carousel Handler
    var WidgetAmoKitCarouselHandler = function ($scope, $) {

        var carousel_elem = $scope.find( '.amo-carousel-activation' ).eq(0);
        if( carousel_elem.length > 0){ carousel_elem[0].style.display='block'; }
        if ( carousel_elem.length > 0 ) {
            ...
            if( carousel_style_ck == 4 ){
                carousel_elem.slick({
                    arrows: arrows,
                    prevArrow: '<button class="amo-carosul-prev">'+arrow_prev_txt+'</button>',
                    nextArrow: '<button class="amo-carosul-next">'+arrow_next_txt+'</button>',
                    dots: dots,
                    customPaging: function( slick,index ) {
                        var data_title = slick.$slides.eq(index).find('.amo-data-title').data('title');
                        var data_thumbnail = slick.$slides.eq(index).find('.amo-data-title').data('thumbnail');
                ...
                carousel_elem.slick({
                    arrows: arrows,
                    prevArrow: '<button aria-label="'+areaBtnPrev+'" class="amo-carosul-prev">'+arrow_prev_txt+'</button>',
                    nextArrow: '<button aria-label="'+areaBtnNext+'" class="amo-carosul-next">'+arrow_next_txt+'</button>',
                    dots: dots,
                    infinite: true,
                    autoplay: autoplay,
                    autoplaySpeed: autoplay_speed,
    ...
    // Carousel Handler
    var WidgetAmoKitThumbnailsgalleryHandler = function ($scope, $) {

        var thumbnailscarousel_elem_for = $scope.find('.amo-thumbgallery-for').eq(0);
        var thumbnailscarousel_elem_nav = $scope.find('.amo-thumbgallery-nav').eq(0);
        ...
        if ( thumbnailscarousel_elem_for.length > 0 ) {
            ...
            thumbnailscarousel_elem_nav.slick({
                ...
                arrows: navarrows,
                prevArrow: '<button aria-label="'+areaBtnPrev+'" class="amo-carosul-prev">'+navarrow_prev_txt+'</button>',
                nextArrow: '<button aria-label="'+areaBtnNext+'" class="amo-carosul-next">'+navarrow_next_txt+'</button>',
                draggable: true,
    ...
    var WidgetGoogleMapHandler = function ($scope, $) {
        var googlemap_elem = $scope.find('.amo-google-map').eq(0);
    ...
    function countDownFlip($this, $time, $countdownoptions) {
        var labels = ['Days', 'Hours', 'Mins', 'Secs'],
            template = function(label, curr, next) {
                if(($countdownoptions['amokitday'] == 'yes') && (label.toLowerCase() == 'days')){
                    return (
                        `<div class="amo-time amo-days">
                            <div class="amo-time-inner">
                                <span class="ht-count amo-curr amo-top">${curr}</span>
                                <span class="ht-count amo-next amo-top">${next}</span>
                                <span class="ht-count amo-next amo-bottom">${next}</span>
                                <span class="ht-count amo-curr amo-bottom">${curr}</span>
                            </div>
                            <span class="amo-label"><p>${($countdownoptions['lavelhide'] == 'yes') ? '' : $countdownoptions['amokitdaytxt']}</p></span>
                        </div>`
                    )
                }else if(($countdownoptions['amokithours'] == 'yes') && (label.toLowerCase() == 'hours')){
                    return (
                        `<div class="amo-time amo-hours">
                            <div class="amo-time-inner">
                                <span class="ht-count amo-curr amo-top">${curr}</span>
                                <span class="ht-count amo-next amo-top">${next}</span>
                                <span class="ht-count amo-next amo-bottom">${next}</span>
                            ...
                            <span class="amo-label"><p>${($countdownoptions['lavelhide'] == 'yes') ? '' : $countdownoptions['amokithourtxt']}</p></span>
                        </div>`
                    )
                }else if(($countdownoptions['amokitminiute'] == 'yes') && (label.toLowerCase() == 'mins')){
                    return (
                        `<div class="amo-time amo-mins">
                            <div class="amo-time-inner">
                                <span class="ht-count amo-curr amo-top">${curr}</span>
                                <span class="ht-count amo-next amo-top">${next}</span>
                                <span class="ht-count amo-next amo-bottom">${next}</span>
                            ...
                            <span class="amo-label"><p>${($countdownoptions['lavelhide'] == 'yes') ? '' : $countdownoptions['amokitminutestxt']}</p></span>
                        </div>`
                    )
                }else if(($countdownoptions['amokitsecond'] == 'yes') && (label.toLowerCase() == 'secs')){
                    return (
                        `<div class="amo-time amo-secs">
                            <div class="amo-time-inner">
                                <span class="ht-count amo-curr amo-top">${curr}</span>
                                <span class="ht-count amo-next amo-top">${next}</span>
                                <span class="ht-count amo-next amo-bottom">${next}</span>
                            ...
                            <span class="amo-label"><p>${($countdownoptions['lavelhide'] == 'yes') ? '' : $countdownoptions['amokitsecondstxt']}</p></span>
                        </div>`
                    )
                }
            },
        ...
        $this.countdown($time, function(event) {
            ...
            if (newDate !== nextDate) {
                ...
                diff(data.curr, data.next).forEach(function(label) {
                    var selector = '.%s'.replace(/%s/, `amokit-${label.toLowerCase()}`),
                        $node = $this.find(selector);
                    // Update the node
                    $node.removeClass('amo-flip');
                    $node.find('.amo-curr').text(data.curr[label]);
                    $node.find('.amo-next').text(data.next[label]);
                    // Wait for a repaint to then flip
                    setTimeout(function() {
                        $node.addClass('amo-flip');
                    })
                });
            }
        });
        ...
        if ( countdown_elem.length > 0 ) {
            countdown_elem.each(function () {
                ...
                if( countdownoptions['style'] === 'flip' ){
                    countDownFlip($this, countdownoptions.amodate, countdownoptions);
                   
                }else{
                    $this.countdown(countdownoptions.amodate, function (event) {
                        ...
                        if( countdownoptions.lavelhide == 'yes' ){
                            ...
                            daysTime = '<span class="ht-count days"><span class="count-inner"><span class="time-count">%-D</span> <p>'+countdownoptions.amodaytxt+ '</p></span></span>';
                            hours = '<span class="ht-count hour"><span class="count-inner"><span class="time-count">%-H</span> <p>'+countdownoptions.amohourtxt+ '</p></span></span>';
                            minutes = '<span class="ht-count minutes"><span class="count-inner"><span class="time-count">%M</span> <p>'+countdownoptions.amominutestxt+ '</p></span></span>';
                            second = '<span class="ht-count second"><span class="count-inner"><span class="time-count">%S</span> <p>'+countdownoptions.amosecondstxt+ '</p></span></span>';
                        }

                        // Total default target time
                        finalTime = daysTime + hours + minutes + second;

                        if ( countdownoptions.amoday != 'yes' ){
                            finalTime = hours + minutes + second;
                        }
                        if ( countdownoptions.amohours != 'yes' ){
                            finalTime = daysTime + minutes + second;
                        }
                        if ( countdownoptions.amominiute != 'yes' ){
                            finalTime = daysTime + hours + second;
                        }
                        if ( countdownoptions.amosecond != 'yes' ){
    ...
    var WidgetTeamMemberPlusHandler = function ($scope, $) {
        ...
        if ( teamPlus_elem.length > 0 ) {
            teamPlus_elem.on('click', function (e) {
                e.preventDefault();
                $( this ).parent('.amo-team-click-action').toggleClass('visible');
    ...
    var WidgetNewsTrickerHandler = function ($scope, $) {
        var newstricker_elem = $scope.find('.amo-newstricker').eq(0);
    ...
    /*============= Video Player ==============*/
     var WidgetVideoPlayerHandler = function ($scope, $) {
        var videocontainer_elem = $scope.find('.amo-player-container').eq(0);
        var videotype = videocontainer_elem.data('videotype');

        if( videotype.videocontainer == 'self' ){
            var videoplayer_elem = $scope.find('.amo-video-player').eq(0);
    ...
    /*=================== Notification Bar with container =================*/
     var WidgetNotifyHandler = function ($scope, $) {
        ...
        var notify_elem = $scope.find('.amo_notify_area').eq(0);
        ...
        if( notify_elem.length > 0 ){
            ...
            $(notify_opt.notify_btn_class).on("click", function () {
                ...
                $.notify({}, {
                    ...
                    spacing: 10,
                    z_index: 99999,
template: '<div class="amo-alert-wrap-'+notify_opt.wrapid+' '+notify_opt.width+' alert alert-{0}">' +
    '<span data-notify="dismiss" class="amo-close"><i class="fas fa-times"></i></span>' +notify_opt.icon+'<span class="notify-message-content">' + notify_opt.notifymessage +
    '</span></div>'
    ...
    var WidgetCounterHandler = function ($scope, $) {
        var count_elem = $scope.find('.amo-counter-number').eq(0);
    ...
    var WidgetImageMasonaryHandler = function ($scope, $) {
        var masonry_elem = $scope.find('.amo-masonry-activation').eq(0);
    ...
    var WidgetNavigationScrollHandler = function ($scope, $) {
        ...
        $('a[href^="#amokit-scroll-slide"]').on('click', function (e) {
            e.preventDefault();

            var fullIndex = $(this).attr('href');
            var slideIndex = parseInt(fullIndex.replace('#amokit-scroll-slide-',''), 0);
  ...
  /*=========== Slick Content tab load option =======*/
    ...
    */
    function amoKitTabsCarouselRefress( $tabmenus ) {
    ...
    $(window).on('elementor/frontend/init', function () {
        elementorFrontend.hooks.addAction( 'frontend/element_ready/amokit-tab-addons.default', WidgetTabControll);
        elementorFrontend.hooks.addAction( 'frontend/element_ready/amokit-google-map-addons.default', WidgetGoogleMapHandler);
        elementorFrontend.hooks.addAction( 'frontend/element_ready/amokit-accordion-addons.default', WidgetAccordionsMapHandler);
        elementorFrontend.hooks.addAction( 'frontend/element_ready/amokit-progressbar-addons.default', WidgetPieChartMapHandler);
        elementorFrontend.hooks.addAction( 'frontend/element_ready/amokit-countdown-addons.default', WidgetCountdownMapHandler);
        elementorFrontend.hooks.addAction( 'frontend/element_ready/amokit-team-member-addons.default', WidgetTeamMemberPlusHandler);
        elementorFrontend.hooks.addAction( 'frontend/element_ready/amokit-testimonial-addons.default', WidgetTestimonialCarouselHandler);
        elementorFrontend.hooks.addAction( 'frontend/element_ready/amokit-newtsicker-addons.default', WidgetNewsTrickerHandler);
        elementorFrontend.hooks.addAction( 'frontend/element_ready/amokit-magnific-popup-addons.default', WidgetLightboxHandler);
        elementorFrontend.hooks.addAction( 'frontend/element_ready/amokit-videoplayer-addons.default', WidgetVideoPlayerHandler);
        elementorFrontend.hooks.addAction( 'frontend/element_ready/amokit-instagram-addons.default', WidgetAmoKitCarouselHandler);
        elementorFrontend.hooks.addAction( 'frontend/element_ready/amokit-tooltip-addons.default', WidgetTooltipHandler);
        elementorFrontend.hooks.addAction( 'frontend/element_ready/amokit-popover-addons.default', WidgetPopoversHandler);
        elementorFrontend.hooks.addAction( 'frontend/element_ready/amokit-notify-addons.default', WidgetNotifyHandler);
        elementorFrontend.hooks.addAction( 'frontend/element_ready/amokit-counter-addons.default', WidgetCounterHandler);
        elementorFrontend.hooks.addAction( 'frontend/element_ready/amokit-postslider-addons.default', WidgetAmoKitCarouselHandler);
        elementorFrontend.hooks.addAction( 'frontend/element_ready/amokit-thumbgallery-addons.default', WidgetAmoKitThumbnailsgalleryHandler);
        elementorFrontend.hooks.addAction( 'frontend/element_ready/amokit-imagemasonryd-addons.default', WidgetImageMasonaryHandler);
        elementorFrontend.hooks.addAction( 'frontend/element_ready/amokit-scrollnavigation-addons.default', WidgetNavigationScrollHandler);
        elementorFrontend.hooks.addAction( 'frontend/element_ready/amokit-twitterfeed-addons.default', WidgetAmoKitCarouselHandler);
        elementorFrontend.hooks.addAction( 'frontend/element_ready/amokit-carousel-addons.default', WidgetAmoKitCarouselHandler);
        elementorFrontend.hooks.addAction( 'frontend/element_ready/amokit-postcarousel-addons.default', WidgetAmoKitCarouselHandler);
        elementorFrontend.hooks.addAction( 'frontend/element_ready/amokit-postgridtab-addons.default', WidgetPostGridHandler);
        elementorFrontend.hooks.addAction( 'frontend/element_ready/amokit-imagecomparison-addons.default', WidgetImageComparisonHandler);
        elementorFrontend.hooks.addAction( 'frontend/element_ready/amokit-panelslider-addons.default', WidgetAmoKitCarouselHandler);
        elementorFrontend.hooks.addAction( 'frontend/element_ready/amokit-switcher-addons.default', WidgetSwithcerControll);
    });
