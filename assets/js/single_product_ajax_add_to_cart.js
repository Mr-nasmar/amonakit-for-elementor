;(function($){
    $(document).on( 'click', '.elementor-widget-amokit-wcaddtocart-addons .single_add_to_cart_button', function (e) {
        e.preventDefault();
        var $this = $(this),
        ...
        var data = {
            ...
            isgrouped: 'no',
            all_data: all_data,
            security:amokitW.woocommerce_ajax_nonce
        };
        ...
        var alldata = data.all_data + '&isgrouped='+ data.isgrouped + '&grouped_product_id='+ data.groupedProductIds +  '&product_id='+ data.product_id + '&product_sku='+ data.product_sku + '&quantity='+ data.quantity + '&variation_id='+ data.variation_id + '&variations='+ JSON.stringify( data.variations ) +'&action=woocommerce_grouped_product_ajax_add_to_cart&security='+amokitW.woocommerce_ajax_nonce;
