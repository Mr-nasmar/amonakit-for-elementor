...
class AmoKit_Settings_API {
    ...
    function callback_checkbox( $args ) {
        ...
        $html  = '<fieldset class="amo_element_checkbox">';
        $html  .= sprintf( '<input type="hidden" name="%1$s[%2$s]" value="off" />', $args['section'], $args['id'] );
        $html  .= sprintf( '<input type="checkbox" class="checkbox" id="amokit_sp_%1$s[%2$s]" name="%1$s[%2$s]" value="on" %3$s />', $args['section'], $args['id'], checked( $value, 'on', false ) );
        $html  .= sprintf( '<label for="amokit_sp_%1$s[%2$s]">%3$s</label>', $args['section'], $args['id'], $args['desc'] );
        $html  .= '</fieldset>';
    ...
    function callback_multicheck( $args ) {
        ...
        foreach ( $args['options'] as $key => $label ) {
            ...
            $html    .= sprintf( '<label for="amokit_sp_%1$s[%2$s][%3$s]">', $args['section'], $args['id'], $key );
            $html    .= sprintf( '<input type="checkbox" class="checkbox" id="amokit_sp_%1$s[%2$s][%3$s]" name="%1$s[%2$s][%3$s]" value="%3$s" %4$s />', $args['section'], $args['id'], $key, checked( $checked, $key, false ) );
    ...
    function callback_radio( $args ) {
        ...
        foreach ( $args['options'] as $key => $label ) {
            $html .= sprintf( '<label for="amokit_sp_%1$s[%2$s][%3$s]">',  $args['section'], $args['id'], $key );
            $html .= sprintf( '<input type="radio" class="radio" id="amokit_sp_%1$s[%2$s][%3$s]" name="%1$s[%2$s]" value="%3$s" %4$s />', $args['section'], $args['id'], $key, checked( $value, $key, false ) );
            $html .= sprintf( '%1$s</label><br>', $label );
        }
    ...
    function callback_file( $args ) {
        ...
        $label = isset( $args['options']['button_label'] ) ? $args['options']['button_label'] : __( 'Choose File','amokit-addons' );
    ...
    function script() {
        ...
        <script>
            jQuery(document).ready(function($) {
                ...
                $(".amopro .wp-picker-container button").attr("disabled", true);
                ...
                $('.wpsa-browse').on('click', function (event) {
                    ...
                    file_frame.on('select', function () {
                        ...
                        self.siblings('.amomedia_display').html('<img src="'+attachment.url+'" alt="" />');
                    });
                ...
                $('.wpsa-remove').on('click', function (event) {
                    ...
                    self.siblings('.amomedia_display').html('');
                });
